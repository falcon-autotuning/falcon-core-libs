...
local math_mod = require("falcon-core.math.init")
...
describe("Vector", function()
	it("module loads successfully", function()
		...
		assert(Vector.size ~= nil, "Should have size method")
	end)
end)
...
describe("Point", function()
	it("module loads successfully", function()
		...
		assert(Point.at ~= nil, "Should have at method")
		assert(Point.size ~= nil, "Should have size method")
	end)
end)
