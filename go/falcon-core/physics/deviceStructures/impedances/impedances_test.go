...
func TestImpedances_SizeAndItems(t *testing.T) {
	withImpedances(t, func(t *testing.T, h *Handle, imps []*impedance.Handle) {
		...
		if len(items) != len(imps) {
			t.Errorf("Items() length = %v, want %v", len(items), len(imps))
		}
	})
}

func TestImpedances_AtAndConstAt(t *testing.T) {
	withImpedances(t, func(t *testing.T, h *Handle, imps []*impedance.Handle) {
...
func TestImpedances_Intersection(t *testing.T) {
	withImpedances(t, func(t *testing.T, h *Handle, imps []*impedance.Handle) {
		...
		if len(items) != len(imps) {
			t.Errorf("Intersection Items = %v, want %v", len(items), len(imps))
		}
	})
}
