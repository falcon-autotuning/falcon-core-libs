...
func (h *Handle) Size() (uint32, error) {
	return cmemoryallocation.Read(h, func() (uint32, error) {
		return uint32(C.Impedances_size(C.ImpedancesHandle(h.CAPIHandle()))), nil
	})
}
...
func (h *Handle) Index(value *impedance.Handle) (uint32, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, value}, func() (uint32, error) {
		return uint32(C.Impedances_index(C.ImpedancesHandle(h.CAPIHandle()), C.ImpedanceHandle(value.CAPIHandle()))), nil
	})
}
