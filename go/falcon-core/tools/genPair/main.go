...
func main() {
	pairs := []PairType{
		...
		{
			Type:                 "PairInterpretationContextDouble",
			FirstGoType:          "*interpretationcontext.Handle",
			FirstCType:           "InterpretationContextHandle",
			FirstIsString:        false,
			FirstZeroValue:       "nil",
			FirstConstructor:     "interpretationcontext.FromCAPI",
			FirstOptionalImport:  `"github.com/falcon-autotuning/falcon-core-libs/go/falcon-core/autotuner-interfaces/interpretations/interpretationcontext"`,
			SecondGoType:         "float64",
			SecondCType:          "double",
			SecondIsPrimitive:    true,
			SecondZeroValue:      "0.0",
			SecondConstructor:    "",
			SecondOptionalImport: "",
			SecondTestDefault:    "float64(24)",
			SecondTestOther:      "float64(11)",
			FirstTestDefault:     "defaultInterpretationContext",
			FirstTestOther:       "otherInterpretationContext",
		},
		{
			Type:                 "PairInterpretationContextString",
			FirstGoType:          "*interpretationcontext.Handle",
			FirstCType:           "InterpretationContextHandle",
			FirstIsString:        false,
			FirstZeroValue:       "nil",
			...
			SecondConstructor:    "str.FromGoString",
			SecondOptionalImport: "",
			SecondTestDefault:    `"hello"`,
			SecondTestOther:      `"world"`,
			FirstTestDefault:     "defaultInterpretationContext",
			FirstTestOther:       "otherInterpretationContext",
		},
		{
			Type:                 "PairMeasurementResponseMeasurementRequest",
			FirstGoType:          "*measurementresponse.Handle",
			FirstCType:           "MeasurementResponseHandle",
			FirstIsString:        false,
			FirstZeroValue:       "nil",
			FirstConstructor:     "measurementresponse.FromCAPI",
			FirstOptionalImport:  `"github.com/falcon-autotuning/falcon-core-libs/go/falcon-core/communications/messages/measurementresponse"`,
			SecondGoType:         "*measurementrequest.Handle",
			SecondCType:          "MeasurementRequestHandle",
			SecondIsPrimitive:    false,
			SecondZeroValue:      "nil",
			SecondConstructor:    "measurementrequest.FromCAPI",
			SecondOptionalImport: `"github.com/falcon-autotuning/falcon-core-libs/go/falcon-core/communications/messages/measurementrequest"`,
			SecondTestDefault:    "defaultrequest",
			SecondTestOther:      "otherrequest",
			FirstTestDefault:     "defaultresponse",
			FirstTestOther:       "otherresponse",
		},
		{
			Type:                 "PairInterpretationContextQuantity",
			FirstGoType:          "*interpretationcontext.Handle",
			FirstCType:           "InterpretationContextHandle",
			FirstIsString:        false,
			FirstZeroValue:       "nil",
