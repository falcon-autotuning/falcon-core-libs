...
func main() {
	maps := []MapType{
		...
		{
			Type:                 "MapInterpretationContextDouble",
			PairGoType:           "pairinterpretationcontextdouble",
			PairCType:            "PairInterpretationContextDoubleHandle",
			...
			SecondConstructor:    "",
			SecondOptionalImport: "",
			ListKeyGoType:        "listinterpretationcontext",
			ListValueGoType:      "listdouble",
			FirstTestDefault:     "firstInterpretationContext",
			SecondTestDefault:    "1.23",
			FirstTestOther:       "secondInterpretationContext",
			SecondTestOther:      "4.56",
		},
		{
			Type:                 "MapInterpretationContextQuantity",
			PairGoType:           "pairinterpretationcontextquantity",
			PairCType:            "PairInterpretationContextQuantityHandle",
			FirstGoType:          "*interpretationcontext.Handle",
			FirstCType:           "InterpretationContextHandle",
			FirstIsPrimitive:     false,
			FirstZeroValue:       "nil",
		...
		{
			Type:                 "MapInterpretationContextString",
			PairGoType:           "pairinterpretationcontextstring",
			PairCType:            "PairInterpretationContextStringHandle",
			FirstGoType:          "*interpretationcontext.Handle",
			FirstCType:           "InterpretationContextHandle",
			FirstIsPrimitive:     false,
			FirstZeroValue:       "nil",
