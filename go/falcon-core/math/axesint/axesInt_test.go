...
var (
	defaultAxesData = []int32{0,1}
	val1            = int32(4)
	otherAxesData   = []int32{3}
)
func eqSlice(a, b []int32) bool {
	return reflect.DeepEqual(a, b)
}

func fixtureAxesData() []int32 {
	return defaultAxesData
}
func TestAxesInt_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestAxesInt_NewFromSliceAndItems(t *testing.T) {
...
func TestAxesInt_EraseAtAndClear(t *testing.T) {
...
func TestAxesInt_IntersectionEqualNotEqual(t *testing.T) {
...
func TestAxesInt_ToJSONAndFromJSON(t *testing.T) {
...
func TestAxesInt_ContainsAndIndex(t *testing.T) {
...
func TestAxesInt_CAPIHandle(t *testing.T) {
...
func TestAxesInt_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestAxesInt_CloseTwice(t *testing.T) {
	l, err := New(defaultAxesData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
