...
// eqSlice compares two slices of *labelledcontrolarray1d.Handle pointers by dereferencing and calling Equal.
...
func fixtureAxesData() []*labelledcontrolarray1d.Handle {
	return defaultAxesData
}
func TestAxesLabelledControlArray1D_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestAxesLabelledControlArray1D_NewFromSliceAndItems(t *testing.T) {
...
func TestAxesLabelledControlArray1D_EraseAtAndClear(t *testing.T) {
...
func TestAxesLabelledControlArray1D_IntersectionEqualNotEqual(t *testing.T) {
...
func TestAxesLabelledControlArray1D_ToJSONAndFromJSON(t *testing.T) {
...
func TestAxesLabelledControlArray1D_ContainsAndIndex(t *testing.T) {
...
func TestAxesLabelledControlArray1D_CAPIHandle(t *testing.T) {
...
func TestAxesLabelledControlArray1D_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestAxesLabelledControlArray1D_CloseTwice(t *testing.T) {
	l, err := New(defaultAxesData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
