...
// eqSlice compares two slices of *controlarray.Handle pointers by dereferencing and calling Equal.
func eqSlice(a, b []*controlarray.Handle) bool {
	if len(a) != len(b) {
		return false
	}
	for i := range a {
...
func fixtureAxesData() []*controlarray.Handle {
	return defaultAxesData
}
func TestAxesControlArray_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestAxesControlArray_NewFromSliceAndItems(t *testing.T) {
...
func TestAxesControlArray_EraseAtAndClear(t *testing.T) {
...
func TestAxesControlArray_IntersectionEqualNotEqual(t *testing.T) {
...
func TestAxesControlArray_ToJSONAndFromJSON(t *testing.T) {
...
func TestAxesControlArray_ContainsAndIndex(t *testing.T) {
...
func TestAxesControlArray_CAPIHandle(t *testing.T) {
...
func TestAxesControlArray_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestAxesControlArray_CloseTwice(t *testing.T) {
	l, err := New(defaultAxesData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
