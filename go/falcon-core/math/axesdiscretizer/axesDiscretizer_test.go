...
// eqSlice compares two slices of *discretizer.Handle pointers by dereferencing and calling Equal.
func eqSlice(a, b []*discretizer.Handle) bool {
	if len(a) != len(b) {
		return false
	}
	for i := range a {
...
func fixtureAxesData() []*discretizer.Handle {
	return defaultAxesData
}
func TestAxesDiscretizer_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestAxesDiscretizer_NewFromSliceAndItems(t *testing.T) {
...
func TestAxesDiscretizer_EraseAtAndClear(t *testing.T) {
...
func TestAxesDiscretizer_IntersectionEqualNotEqual(t *testing.T) {
...
func TestAxesDiscretizer_ToJSONAndFromJSON(t *testing.T) {
...
func TestAxesDiscretizer_ContainsAndIndex(t *testing.T) {
...
func TestAxesDiscretizer_CAPIHandle(t *testing.T) {
...
func TestAxesDiscretizer_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestAxesDiscretizer_CloseTwice(t *testing.T) {
	l, err := New(defaultAxesData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
