...
// eqSlice compares two slices of *instrumentport.Handle pointers by dereferencing and calling Equal.
func eqSlice(a, b []*instrumentport.Handle) bool {
	if len(a) != len(b) {
		return false
	}
	for i := range a {
...
func fixtureAxesData() []*instrumentport.Handle {
	return defaultAxesData
}
func TestAxesInstrumentPort_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestAxesInstrumentPort_NewFromSliceAndItems(t *testing.T) {
...
func TestAxesInstrumentPort_EraseAtAndClear(t *testing.T) {
...
func TestAxesInstrumentPort_IntersectionEqualNotEqual(t *testing.T) {
...
func TestAxesInstrumentPort_ToJSONAndFromJSON(t *testing.T) {
...
func TestAxesInstrumentPort_ContainsAndIndex(t *testing.T) {
...
func TestAxesInstrumentPort_CAPIHandle(t *testing.T) {
...
func TestAxesInstrumentPort_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestAxesInstrumentPort_CloseTwice(t *testing.T) {
	l, err := New(defaultAxesData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
