...
// eqSlice compares two slices of *controlarray1d.Handle pointers by dereferencing and calling Equal.
func eqSlice(a, b []*controlarray1d.Handle) bool {
	if len(a) != len(b) {
		return false
	}
	for i := range a {
...
func fixtureAxesData() []*controlarray1d.Handle {
	return defaultAxesData
}
func TestAxesControlArray1D_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestAxesControlArray1D_NewFromSliceAndItems(t *testing.T) {
...
func TestAxesControlArray1D_EraseAtAndClear(t *testing.T) {
...
func TestAxesControlArray1D_IntersectionEqualNotEqual(t *testing.T) {
...
func TestAxesControlArray1D_ToJSONAndFromJSON(t *testing.T) {
...
func TestAxesControlArray1D_ContainsAndIndex(t *testing.T) {
...
func TestAxesControlArray1D_CAPIHandle(t *testing.T) {
...
func TestAxesControlArray1D_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestAxesControlArray1D_CloseTwice(t *testing.T) {
	l, err := New(defaultAxesData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
