...
func (h *Handle) Size() (uint32, error) {
	return cmemoryallocation.Read(h, func() (uint32, error) {
		return uint32(C.AxesControlArray1D_size(C.AxesControlArray1DHandle(h.CAPIHandle()))), nil
	})
}
...
func (h *Handle) At(idx uint32) (*controlarray1d.Handle, error) {
...
func (h *Handle) Items() ([]*controlarray1d.Handle, error) {
	dim, err := cmemoryallocation.Read(h, func() (int32, error) {
		return int32(C.AxesControlArray1D_dimension(C.AxesControlArray1DHandle(h.CAPIHandle()))), nil
	})
	if err != nil {
	...
	for i := range out {
		realout[i] = *controlarray1d.Handle(realout[i])
	}
	return realout, nil
}
...
func (h *Handle) Index(value *controlarray1d.Handle) (uint32, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, value}, func() (uint32, error) {
		return uint32(C.AxesControlArray1D_index(C.AxesControlArray1DHandle(h.CAPIHandle()), C.ControlArray1DHandle(value.CAPIHandle()))), nil
	})
}
func (h *Handle) Intersection(other *Handle) (*Handle, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, other}, func() (*Handle, error) {

		return Handle.FromCAPI(unsafe.Pointer(C.AxesControlArray1D_intersection(C.AxesControlArray1DHandle(h.CAPIHandle()), C.AxesControlArray1DHandle(other.CAPIHandle()))))
	})
}
func (h *Handle) Equal(b *Handle) (bool, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, b}, func() (bool, error) {
		return bool(C.AxesControlArray1D_equal(C.AxesControlArray1DHandle(h.CAPIHandle()), C.AxesControlArray1DHandle(b.CAPIHandle()))), nil
	})
}
func (h *Handle) NotEqual(b *Handle) (bool, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, b}, func() (bool, error) {
		return bool(C.AxesControlArray1D_not_equal(C.AxesControlArray1DHandle(h.CAPIHandle()), C.AxesControlArray1DHandle(b.CAPIHandle()))), nil
	})
}
