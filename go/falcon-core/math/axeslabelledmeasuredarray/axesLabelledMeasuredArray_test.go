...
// eqSlice compares two slices of *labelledmeasuredarray.Handle pointers by dereferencing and calling Equal.
func eqSlice(a, b []*labelledmeasuredarray.Handle) bool {
	if len(a) != len(b) {
		return false
	}
	for i := range a {
...
func fixtureAxesData() []*labelledmeasuredarray.Handle {
	return defaultAxesData
}
func TestAxesLabelledMeasuredArray_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestAxesLabelledMeasuredArray_NewFromSliceAndItems(t *testing.T) {
...
func TestAxesLabelledMeasuredArray_EraseAtAndClear(t *testing.T) {
...
func TestAxesLabelledMeasuredArray_IntersectionEqualNotEqual(t *testing.T) {
...
func TestAxesLabelledMeasuredArray_ToJSONAndFromJSON(t *testing.T) {
...
func TestAxesLabelledMeasuredArray_ContainsAndIndex(t *testing.T) {
...
func TestAxesLabelledMeasuredArray_CAPIHandle(t *testing.T) {
...
func TestAxesLabelledMeasuredArray_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestAxesLabelledMeasuredArray_CloseTwice(t *testing.T) {
	l, err := New(defaultAxesData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
