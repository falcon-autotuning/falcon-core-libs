...
func (h *Handle) Equal(b *Handle) (bool, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, b}, func() (bool, error) {
		return bool(C.AnalyticFunction_equal(C.AnalyticFunctionHandle(h.CAPIHandle()), C.AnalyticFunctionHandle(b.CAPIHandle()))), nil
	})
}
func (h *Handle) NotEqual(b *Handle) (bool, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, b}, func() (bool, error) {
		return bool(C.AnalyticFunction_not_equal(C.AnalyticFunctionHandle(h.CAPIHandle()), C.AnalyticFunctionHandle(b.CAPIHandle()))), nil
	})
}
