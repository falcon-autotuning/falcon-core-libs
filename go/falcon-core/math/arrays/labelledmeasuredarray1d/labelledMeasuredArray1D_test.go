...
func TestLabelledMeasuredArray1D_ShapeDimensionData(t *testing.T) {
...
func TestLabelledMeasuredArray1D_PlusEqualsFArray(t *testing.T) {
...
func TestLabelledMeasuredArray1D_PlusEqualsDouble(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledMeasuredArray1D_PlusEqualsInt(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledMeasuredArray1D_MinusEqualsFArray(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledMeasuredArray1D_MinusEqualsDouble(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledMeasuredArray1D_MinusEqualsInt(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledMeasuredArray1D_TimesEqualsFArray(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledMeasuredArray1D_TimesEqualsDouble(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledMeasuredArray1D_TimesEqualsInt(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledMeasuredArray1D_DividesEqualsFArray(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledMeasuredArray1D_DividesEqualsDouble(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledMeasuredArray1D_DividesEqualsInt(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledMeasuredArray1D_ArithmeticOpsNonMutating(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledMeasuredArray1D_MinMax(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledMeasuredArray1D_Equal(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledMeasuredArray1D_GreaterLessThan(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledMeasuredArray1D_RemoveOffsetSum(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledMeasuredArray1D_ReshapeWhereFlip(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledMeasuredArray1D_FullGradientGradient(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledMeasuredArray1D_SumOfSquaresAndDiffs(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledMeasuredArray1D_ToJSONAndFromJSON(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledMeasuredArray1D_ErrorBranches(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func mustMeasuredArray() *measuredarray.Handle {
	h, _ := farraydouble.FromData([]float64{1, 2, 3, 4}, []uint64{4})
	m, err := measuredarray.FromFArray(h)
	if err != nil {
		panic(err)
	}
	return m
...
func TestLabelledMeasuredArray1D_FromMeasuredArray1D(t *testing.T) {
	// nil input
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
	...
	if err == nil || lma != nil {
		t.Errorf("FromMeasuredArray1D(nil) should error and return nil")
	}
	...
	if err != nil {
		t.Fatalf("FromMeasuredArray1D failed: %v", err)
	}
	defer lma.Close()
...
func TestMeasuredArray1D_BooleanAndGetterMethods(t *testing.T) {
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
	ma := mustMeasuredArray()
	defer ma.Close()
	a, err := FromMeasuredArray(ma, ac)
	if err != nil {
