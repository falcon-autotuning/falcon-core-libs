...
var (
	...
	destroy = func(ptr unsafe.Pointer) {
		C.IncreasingAlignment_destroy(C.IncreasingAlignmentHandle(ptr))
	}
)
...
func (h *Handle) ToJSON() (string, error) {
	return cmemoryallocation.Read(h, func() (string, error) {
		...
		strObj, err := str.FromCAPI(unsafe.Pointer(C.IncreasingAlignment_to_json_string(C.IncreasingAlignmentHandle(h.CAPIHandle()))))
		if err != nil {
...
func FromJSON(json string) (*Handle, error) {
	...
	return cmemoryallocation.Read(realjson, func() (*Handle, error) {
		...
		return cmemoryallocation.NewAllocation(
			func() (unsafe.Pointer, error) {
				return unsafe.Pointer(C.IncreasingAlignment_from_json_string(C.StringHandle(realjson.CAPIHandle()))), nil
			},
			construct,
			destroy,
		)
