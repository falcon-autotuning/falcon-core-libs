...
func TestLabelledControlArray_ShapeDimensionData(t *testing.T) {
...
func TestLabelledControlArray_PlusEqualsFArray(t *testing.T) {
...
func TestLabelledControlArray_PlusEqualsDouble(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledControlArray_PlusEqualsInt(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledControlArray_MinusEqualsFArray(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledControlArray_MinusEqualsDouble(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledControlArray_MinusEqualsInt(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledControlArray_TimesEqualsDouble(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledControlArray_TimesEqualsInt(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledControlArray_DividesEqualsDouble(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledControlArray_DividesEqualsInt(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledControlArray_ArithmeticOpsNonMutating(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledControlArray_MinMax(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledControlArray_Equal(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledControlArray_GreaterLessThan(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledControlArray_RemoveOffsetSum(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledControlArray_ReshapeWhereFlip(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledControlArray_FullGradientGradient(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledControlArray_SumOfSquaresAndDiffs(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledControlArray_ToJSONAndFromJSON(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledControlArray_ErrorBranches(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledControlArray_FromControlArray(t *testing.T) {
	// nil input
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
