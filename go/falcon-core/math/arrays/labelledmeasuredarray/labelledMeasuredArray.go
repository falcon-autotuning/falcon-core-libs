	...
	return cmemoryallocation.Read(handle, func() (*Handle, error) {
		...
		return cmemoryallocation.NewAllocation(
			func() (unsafe.Pointer, error) {
				return unsafe.Pointer(C.LabelledMeasuredArray_copy(C.LabelledMeasuredArrayHandle(handle.CAPIHandle()))), nil
			},
			construct,
			destroy,
		)
...
func (h *Handle) Size() (uint64, error) {
	return cmemoryallocation.Read(h, func() (uint64, error) {
		return uint64(C.LabelledMeasuredArray_size(C.LabelledMeasuredArrayHandle(h.CAPIHandle()))), nil
	})
}
func (h *Handle) Dimension() (uint64, error) {
	return cmemoryallocation.Read(h, func() (uint64, error) {
		return uint64(C.LabelledMeasuredArray_dimension(C.LabelledMeasuredArrayHandle(h.CAPIHandle()))), nil
	})
}
...
func (h *Handle) Min() (float64, error) {
	return cmemoryallocation.Read(h, func() (float64, error) {
		return float64(C.LabelledMeasuredArray_min(C.LabelledMeasuredArrayHandle(h.CAPIHandle()))), nil
	})
}
...
func (h *Handle) Max() (float64, error) {
	return cmemoryallocation.Read(h, func() (float64, error) {
		return float64(C.LabelledMeasuredArray_max(C.LabelledMeasuredArrayHandle(h.CAPIHandle()))), nil
	})
}
