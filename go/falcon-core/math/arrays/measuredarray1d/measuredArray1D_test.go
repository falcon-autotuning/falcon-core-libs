...
func TestMeasuredArray1D_FromDataAndClose(t *testing.T) {
...
func TestMeasuredArray1D_ShapeDimensionData(t *testing.T) {
...
func TestMeasuredArray1D_ArithmeticOpsEquals(t *testing.T) {
	a, _ := FromData(defaultData, defaultShape)
	defer a.Close()
...
func TestMeasuredArray1D_ArithmeticOpsNonMutating(t *testing.T) {
	a, _ := FromData(defaultData, defaultShape)
	defer a.Close()
	b, _ := farraydouble.FromData(defaultData, defaultShape)
	defer b.Close()
...
func TestMeasuredArray1D_MinMax(t *testing.T) {
	a, _ := FromData(defaultData, defaultShape)
	defer a.Close()
	b, _ := farraydouble.FromData(defaultData, defaultShape)
	defer b.Close()
...
func TestMeasuredArray1D_Equal(t *testing.T) {
	a, _ := FromData(defaultData, defaultShape)
	defer a.Close()
...
func TestMeasuredArray1D_GreaterLessThan(t *testing.T) {
	a, _ := FromData(defaultData, defaultShape)
	defer a.Close()
...
func TestMeasuredArray1D_RemoveOffsetSum(t *testing.T) {
	a, _ := FromData(defaultData, defaultShape)
	defer a.Close()
...
func TestMeasuredArray1D_ReshapeWhereFlip(t *testing.T) {
	a, _ := FromData(defaultData, defaultShape)
	defer a.Close()
...
func TestMeasuredArray1D_FullGradientGradient(t *testing.T) {
	a, _ := FromData(defaultData, defaultShape)
	defer a.Close()
...
func TestMeasuredArray1D_SumOfSquaresAndDiffs(t *testing.T) {
	a, _ := FromData(defaultData, defaultShape)
	defer a.Close()
...
func TestMeasuredArray1D_ToJSONAndFromJSON(t *testing.T) {
	a, _ := FromData(defaultData, defaultShape)
	defer a.Close()
	js, err := a.ToJSON()
	if err != nil {
...
func TestMeasuredArray1D_ErrorBranches(t *testing.T) {
	a, _ := FromData(defaultData, defaultShape)
	a.Close()
	_, err := a.Size()
	if err == nil {
