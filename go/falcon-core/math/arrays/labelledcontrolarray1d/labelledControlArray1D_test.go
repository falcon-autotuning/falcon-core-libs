...
func TestLabelledControlArray1D_ShapeDimensionData(t *testing.T) {
...
func TestLabelledControlArray1D_PlusEqualsFArray(t *testing.T) {
...
func TestLabelledControlArray1D_PlusEqualsDouble(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledControlArray1D_PlusEqualsInt(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledControlArray1D_MinusEqualsFArray(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledControlArray1D_MinusEqualsDouble(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledControlArray1D_MinusEqualsInt(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledControlArray1D_TimesEqualsDouble(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledControlArray1D_TimesEqualsInt(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledControlArray1D_DividesEqualsDouble(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledControlArray1D_DividesEqualsInt(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledControlArray1D_ArithmeticOpsNonMutating(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
	...
	// MinusFArray
	a2, _ := a.TimesDouble(2.0)
	res, err = a2.MinusFArray(b)
	if err != nil {
...
func TestLabelledControlArray1D_MinMax(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
	...
	b, _ := farraydouble.FromData(defaultData, defaultShape)
	defer b.Close()
	_, err := a2.MinFArray(b)
	if err != nil {
		t.Errorf("MinFArray failed: %v", err)
	}
	_, err = a2.MaxFArray(b)
	if err != nil {
		t.Errorf("MaxFArray failed: %v", err)
	}
}

func TestLabelledControlArray1D_Equal(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledControlArray1D_GreaterLessThan(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledControlArray1D_RemoveOffsetSum(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledControlArray1D_FullGradientGradient(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledControlArray1D_SumOfSquaresAndDiffs(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledControlArray1D_ToJSONAndFromJSON(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func TestLabelledControlArray1D_ErrorBranches(t *testing.T) {
	aold, _ := farraydouble.FromData(defaultData, defaultShape)
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
...
func mustControlArray() *controlarray.Handle {
	h, err := controlarray.FromData(defaultData, defaultShape)
	if err != nil {
		panic(err)
	}
	return h
...
func TestLabelledControlArray1D_FromControlArray(t *testing.T) {
	// nil input
	bgate, _ := connection.NewBarrierGate("B1")
	volt, _ := symbolunit.NewVolt()
	ac, _ := acquisitioncontext.New(bgate, instrumenttypes.VoltageSource(), volt)
	lma, err := FromControlArray(nil, ac)
	if err == nil || lma != nil {
		t.Errorf("FromControlArray(nil) should error and return nil")
	}

	// valid input
	ma := mustControlArray()
	defer ma.Close()
	lma, err = FromControlArray(ma, ac)
	if err != nil {
		t.Fatalf("FromControlArray failed: %v", err)
	}
	defer lma.Close()
