...
func TestLabelledArraysLabelledControlArray_NewFromListAndPushBack(t *testing.T) {
	list, err := listlabelledcontrolarray.New(defaultListData)
	if err != nil {
...
func TestLabelledArraysLabelledControlArray_ArraysLabelsAndIsMethods(t *testing.T) {
	list, err := listlabelledcontrolarray.New(defaultListData)
	if err != nil {
		t.Fatalf("New list failed: %v", err)
	}
...
func TestLabelledArraysLabelledControlArray_EraseAtAndClear(t *testing.T) {
	list, err := listlabelledcontrolarray.New(defaultListData)
	if err != nil {
		t.Fatalf("New list failed: %v", err)
	}
...
func TestLabelledArraysLabelledControlArray_AtContainsIndex(t *testing.T) {
	list, err := listlabelledcontrolarray.New(defaultListData)
	if err != nil {
		t.Fatalf("New list failed: %v", err)
	}
...
func TestLabelledArraysLabelledControlArray_IntersectionEqualNotEqual(t *testing.T) {
	list, err := listlabelledcontrolarray.New(defaultListData)
	if err != nil {
		t.Fatalf("New list failed: %v", err)
	}
	...
	otherList, err := listlabelledcontrolarray.New(otherListData)
	if err != nil {
...
func TestLabelledArraysLabelledControlArray_ToJSONAndFromJSON(t *testing.T) {
	list, err := listlabelledcontrolarray.New(defaultListData)
	if err != nil {
		t.Fatalf("New list failed: %v", err)
	}
...
func TestLabelledArraysLabelledControlArray_CAPIHandle(t *testing.T) {
	list, err := listlabelledcontrolarray.New(defaultListData)
	if err != nil {
		t.Fatalf("New list failed: %v", err)
	}
...
func TestLabelledArraysLabelledControlArray_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
...
func TestLabelledArraysLabelledControlArray_CloseTwice(t *testing.T) {
	list, err := listlabelledcontrolarray.New(defaultListData)
	if err != nil {
		t.Fatalf("New list failed: %v", err)
	}
