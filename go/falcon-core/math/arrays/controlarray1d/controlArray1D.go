...
func (h *Handle) Is1D() (bool, error) {
	...
	defer h.mu.RUnlock()
	if h.closed || h.chandle == utils.NilHandle[chandle]() {
		return false, errors.New("ControlArray1D is closed")
	}
...
func (h *Handle) As1D() (*farraydouble.Handle, error) {
	...
	defer h.mu.RUnlock()
	if h.closed || h.chandle == utils.NilHandle[chandle]() {
		return nil, errors.New("ControlArray1D is closed")
	}
...
func (h *Handle) GetStart() (float64, error) {
	...
	defer h.mu.RUnlock()
	if h.closed || h.chandle == utils.NilHandle[chandle]() {
		return 0, errors.New("ControlArray1D is closed")
	}
...
func (h *Handle) Reverse() error {
	...
	defer h.mu.Unlock()
	if h.closed || h.chandle == utils.NilHandle[chandle]() {
		return errors.New("ControlArray1D is closed")
	}
...
func (h *Handle) PlusControlArray1D(other *Handle) (*Handle, error) {
	...
	res := chandle(C.ControlArray1D_plus_control_array(C.ControlArray1DHandle(h.chandle), C.ControlArray1DHandle(other.chandle)))
	err := h.errorHandler.CheckCapiError()
	if err != nil {
		return nil, err
	}
...
func (h *Handle) MinusControlArray1D(other *Handle) (*Handle, error) {
	...
	res := chandle(C.ControlArray1D_minus_control_array(C.ControlArray1DHandle(h.chandle), C.ControlArray1DHandle(other.chandle)))
	err := h.errorHandler.CheckCapiError()
	if err != nil {
		return nil, err
	}
...
func (h *Handle) MinControlArray1D(other *Handle) (*Handle, error) {
	...
	res := chandle(C.ControlArray1D_min_control_array(C.ControlArray1DHandle(h.chandle), C.ControlArray1DHandle(other.chandle)))
	err := h.errorHandler.CheckCapiError()
	if err != nil {
		return nil, err
	}
...
func (h *Handle) MaxControlArray1D(other *Handle) (*Handle, error) {
	...
	res := chandle(C.ControlArray1D_max_control_array(C.ControlArray1DHandle(h.chandle), C.ControlArray1DHandle(other.chandle)))
	err := h.errorHandler.CheckCapiError()
	if err != nil {
		return nil, err
	}
...
func (h *Handle) Equal(other *Handle) (bool, error) {
	...
	val := bool(C.ControlArray1D_equality(C.ControlArray1DHandle(h.chandle), C.ControlArray1DHandle(other.chandle)))
	err := h.errorHandler.CheckCapiError()
	if err != nil {
		return false, err
	}
...
func (h *Handle) NotEqual(other *Handle) (bool, error) {
	...
	val := bool(C.ControlArray1D_notequality(C.ControlArray1DHandle(h.chandle), C.ControlArray1DHandle(other.chandle)))
	err := h.errorHandler.CheckCapiError()
	if err != nil {
		return false, err
	}
...
func (h *Handle) GetSummedDiffArrayOfSquares(other *Handle) (float64, error) {
	...
	val := float64(C.ControlArray1D_get_summed_diff_array_of_squares(C.ControlArray1DHandle(h.chandle), C.ControlArray1DHandle(other.chandle)))
	err := h.errorHandler.CheckCapiError()
	if err != nil {
		return 0, err
	}
