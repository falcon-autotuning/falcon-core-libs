...
func (h *Handle) Iscontrolarrays() (bool, error) {
	return cmemoryallocation.Read(h, func() (bool, error) {
		return bool(C.LabelledArraysLabelledControlArray1D_isControlArrays(C.LabelledArraysLabelledControlArray1DHandle(h.CAPIHandle()))), nil
	})
}
func (h *Handle) Ismeasuredarrays() (bool, error) {
	return cmemoryallocation.Read(h, func() (bool, error) {
		return bool(C.LabelledArraysLabelledControlArray1D_isMeasuredArrays(C.LabelledArraysLabelledControlArray1DHandle(h.CAPIHandle()))), nil
	})
}
...
func (h *Handle) Intersection(other *Handle) (*Handle, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, other}, func() (*Handle, error) {
		...
		return Handle.FromCAPI(unsafe.Pointer(C.LabelledArraysLabelledControlArray1D_intersection(C.LabelledArraysLabelledControlArray1DHandle(h.CAPIHandle()), C.LabelledArraysLabelledControlArray1DHandle(other.CAPIHandle()))))
	})
}
