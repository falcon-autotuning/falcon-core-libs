...
func mustControlArray(data []float64, shape []uint64, name string) *labelledcontrolarray1d.Handle {
...
var (
	defaultListData = []*labelledcontrolarray1d.Handle{
		mustControlArray([]float64{0.0, 1.0}, []uint64{2}, "B1"),
		mustControlArray([]float64{0.0, 1.0, 2.0, 3.0}, []uint64{4}, "B2"),
	}
	otherListData = []*labelledcontrolarray1d.Handle{
		mustControlArray([]float64{0.5, 1.0, 2.0, 3.0}, []uint64{4}, "B3"),
	}
)
