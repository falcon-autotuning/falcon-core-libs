...
func fixtureListData() []*labelledcontrolarray1d.Handle {
	return defaultListData
}

func TestLabelledArraysLabelledControlArray1D_NewFromListAndPushBack(t *testing.T) {
	list, err := listlabelledcontrolarray1d.New(defaultListData)
	if err != nil {
...
func TestLabelledArraysLabelledControlArray1D_ArraysLabelsAndIsMethods(t *testing.T) {
	list, err := listlabelledcontrolarray1d.New(defaultListData)
	if err != nil {
		t.Fatalf("New list failed: %v", err)
	}
...
func TestLabelledArraysLabelledControlArray1D_EraseAtAndClear(t *testing.T) {
	list, err := listlabelledcontrolarray1d.New(defaultListData)
	if err != nil {
		t.Fatalf("New list failed: %v", err)
	}
...
func TestLabelledArraysLabelledControlArray1D_AtContainsIndex(t *testing.T) {
	list, err := listlabelledcontrolarray1d.New(defaultListData)
	if err != nil {
		t.Fatalf("New list failed: %v", err)
	}
...
func TestLabelledArraysLabelledControlArray1D_IntersectionEqualNotEqual(t *testing.T) {
	list, err := listlabelledcontrolarray1d.New(defaultListData)
	if err != nil {
		t.Fatalf("New list failed: %v", err)
	}
	...
	otherList, err := listlabelledcontrolarray1d.New(otherListData)
	if err != nil {
...
func TestLabelledArraysLabelledControlArray1D_ToJSONAndFromJSON(t *testing.T) {
	list, err := listlabelledcontrolarray1d.New(defaultListData)
	if err != nil {
		t.Fatalf("New list failed: %v", err)
	}
...
func TestLabelledArraysLabelledControlArray1D_CAPIHandle(t *testing.T) {
	list, err := listlabelledcontrolarray1d.New(defaultListData)
	if err != nil {
		t.Fatalf("New list failed: %v", err)
	}
...
func TestLabelledArraysLabelledControlArray1D_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
...
func TestLabelledArraysLabelledControlArray1D_CloseTwice(t *testing.T) {
	list, err := listlabelledcontrolarray1d.New(defaultListData)
	if err != nil {
		t.Fatalf("New list failed: %v", err)
	}
