...
func fixtureListData() []*labelledmeasuredarray.Handle {
	return defaultListData
}

func TestLabelledArraysLabelledMeasuredArray_NewFromListAndPushBack(t *testing.T) {
	list, err := listlabelledmeasuredarray.New(defaultListData)
	if err != nil {
...
func TestLabelledArraysLabelledMeasuredArray_ArraysLabelsAndIsMethods(t *testing.T) {
	list, err := listlabelledmeasuredarray.New(defaultListData)
	if err != nil {
		t.Fatalf("New list failed: %v", err)
	}
...
func TestLabelledArraysLabelledMeasuredArray_EraseAtAndClear(t *testing.T) {
	list, err := listlabelledmeasuredarray.New(defaultListData)
	if err != nil {
		t.Fatalf("New list failed: %v", err)
	}
...
func TestLabelledArraysLabelledMeasuredArray_AtContainsIndex(t *testing.T) {
	list, err := listlabelledmeasuredarray.New(defaultListData)
	if err != nil {
		t.Fatalf("New list failed: %v", err)
	}
...
func TestLabelledArraysLabelledMeasuredArray_IntersectionEqualNotEqual(t *testing.T) {
	list, err := listlabelledmeasuredarray.New(defaultListData)
	if err != nil {
		t.Fatalf("New list failed: %v", err)
	}
	...
	otherList, err := listlabelledmeasuredarray.New(otherListData)
	if err != nil {
...
func TestLabelledArraysLabelledMeasuredArray_ToJSONAndFromJSON(t *testing.T) {
	list, err := listlabelledmeasuredarray.New(defaultListData)
	if err != nil {
		t.Fatalf("New list failed: %v", err)
	}
...
func TestLabelledArraysLabelledMeasuredArray_CAPIHandle(t *testing.T) {
	list, err := listlabelledmeasuredarray.New(defaultListData)
	if err != nil {
		t.Fatalf("New list failed: %v", err)
	}
...
func TestLabelledArraysLabelledMeasuredArray_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
...
func TestLabelledArraysLabelledMeasuredArray_CloseTwice(t *testing.T) {
	list, err := listlabelledmeasuredarray.New(defaultListData)
	if err != nil {
		t.Fatalf("New list failed: %v", err)
	}
