...
// eqSlice compares two slices of *labelledmeasuredarray1d.Handle pointers by dereferencing and calling Equal.
...
func fixtureAxesData() []*labelledmeasuredarray1d.Handle {
	return defaultAxesData
}
func TestAxesLabelledMeasuredArray1D_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestAxesLabelledMeasuredArray1D_NewFromSliceAndItems(t *testing.T) {
...
func TestAxesLabelledMeasuredArray1D_EraseAtAndClear(t *testing.T) {
...
func TestAxesLabelledMeasuredArray1D_IntersectionEqualNotEqual(t *testing.T) {
...
func TestAxesLabelledMeasuredArray1D_ToJSONAndFromJSON(t *testing.T) {
...
func TestAxesLabelledMeasuredArray1D_ContainsAndIndex(t *testing.T) {
...
func TestAxesLabelledMeasuredArray1D_CAPIHandle(t *testing.T) {
...
func TestAxesLabelledMeasuredArray1D_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestAxesLabelledMeasuredArray1D_CloseTwice(t *testing.T) {
	l, err := New(defaultAxesData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
