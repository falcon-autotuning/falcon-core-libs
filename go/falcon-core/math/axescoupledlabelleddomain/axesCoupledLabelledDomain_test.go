...
// eqSlice compares two slices of *coupledlabelleddomain.Handle pointers by dereferencing and calling Equal.
func eqSlice(a, b []*coupledlabelleddomain.Handle) bool {
	if len(a) != len(b) {
		return false
	}
	for i := range a {
...
func fixtureAxesData() []*coupledlabelleddomain.Handle {
	return defaultAxesData
}
func TestAxesCoupledLabelledDomain_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestAxesCoupledLabelledDomain_NewFromSliceAndItems(t *testing.T) {
...
func TestAxesCoupledLabelledDomain_EraseAtAndClear(t *testing.T) {
...
func TestAxesCoupledLabelledDomain_IntersectionEqualNotEqual(t *testing.T) {
...
func TestAxesCoupledLabelledDomain_ToJSONAndFromJSON(t *testing.T) {
...
func TestAxesCoupledLabelledDomain_ContainsAndIndex(t *testing.T) {
...
func TestAxesCoupledLabelledDomain_CAPIHandle(t *testing.T) {
...
func TestAxesCoupledLabelledDomain_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestAxesCoupledLabelledDomain_CloseTwice(t *testing.T) {
	l, err := New(defaultAxesData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
