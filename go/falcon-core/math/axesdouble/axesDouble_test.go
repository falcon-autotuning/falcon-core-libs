...
var (
	defaultAxesData = []float64{1.1, 2.2}
	val1            = float64(3.3)
	otherAxesData   = []float64{1.0}
)
...
func fixtureAxesData() []float64 {
	return defaultAxesData
}
func TestAxesDouble_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestAxesDouble_NewFromSliceAndItems(t *testing.T) {
...
func TestAxesDouble_EraseAtAndClear(t *testing.T) {
...
func TestAxesDouble_IntersectionEqualNotEqual(t *testing.T) {
...
func TestAxesDouble_ToJSONAndFromJSON(t *testing.T) {
...
func TestAxesDouble_ContainsAndIndex(t *testing.T) {
...
func TestAxesDouble_CAPIHandle(t *testing.T) {
...
func TestAxesDouble_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestAxesDouble_CloseTwice(t *testing.T) {
	l, err := New(defaultAxesData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
