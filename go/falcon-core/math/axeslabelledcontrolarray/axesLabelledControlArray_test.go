...
func fixtureAxesData() []*labelledcontrolarray.Handle {
	return defaultAxesData
}
func TestAxesLabelledControlArray_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestAxesLabelledControlArray_NewFromSliceAndItems(t *testing.T) {
...
func TestAxesLabelledControlArray_EraseAtAndClear(t *testing.T) {
...
func TestAxesLabelledControlArray_IntersectionEqualNotEqual(t *testing.T) {
...
func TestAxesLabelledControlArray_ToJSONAndFromJSON(t *testing.T) {
...
func TestAxesLabelledControlArray_ContainsAndIndex(t *testing.T) {
...
func TestAxesLabelledControlArray_CAPIHandle(t *testing.T) {
...
func TestAxesLabelledControlArray_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestAxesLabelledControlArray_CloseTwice(t *testing.T) {
	l, err := New(defaultAxesData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
