...
// eqSlice compares two slices of *mapstringbool.Handle pointers by dereferencing and calling Equal.
func eqSlice(a, b []*mapstringbool.Handle) bool {
	if len(a) != len(b) {
		return false
	}
	for i := range a {
...
func fixtureAxesData() []*mapstringbool.Handle {
	return defaultAxesData
}
func TestAxesMapStringBool_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestAxesMapStringBool_NewFromSliceAndItems(t *testing.T) {
...
func TestAxesMapStringBool_EraseAtAndClear(t *testing.T) {
...
func TestAxesMapStringBool_IntersectionEqualNotEqual(t *testing.T) {
...
func TestAxesMapStringBool_ToJSONAndFromJSON(t *testing.T) {
...
func TestAxesMapStringBool_ContainsAndIndex(t *testing.T) {
...
func TestAxesMapStringBool_CAPIHandle(t *testing.T) {
...
func TestAxesMapStringBool_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestAxesMapStringBool_CloseTwice(t *testing.T) {
	l, err := New(defaultAxesData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
