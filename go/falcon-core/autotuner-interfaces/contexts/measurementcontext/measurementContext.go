	...
	return cmemoryallocation.Read(handle, func() (*Handle, error) {
		...
		return cmemoryallocation.NewAllocation(
			func() (unsafe.Pointer, error) {
				return unsafe.Pointer(C.MeasurementContext_copy(C.MeasurementContextHandle(handle.CAPIHandle()))), nil
			},
			construct,
			destroy,
		)
...
func (h *Handle) Equal(other *Handle) (bool, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, other}, func() (bool, error) {
		return bool(C.MeasurementContext_equal(C.MeasurementContextHandle(h.CAPIHandle()), C.MeasurementContextHandle(other.CAPIHandle()))), nil
	})
}
func (h *Handle) NotEqual(other *Handle) (bool, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, other}, func() (bool, error) {
		return bool(C.MeasurementContext_not_equal(C.MeasurementContextHandle(h.CAPIHandle()), C.MeasurementContextHandle(other.CAPIHandle()))), nil
	})
}
