...
var (
	testMapHandle           *mapinterpretationcontextdouble.Handle
	...
	testValue               float64
	testValue2              float64
	testOtherValue          float64
	testJSON                string
	testListPair            *listpairinterpretationcontextdouble.Handle
	testListValue           *listdouble.Handle
...
func setupHandles() {
	...
	// Example:
	// testMapHandle, _ = mapinterpretationcontextdouble.New(...)
