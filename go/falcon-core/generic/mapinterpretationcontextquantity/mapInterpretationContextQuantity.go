...
func New(data []*pairinterpretationcontextquantity.Handle) (*Handle, error) {
	...
	return cmemoryallocation.NewAllocation(
		func() (unsafe.Pointer, error) {
			return unsafe.Pointer(C.MapInterpretationContextQuantity_create(&list[0], C.size_t(len(data)))), nil
		},
		construct,
		destroy,
	)
...
func (h *Handle) Size() (uint32, error) {
	return cmemoryallocation.Read(h, func() (uint32, error) {
		return uint32(C.MapInterpretationContextQuantity_size(C.MapInterpretationContextQuantityHandle(h.CAPIHandle()))), nil
	})
}
...
func (h *Handle) Equal(b *Handle) (bool, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, b}, func() (bool, error) {
		return bool(C.MapInterpretationContextQuantity_equal(C.MapInterpretationContextQuantityHandle(h.CAPIHandle()), C.MapInterpretationContextQuantityHandle(b.CAPIHandle()))), nil
	})
}
func (h *Handle) NotEqual(b *Handle) (bool, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, b}, func() (bool, error) {
		return bool(C.MapInterpretationContextQuantity_not_equal(C.MapInterpretationContextQuantityHandle(h.CAPIHandle()), C.MapInterpretationContextQuantityHandle(b.CAPIHandle()))), nil
	})
}
