...
// eqSlice compares two slices of *labelleddomain.Handle pointers by dereferencing and calling Equal.
func eqSlice(a, b []*labelleddomain.Handle) bool {
	if len(a) != len(b) {
		return false
	}
	for i := range a {
...
func fixtureListData() []*labelleddomain.Handle {
	return defaultListData
}
func TestListLabelledDomain_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestListLabelledDomain_NewFromSliceAndItems(t *testing.T) {
...
func TestListLabelledDomain_EraseAtAndClear(t *testing.T) {
...
func TestListLabelledDomain_IntersectionEqualNotEqual(t *testing.T) {
...
func TestListLabelledDomain_ToJSONAndFromJSON(t *testing.T) {
...
func TestListLabelledDomain_ContainsAndIndex(t *testing.T) {
...
func TestListLabelledDomain_CAPIHandle(t *testing.T) {
...
func TestListLabelledDomain_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestListLabelledDomain_CloseTwice(t *testing.T) {
	l, err := New(defaultListData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
