...
// eqSlice compares two slices of *pairchannelconnections.Handle pointers by dereferencing and calling Equal.
func eqSlice(a, b []*pairchannelconnections.Handle) bool {
	if len(a) != len(b) {
		return false
	}
	for i := range a {
...
func fixtureListData() []*pairchannelconnections.Handle {
	return defaultListData
}
func TestListPairChannelConnections_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestListPairChannelConnections_NewFromSliceAndItems(t *testing.T) {
...
func TestListPairChannelConnections_EraseAtAndClear(t *testing.T) {
...
func TestListPairChannelConnections_IntersectionEqualNotEqual(t *testing.T) {
...
func TestListPairChannelConnections_ToJSONAndFromJSON(t *testing.T) {
...
func TestListPairChannelConnections_ContainsAndIndex(t *testing.T) {
...
func TestListPairChannelConnections_CAPIHandle(t *testing.T) {
...
func TestListPairChannelConnections_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestListPairChannelConnections_CloseTwice(t *testing.T) {
	l, err := New(defaultListData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
