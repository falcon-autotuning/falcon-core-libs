...
var (
	...
	destroy = func(ptr unsafe.Pointer) {
		C.PairConnectionQuantity_destroy(C.PairConnectionQuantityHandle(ptr))
	}
)
...
func New(first *connection.Handle, second *quantity.Handle) (*Handle, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{first, second}, func() (*Handle, error) {

		return cmemoryallocation.NewAllocation(
			func() (unsafe.Pointer, error) {
				return unsafe.Pointer(C.PairConnectionQuantity_create(C.ConnectionHandle(first.CAPIHandle()), C.QuantityHandle(second.CAPIHandle()))), nil
			},
			construct,
			destroy,
		)
...
func (h *Handle) First() (*connection.Handle, error) {
	return cmemoryallocation.Read(h, func() (*connection.Handle, error) {
		...
		return connection.FromCAPI(unsafe.Pointer(C.PairConnectionQuantity_first(C.PairConnectionQuantityHandle(h.CAPIHandle()))))
	})
}
...
func (h *Handle) ToJSON() (string, error) {
	return cmemoryallocation.Read(h, func() (string, error) {
		...
		strObj, err := str.FromCAPI(unsafe.Pointer(C.PairConnectionQuantity_to_json_string(C.PairConnectionQuantityHandle(h.CAPIHandle()))))
		if err != nil {
...
func FromJSON(json string) (*Handle, error) {
	...
	return cmemoryallocation.Read(realjson, func() (*Handle, error) {
		...
		return cmemoryallocation.NewAllocation(
			func() (unsafe.Pointer, error) {
				return unsafe.Pointer(C.PairConnectionQuantity_from_json_string(C.StringHandle(realjson.CAPIHandle()))), nil
			},
			construct,
			destroy,
		)
