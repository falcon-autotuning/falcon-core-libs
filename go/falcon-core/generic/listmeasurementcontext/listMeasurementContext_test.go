...
func fixtureListData() []*measurementcontext.Handle {
	return defaultListData
}
func TestListMeasurementContext_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestListMeasurementContext_NewFromSliceAndItems(t *testing.T) {
...
func TestListMeasurementContext_EraseAtAndClear(t *testing.T) {
...
func TestListMeasurementContext_IntersectionEqualNotEqual(t *testing.T) {
...
func TestListMeasurementContext_ToJSONAndFromJSON(t *testing.T) {
...
func TestListMeasurementContext_ContainsAndIndex(t *testing.T) {
...
func TestListMeasurementContext_CAPIHandle(t *testing.T) {
...
func TestListMeasurementContext_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestListMeasurementContext_CloseTwice(t *testing.T) {
	l, err := New(defaultListData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
