...
// eqSlice compares two slices of *gname.Handle pointers by dereferencing and calling Equal.
func eqSlice(a, b []*gname.Handle) bool {
	if len(a) != len(b) {
		return false
	}
	for i := range a {
...
func fixtureListData() []*gname.Handle {
	return defaultListData
}
func TestListGname_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestListGname_NewFromSliceAndItems(t *testing.T) {
...
func TestListGname_EraseAtAndClear(t *testing.T) {
...
func TestListGname_IntersectionEqualNotEqual(t *testing.T) {
...
func TestListGname_ToJSONAndFromJSON(t *testing.T) {
...
func TestListGname_ContainsAndIndex(t *testing.T) {
...
func TestListGname_CAPIHandle(t *testing.T) {
...
func TestListGname_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestListGname_CloseTwice(t *testing.T) {
	l, err := New(defaultListData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
