...
var (
	defaultFirst  = float32(1.1)
	defaultSecond = float32(2.2)
	otherFirst    = float32(3.3)
	otherSecond   = float32(4.4)
)

func TestPairFloatFloat_NewAndAccessors(t *testing.T) {
...
func TestPairFloatFloat_EqualAndNotEqual(t *testing.T) {
...
func TestPairFloatFloat_ToJSONAndFromJSON(t *testing.T) {
	p, err := New(defaultFirst, defaultSecond)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
...
func TestPairFloatFloat_CAPIHandle(t *testing.T) {
	p, err := New(defaultFirst, defaultSecond)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
...
func TestPairFloatFloat_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
...
func TestPairFloatFloat_CloseTwice(t *testing.T) {
	p, err := New(defaultFirst, defaultSecond)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
...
func pairFirstEqual(a, b float32) bool {
