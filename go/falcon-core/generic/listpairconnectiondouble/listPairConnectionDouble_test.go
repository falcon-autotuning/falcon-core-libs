...
// eqSlice compares two slices of *pairconnectiondouble.Handle pointers by dereferencing and calling Equal.
func eqSlice(a, b []*pairconnectiondouble.Handle) bool {
	if len(a) != len(b) {
		return false
	}
	for i := range a {
...
func fixtureListData() []*pairconnectiondouble.Handle {
	return defaultListData
}
func TestListPairConnectionDouble_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestListPairConnectionDouble_NewFromSliceAndItems(t *testing.T) {
...
func TestListPairConnectionDouble_EraseAtAndClear(t *testing.T) {
...
func TestListPairConnectionDouble_IntersectionEqualNotEqual(t *testing.T) {
...
func TestListPairConnectionDouble_ToJSONAndFromJSON(t *testing.T) {
...
func TestListPairConnectionDouble_ContainsAndIndex(t *testing.T) {
...
func TestListPairConnectionDouble_CAPIHandle(t *testing.T) {
...
func TestListPairConnectionDouble_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestListPairConnectionDouble_CloseTwice(t *testing.T) {
	l, err := New(defaultListData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
