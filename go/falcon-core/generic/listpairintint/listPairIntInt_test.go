...
// eqSlice compares two slices of *pairintint.Handle pointers by dereferencing and calling Equal.
func eqSlice(a, b []*pairintint.Handle) bool {
	if len(a) != len(b) {
		return false
	}
	for i := range a {
...
func fixtureListData() []*pairintint.Handle {
	return defaultListData
}
func TestListPairIntInt_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestListPairIntInt_NewFromSliceAndItems(t *testing.T) {
...
func TestListPairIntInt_EraseAtAndClear(t *testing.T) {
...
func TestListPairIntInt_IntersectionEqualNotEqual(t *testing.T) {
...
func TestListPairIntInt_ToJSONAndFromJSON(t *testing.T) {
...
func TestListPairIntInt_ContainsAndIndex(t *testing.T) {
...
func TestListPairIntInt_CAPIHandle(t *testing.T) {
...
func TestListPairIntInt_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestListPairIntInt_CloseTwice(t *testing.T) {
	l, err := New(defaultListData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
