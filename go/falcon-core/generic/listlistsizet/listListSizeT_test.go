...
// eqSlice compares two slices of *listsizet.Handle pointers by dereferencing and calling Equal.
func eqSlice(a, b []*listsizet.Handle) bool {
	if len(a) != len(b) {
		return false
	}
	for i := range a {
...
func fixtureListData() []*listsizet.Handle {
	return defaultListData
}
func TestListListSizeT_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestListListSizeT_NewFromSliceAndItems(t *testing.T) {
...
func TestListListSizeT_EraseAtAndClear(t *testing.T) {
...
func TestListListSizeT_IntersectionEqualNotEqual(t *testing.T) {
...
func TestListListSizeT_ToJSONAndFromJSON(t *testing.T) {
...
func TestListListSizeT_ContainsAndIndex(t *testing.T) {
...
func TestListListSizeT_CAPIHandle(t *testing.T) {
...
func TestListListSizeT_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestListListSizeT_CloseTwice(t *testing.T) {
	l, err := New(defaultListData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
