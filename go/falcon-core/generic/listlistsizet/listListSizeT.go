...
func FillValue(count uint32, value *listsizet.Handle) (*Handle, error) {
...
func New(data []*listsizet.Handle) (*Handle, error) {
	list := make([]C.ListSizeTHandle, len(data))
	for i, v := range data {
		list[i] = C.ListSizeTHandle(v)
	}
	return cmemoryallocation.NewAllocation(
		func() (unsafe.Pointer, error) {
			return unsafe.Pointer(C.ListListSizeT_create(&list[0], C.size_t(len(data)))), nil
		},
		construct,
		destroy,
	)
...
func (h *Handle) Size() (uint32, error) {
	return cmemoryallocation.Read(h, func() (uint32, error) {
		return uint32(C.ListListSizeT_size(C.ListListSizeTHandle(h.CAPIHandle()))), nil
	})
}
...
func (h *Handle) At(idx uint32) (*listsizet.Handle, error) {
...
func (h *Handle) Index(value *listsizet.Handle) (uint32, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, value}, func() (uint32, error) {
		return uint32(C.ListListSizeT_index(C.ListListSizeTHandle(h.CAPIHandle()), C.ListSizeTHandle(value.CAPIHandle()))), nil
	})
}
...
func (h *Handle) Equal(b *Handle) (bool, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, b}, func() (bool, error) {
		return bool(C.ListListSizeT_equal(C.ListListSizeTHandle(h.CAPIHandle()), C.ListListSizeTHandle(b.CAPIHandle()))), nil
	})
}
func (h *Handle) NotEqual(b *Handle) (bool, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, b}, func() (bool, error) {
		return bool(C.ListListSizeT_not_equal(C.ListListSizeTHandle(h.CAPIHandle()), C.ListListSizeTHandle(b.CAPIHandle()))), nil
	})
}
