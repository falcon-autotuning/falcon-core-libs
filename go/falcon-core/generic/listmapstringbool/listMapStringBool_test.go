...
func fixtureListData() []*mapstringbool.Handle {
	return defaultListData
}
func TestListMapStringBool_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestListMapStringBool_NewFromSliceAndItems(t *testing.T) {
...
func TestListMapStringBool_EraseAtAndClear(t *testing.T) {
...
func TestListMapStringBool_IntersectionEqualNotEqual(t *testing.T) {
...
func TestListMapStringBool_ToJSONAndFromJSON(t *testing.T) {
...
func TestListMapStringBool_ContainsAndIndex(t *testing.T) {
...
func TestListMapStringBool_CAPIHandle(t *testing.T) {
...
func TestListMapStringBool_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestListMapStringBool_CloseTwice(t *testing.T) {
	l, err := New(defaultListData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
