...
// eqSlice compares two slices of *pairquantityquantity.Handle pointers by dereferencing and calling Equal.
func eqSlice(a, b []*pairquantityquantity.Handle) bool {
	if len(a) != len(b) {
		return false
	}
	for i := range a {
...
func fixtureListData() []*pairquantityquantity.Handle {
	return defaultListData
}
func TestListPairQuantityQuantity_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestListPairQuantityQuantity_NewFromSliceAndItems(t *testing.T) {
...
func TestListPairQuantityQuantity_EraseAtAndClear(t *testing.T) {
...
func TestListPairQuantityQuantity_IntersectionEqualNotEqual(t *testing.T) {
...
func TestListPairQuantityQuantity_ToJSONAndFromJSON(t *testing.T) {
...
func TestListPairQuantityQuantity_ContainsAndIndex(t *testing.T) {
...
func TestListPairQuantityQuantity_CAPIHandle(t *testing.T) {
...
func TestListPairQuantityQuantity_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestListPairQuantityQuantity_CloseTwice(t *testing.T) {
	l, err := New(defaultListData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
