...
func TestListLabelledControlArray1D_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestListLabelledControlArray1D_NewFromSliceAndItems(t *testing.T) {
...
func TestListLabelledControlArray1D_EraseAtAndClear(t *testing.T) {
...
func TestListLabelledControlArray1D_IntersectionEqualNotEqual(t *testing.T) {
...
func TestListLabelledControlArray1D_ToJSONAndFromJSON(t *testing.T) {
...
func TestListLabelledControlArray1D_ContainsAndIndex(t *testing.T) {
...
func TestListLabelledControlArray1D_CAPIHandle(t *testing.T) {
...
func TestListLabelledControlArray1D_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestListLabelledControlArray1D_CloseTwice(t *testing.T) {
	l, err := New(defaultListData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
