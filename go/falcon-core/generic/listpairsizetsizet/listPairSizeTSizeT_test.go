...
// eqSlice compares two slices of *pairsizetsizet.Handle pointers by dereferencing and calling Equal.
func eqSlice(a, b []*pairsizetsizet.Handle) bool {
	if len(a) != len(b) {
		return false
	}
	for i := range a {
...
func fixtureListData() []*pairsizetsizet.Handle {
	return defaultListData
}
func TestListPairSizeTSizeT_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestListPairSizeTSizeT_NewFromSliceAndItems(t *testing.T) {
...
func TestListPairSizeTSizeT_EraseAtAndClear(t *testing.T) {
...
func TestListPairSizeTSizeT_IntersectionEqualNotEqual(t *testing.T) {
...
func TestListPairSizeTSizeT_ToJSONAndFromJSON(t *testing.T) {
...
func TestListPairSizeTSizeT_ContainsAndIndex(t *testing.T) {
...
func TestListPairSizeTSizeT_CAPIHandle(t *testing.T) {
...
func TestListPairSizeTSizeT_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestListPairSizeTSizeT_CloseTwice(t *testing.T) {
	l, err := New(defaultListData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
