...
// eqSlice compares two slices of *pairstringbool.Handle pointers by dereferencing and calling Equal.
func eqSlice(a, b []*pairstringbool.Handle) bool {
	if len(a) != len(b) {
		return false
	}
	for i := range a {
...
func fixtureListData() []*pairstringbool.Handle {
	return defaultListData
}
func TestListPairStringBool_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestListPairStringBool_NewFromSliceAndItems(t *testing.T) {
...
func TestListPairStringBool_EraseAtAndClear(t *testing.T) {
...
func TestListPairStringBool_IntersectionEqualNotEqual(t *testing.T) {
...
func TestListPairStringBool_ToJSONAndFromJSON(t *testing.T) {
...
func TestListPairStringBool_ContainsAndIndex(t *testing.T) {
...
func TestListPairStringBool_CAPIHandle(t *testing.T) {
...
func TestListPairStringBool_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestListPairStringBool_CloseTwice(t *testing.T) {
	l, err := New(defaultListData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
