...
// eqSlice compares two slices of *quantity.Handle pointers by dereferencing and calling Equal.
func eqSlice(a, b []*quantity.Handle) bool {
	if len(a) != len(b) {
		return false
	}
	for i := range a {
...
func fixtureListData() []*quantity.Handle {
	return defaultListData
}
func TestListQuantity_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestListQuantity_NewFromSliceAndItems(t *testing.T) {
...
func TestListQuantity_EraseAtAndClear(t *testing.T) {
...
func TestListQuantity_IntersectionEqualNotEqual(t *testing.T) {
...
func TestListQuantity_ToJSONAndFromJSON(t *testing.T) {
...
func TestListQuantity_ContainsAndIndex(t *testing.T) {
...
func TestListQuantity_CAPIHandle(t *testing.T) {
...
func TestListQuantity_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestListQuantity_CloseTwice(t *testing.T) {
	l, err := New(defaultListData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
