...
// eqSlice compares two slices of *pairinterpretationcontextdouble.Handle pointers by dereferencing and calling Equal.
func eqSlice(a, b []*pairinterpretationcontextdouble.Handle) bool {
	if len(a) != len(b) {
		return false
	}
	for i := range a {
...
func fixtureListData() []*pairinterpretationcontextdouble.Handle {
	return defaultListData
}
func TestListPairInterpretationContextDouble_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestListPairInterpretationContextDouble_NewFromSliceAndItems(t *testing.T) {
...
func TestListPairInterpretationContextDouble_EraseAtAndClear(t *testing.T) {
...
func TestListPairInterpretationContextDouble_IntersectionEqualNotEqual(t *testing.T) {
...
func TestListPairInterpretationContextDouble_ToJSONAndFromJSON(t *testing.T) {
...
func TestListPairInterpretationContextDouble_ContainsAndIndex(t *testing.T) {
...
func TestListPairInterpretationContextDouble_CAPIHandle(t *testing.T) {
...
func TestListPairInterpretationContextDouble_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestListPairInterpretationContextDouble_CloseTwice(t *testing.T) {
	l, err := New(defaultListData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
