...
var (
	defaultFirst  = g1
	defaultSecond = defaultGroup
	otherFirst    = g2
	otherSecond   = otherGroup
)

func TestPairGnameGroup_NewAndAccessors(t *testing.T) {
...
func TestPairGnameGroup_EqualAndNotEqual(t *testing.T) {
...
func TestPairGnameGroup_ToJSONAndFromJSON(t *testing.T) {
	p, err := New(defaultFirst, defaultSecond)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
...
func TestPairGnameGroup_CAPIHandle(t *testing.T) {
	p, err := New(defaultFirst, defaultSecond)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
...
func TestPairGnameGroup_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
...
func TestPairGnameGroup_CloseTwice(t *testing.T) {
	p, err := New(defaultFirst, defaultSecond)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
...
func pairFirstEqual(a, b *gname.Handle) bool {
	
	eq, err := a.Equal(b)
	return err == nil && eq
	
}
func pairSecondEqual(a, b *group.Handle) bool {
