...
// eqSlice compares two slices of *pairinterpretationcontextstring.Handle pointers by dereferencing and calling Equal.
func eqSlice(a, b []*pairinterpretationcontextstring.Handle) bool {
	if len(a) != len(b) {
		return false
	}
	for i := range a {
...
func fixtureListData() []*pairinterpretationcontextstring.Handle {
	return defaultListData
}
func TestListPairInterpretationContextString_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestListPairInterpretationContextString_NewFromSliceAndItems(t *testing.T) {
...
func TestListPairInterpretationContextString_EraseAtAndClear(t *testing.T) {
...
func TestListPairInterpretationContextString_IntersectionEqualNotEqual(t *testing.T) {
...
func TestListPairInterpretationContextString_ToJSONAndFromJSON(t *testing.T) {
...
func TestListPairInterpretationContextString_ContainsAndIndex(t *testing.T) {
...
func TestListPairInterpretationContextString_CAPIHandle(t *testing.T) {
...
func TestListPairInterpretationContextString_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestListPairInterpretationContextString_CloseTwice(t *testing.T) {
	l, err := New(defaultListData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
