...
var (
	defaultListData = []bool{true,false}
	val1            = bool(true)
	otherListData   = []bool{true}
)
func eqSlice(a, b []bool) bool {
	return reflect.DeepEqual(a, b)
}

func fixtureListData() []bool {
	return defaultListData
}
func TestListBool_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestListBool_NewAllocateAndFillValue(t *testing.T) {
...
func TestListBool_NewFromSliceAndItems(t *testing.T) {
...
func TestListBool_EraseAtAndClear(t *testing.T) {
...
func TestListBool_IntersectionEqualNotEqual(t *testing.T) {
...
func TestListBool_ToJSONAndFromJSON(t *testing.T) {
...
func TestListBool_ContainsAndIndex(t *testing.T) {
...
func TestListBool_CAPIHandle(t *testing.T) {
...
func TestListBool_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestListBool_CloseTwice(t *testing.T) {
	l, err := New(defaultListData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
