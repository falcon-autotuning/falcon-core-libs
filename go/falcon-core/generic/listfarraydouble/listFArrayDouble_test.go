...
// eqSlice compares two slices of *farraydouble.Handle pointers by dereferencing and calling Equal.
func eqSlice(a, b []*farraydouble.Handle) bool {
	if len(a) != len(b) {
		return false
	}
	for i := range a {
...
func fixtureListData() []*farraydouble.Handle {
	return defaultListData
}
func TestListFArrayDouble_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestListFArrayDouble_NewFromSliceAndItems(t *testing.T) {
...
func TestListFArrayDouble_EraseAtAndClear(t *testing.T) {
...
func TestListFArrayDouble_IntersectionEqualNotEqual(t *testing.T) {
...
func TestListFArrayDouble_ToJSONAndFromJSON(t *testing.T) {
...
func TestListFArrayDouble_ContainsAndIndex(t *testing.T) {
...
func TestListFArrayDouble_CAPIHandle(t *testing.T) {
...
func TestListFArrayDouble_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestListFArrayDouble_CloseTwice(t *testing.T) {
	l, err := New(defaultListData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
