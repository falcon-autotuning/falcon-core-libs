...
func FillValue(count uint32, value *farraydouble.Handle) (*Handle, error) {
...
func New(data []*farraydouble.Handle) (*Handle, error) {
	list := make([]C.FArrayDoubleHandle, len(data))
	for i, v := range data {
		list[i] = C.FArrayDoubleHandle(v)
	}
	return cmemoryallocation.NewAllocation(
		func() (unsafe.Pointer, error) {
			return unsafe.Pointer(C.ListFArrayDouble_create(&list[0], C.size_t(len(data)))), nil
		},
		construct,
		destroy,
	)
...
func (h *Handle) Size() (uint32, error) {
	return cmemoryallocation.Read(h, func() (uint32, error) {
		return uint32(C.ListFArrayDouble_size(C.ListFArrayDoubleHandle(h.CAPIHandle()))), nil
	})
}
...
func (h *Handle) At(idx uint32) (*farraydouble.Handle, error) {
...
func (h *Handle) Index(value *farraydouble.Handle) (uint32, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, value}, func() (uint32, error) {
		return uint32(C.ListFArrayDouble_index(C.ListFArrayDoubleHandle(h.CAPIHandle()), C.FArrayDoubleHandle(value.CAPIHandle()))), nil
	})
}
...
func (h *Handle) Equal(b *Handle) (bool, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, b}, func() (bool, error) {
		return bool(C.ListFArrayDouble_equal(C.ListFArrayDoubleHandle(h.CAPIHandle()), C.ListFArrayDoubleHandle(b.CAPIHandle()))), nil
	})
}
func (h *Handle) NotEqual(b *Handle) (bool, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, b}, func() (bool, error) {
		return bool(C.ListFArrayDouble_not_equal(C.ListFArrayDoubleHandle(h.CAPIHandle()), C.ListFArrayDoubleHandle(b.CAPIHandle()))), nil
	})
}
