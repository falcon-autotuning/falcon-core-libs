...
func fixtureListData() []*coupledlabelleddomain.Handle {
	return defaultListData
}
func TestListCoupledLabelledDomain_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestListCoupledLabelledDomain_NewFromSliceAndItems(t *testing.T) {
...
func TestListCoupledLabelledDomain_EraseAtAndClear(t *testing.T) {
...
func TestListCoupledLabelledDomain_IntersectionEqualNotEqual(t *testing.T) {
...
func TestListCoupledLabelledDomain_ToJSONAndFromJSON(t *testing.T) {
...
func TestListCoupledLabelledDomain_ContainsAndIndex(t *testing.T) {
...
func TestListCoupledLabelledDomain_CAPIHandle(t *testing.T) {
...
func TestListCoupledLabelledDomain_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestListCoupledLabelledDomain_CloseTwice(t *testing.T) {
	l, err := New(defaultListData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
