...
func (h *Handle) Equal(b *Handle) (bool, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, b}, func() (bool, error) {
		return bool(C.PairConnectionPairQuantityQuantity_equal(C.PairConnectionPairQuantityQuantityHandle(h.CAPIHandle()), C.PairConnectionPairQuantityQuantityHandle(b.CAPIHandle()))), nil
	})
}
func (h *Handle) NotEqual(b *Handle) (bool, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, b}, func() (bool, error) {
		return bool(C.PairConnectionPairQuantityQuantity_not_equal(C.PairConnectionPairQuantityQuantityHandle(h.CAPIHandle()), C.PairConnectionPairQuantityQuantityHandle(b.CAPIHandle()))), nil
	})
}
