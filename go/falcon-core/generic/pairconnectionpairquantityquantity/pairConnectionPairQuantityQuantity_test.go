...
var (
	defaultFirst  = defaultConnection
	defaultSecond = defaultPairQuantityQuantity
	otherFirst    = otherConnection
	otherSecond   = otherPairQuantityQuantity
)

func TestPairConnectionPairQuantityQuantity_NewAndAccessors(t *testing.T) {
...
func TestPairConnectionPairQuantityQuantity_EqualAndNotEqual(t *testing.T) {
...
func TestPairConnectionPairQuantityQuantity_ToJSONAndFromJSON(t *testing.T) {
	p, err := New(defaultFirst, defaultSecond)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
...
func TestPairConnectionPairQuantityQuantity_CAPIHandle(t *testing.T) {
	p, err := New(defaultFirst, defaultSecond)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
...
func TestPairConnectionPairQuantityQuantity_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
...
func TestPairConnectionPairQuantityQuantity_CloseTwice(t *testing.T) {
	p, err := New(defaultFirst, defaultSecond)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
...
func pairFirstEqual(a, b *connection.Handle) bool {
	
	eq, err := a.Equal(b)
	return err == nil && eq
	
}
func pairSecondEqual(a, b *pairquantityquantity.Handle) bool {
