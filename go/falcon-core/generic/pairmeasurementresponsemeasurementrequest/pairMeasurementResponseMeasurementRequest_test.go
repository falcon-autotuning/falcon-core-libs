...
var (
	defaultFirst  = defaultresponse
	defaultSecond = defaultrequest
	otherFirst    = otherresponse
	otherSecond   = otherrequest
)

func TestPairMeasurementResponseMeasurementRequest_NewAndAccessors(t *testing.T) {
...
func TestPairMeasurementResponseMeasurementRequest_EqualAndNotEqual(t *testing.T) {
...
func TestPairMeasurementResponseMeasurementRequest_ToJSONAndFromJSON(t *testing.T) {
	p, err := New(defaultFirst, defaultSecond)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
...
func TestPairMeasurementResponseMeasurementRequest_CAPIHandle(t *testing.T) {
	p, err := New(defaultFirst, defaultSecond)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
...
func TestPairMeasurementResponseMeasurementRequest_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
...
func TestPairMeasurementResponseMeasurementRequest_CloseTwice(t *testing.T) {
	p, err := New(defaultFirst, defaultSecond)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
...
func pairFirstEqual(a, b *measurementresponse.Handle) bool {
	
	eq, err := a.Equal(b)
	return err == nil && eq
	
}
func pairSecondEqual(a, b *measurementrequest.Handle) bool {
