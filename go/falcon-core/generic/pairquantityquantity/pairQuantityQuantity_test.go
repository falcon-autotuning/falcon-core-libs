...
var (
	defaultFirst  = defaultQuantity
	defaultSecond = defaultQuantity2
	otherFirst    = otherQuantity
	otherSecond   = otherQuantity2
)

func TestPairQuantityQuantity_NewAndAccessors(t *testing.T) {
...
func TestPairQuantityQuantity_EqualAndNotEqual(t *testing.T) {
...
func TestPairQuantityQuantity_ToJSONAndFromJSON(t *testing.T) {
	p, err := New(defaultFirst, defaultSecond)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
...
func TestPairQuantityQuantity_CAPIHandle(t *testing.T) {
	p, err := New(defaultFirst, defaultSecond)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
...
func TestPairQuantityQuantity_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
...
func TestPairQuantityQuantity_CloseTwice(t *testing.T) {
	p, err := New(defaultFirst, defaultSecond)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
...
func pairFirstEqual(a, b *quantity.Handle) bool {
