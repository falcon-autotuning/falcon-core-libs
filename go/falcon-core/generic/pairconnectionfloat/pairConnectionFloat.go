...
var (
	...
	destroy = func(ptr unsafe.Pointer) {
		C.PairConnectionFloat_destroy(C.PairConnectionFloatHandle(ptr))
	}
)
...
func New(first *connection.Handle, second float32) (*Handle, error) {
	return cmemoryallocation.Read(first, func() (*Handle, error) {

		return cmemoryallocation.NewAllocation(
			func() (unsafe.Pointer, error) {
				return unsafe.Pointer(C.PairConnectionFloat_create(C.ConnectionHandle(first.CAPIHandle()), C.float(second))), nil
			},
			construct,
			destroy,
		)
...
func (h *Handle) First() (*connection.Handle, error) {
	return cmemoryallocation.Read(h, func() (*connection.Handle, error) {
		...
		return connection.FromCAPI(unsafe.Pointer(C.PairConnectionFloat_first(C.PairConnectionFloatHandle(h.CAPIHandle()))))
	})
}
...
func (h *Handle) ToJSON() (string, error) {
	return cmemoryallocation.Read(h, func() (string, error) {
		...
		strObj, err := str.FromCAPI(unsafe.Pointer(C.PairConnectionFloat_to_json_string(C.PairConnectionFloatHandle(h.CAPIHandle()))))
		if err != nil {
...
func FromJSON(json string) (*Handle, error) {
	...
	return cmemoryallocation.Read(realjson, func() (*Handle, error) {
		...
		return cmemoryallocation.NewAllocation(
			func() (unsafe.Pointer, error) {
				return unsafe.Pointer(C.PairConnectionFloat_from_json_string(C.StringHandle(realjson.CAPIHandle()))), nil
			},
			construct,
			destroy,
		)
