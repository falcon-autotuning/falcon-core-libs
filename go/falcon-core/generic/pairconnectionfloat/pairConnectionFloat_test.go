...
var (
	...
	defaultSecond = float32(2.2)
	otherFirst    = otherConnection
	otherSecond   = float32(4.4)
)

func TestPairConnectionFloat_NewAndAccessors(t *testing.T) {
...
func TestPairConnectionFloat_EqualAndNotEqual(t *testing.T) {
...
func TestPairConnectionFloat_ToJSONAndFromJSON(t *testing.T) {
	p, err := New(defaultFirst, defaultSecond)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
...
func TestPairConnectionFloat_CAPIHandle(t *testing.T) {
	p, err := New(defaultFirst, defaultSecond)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
...
func TestPairConnectionFloat_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
...
func TestPairConnectionFloat_CloseTwice(t *testing.T) {
	p, err := New(defaultFirst, defaultSecond)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
...
func pairSecondEqual(a, b float32) bool {
