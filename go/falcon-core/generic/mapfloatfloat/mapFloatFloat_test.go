...
var (
	defaultKey   = float32(42)
	defaultValue = float32(24)
	otherKey     = float32(99)
	otherValue   = float32(11)
)

func TestMapFloatFloat_NewEmptyAndBasicOps(t *testing.T) {
	m, err := NewEmpty()
	if err != nil {
...
func TestMapFloatFloat_InsertAndAt(t *testing.T) {
	m, err := NewEmpty()
	if err != nil {
		t.Fatalf("NewEmpty failed: %v", err)
	}
...
func TestMapFloatFloat_InsertOrAssign(t *testing.T) {
	m, err := NewEmpty()
	if err != nil {
		t.Fatalf("NewEmpty failed: %v", err)
	}
...
func TestMapFloatFloat_EraseAndClear(t *testing.T) {
	m, err := NewEmpty()
	if err != nil {
		t.Fatalf("NewEmpty failed: %v", err)
	}
...
func TestMapFloatFloat_Contains(t *testing.T) {
	m, err := NewEmpty()
	if err != nil {
		t.Fatalf("NewEmpty failed: %v", err)
	}
...
func TestMapFloatFloat_KeysValuesItems(t *testing.T) {
	m, err := NewEmpty()
	if err != nil {
		t.Fatalf("NewEmpty failed: %v", err)
	}
...
func TestMapFloatFloat_EqualAndNotEqual(t *testing.T) {
	m1, err := NewEmpty()
	if err != nil {
		t.Fatalf("NewEmpty failed: %v", err)
	}
...
func TestMapFloatFloat_ToJSONAndFromJSON(t *testing.T) {
	m, err := NewEmpty()
	if err != nil {
		t.Fatalf("NewEmpty failed: %v", err)
	}
...
func TestMapFloatFloat_CAPIHandle(t *testing.T) {
	m, err := NewEmpty()
	if err != nil {
		t.Fatalf("NewEmpty failed: %v", err)
	}
...
func TestMapFloatFloat_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
...
func TestMapFloatFloat_CloseTwice(t *testing.T) {
	m, err := NewEmpty()
	if err != nil {
		t.Fatalf("NewEmpty failed: %v", err)
	}
