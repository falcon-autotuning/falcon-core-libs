...
func FillValue(count uint32, value *pairinstrumentportporttransform.Handle) (*Handle, error) {
...
func New(data []*pairinstrumentportporttransform.Handle) (*Handle, error) {
	...
	return cmemoryallocation.NewAllocation(
		func() (unsafe.Pointer, error) {
			return unsafe.Pointer(C.ListPairInstrumentPortPortTransform_create(&list[0], C.size_t(len(data)))), nil
		},
		construct,
		destroy,
	)
...
func (h *Handle) Size() (uint32, error) {
	return cmemoryallocation.Read(h, func() (uint32, error) {
		return uint32(C.ListPairInstrumentPortPortTransform_size(C.ListPairInstrumentPortPortTransformHandle(h.CAPIHandle()))), nil
	})
}
...
func (h *Handle) At(idx uint32) (*pairinstrumentportporttransform.Handle, error) {
...
func (h *Handle) Index(value *pairinstrumentportporttransform.Handle) (uint32, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, value}, func() (uint32, error) {
		return uint32(C.ListPairInstrumentPortPortTransform_index(C.ListPairInstrumentPortPortTransformHandle(h.CAPIHandle()), C.PairInstrumentPortPortTransformHandle(value.CAPIHandle()))), nil
	})
}
...
func (h *Handle) Equal(b *Handle) (bool, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, b}, func() (bool, error) {
		return bool(C.ListPairInstrumentPortPortTransform_equal(C.ListPairInstrumentPortPortTransformHandle(h.CAPIHandle()), C.ListPairInstrumentPortPortTransformHandle(b.CAPIHandle()))), nil
	})
}
func (h *Handle) NotEqual(b *Handle) (bool, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, b}, func() (bool, error) {
		return bool(C.ListPairInstrumentPortPortTransform_not_equal(C.ListPairInstrumentPortPortTransformHandle(h.CAPIHandle()), C.ListPairInstrumentPortPortTransformHandle(b.CAPIHandle()))), nil
	})
}
