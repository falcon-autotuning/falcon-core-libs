...
// eqSlice compares two slices of *pairinstrumentportporttransform.Handle pointers by dereferencing and calling Equal.
func eqSlice(a, b []*pairinstrumentportporttransform.Handle) bool {
	if len(a) != len(b) {
		return false
	}
	for i := range a {
...
func fixtureListData() []*pairinstrumentportporttransform.Handle {
	return defaultListData
}
func TestListPairInstrumentPortPortTransform_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestListPairInstrumentPortPortTransform_NewFromSliceAndItems(t *testing.T) {
...
func TestListPairInstrumentPortPortTransform_EraseAtAndClear(t *testing.T) {
...
func TestListPairInstrumentPortPortTransform_IntersectionEqualNotEqual(t *testing.T) {
...
func TestListPairInstrumentPortPortTransform_ToJSONAndFromJSON(t *testing.T) {
...
func TestListPairInstrumentPortPortTransform_ContainsAndIndex(t *testing.T) {
...
func TestListPairInstrumentPortPortTransform_CAPIHandle(t *testing.T) {
...
func TestListPairInstrumentPortPortTransform_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestListPairInstrumentPortPortTransform_CloseTwice(t *testing.T) {
	l, err := New(defaultListData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
