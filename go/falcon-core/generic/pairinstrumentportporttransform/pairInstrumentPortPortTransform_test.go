...
var (
	defaultFirst  = defaultInstrumentPort
	defaultSecond = defaultPortTransform
	otherFirst    = otherInstrumentPort
	otherSecond   = otherPortTransform
)

func TestPairInstrumentPortPortTransform_NewAndAccessors(t *testing.T) {
...
func TestPairInstrumentPortPortTransform_EqualAndNotEqual(t *testing.T) {
...
func TestPairInstrumentPortPortTransform_ToJSONAndFromJSON(t *testing.T) {
	p, err := New(defaultFirst, defaultSecond)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
...
func TestPairInstrumentPortPortTransform_CAPIHandle(t *testing.T) {
	p, err := New(defaultFirst, defaultSecond)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
...
func TestPairInstrumentPortPortTransform_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
...
func TestPairInstrumentPortPortTransform_CloseTwice(t *testing.T) {
	p, err := New(defaultFirst, defaultSecond)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
...
func pairFirstEqual(a, b *instrumentport.Handle) bool {
	
	eq, err := a.Equal(b)
	return err == nil && eq
	
}
func pairSecondEqual(a, b *porttransform.Handle) bool {
