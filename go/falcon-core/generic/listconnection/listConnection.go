...
func FillValue(count uint32, value *connection.Handle) (*Handle, error) {
...
func New(data []*connection.Handle) (*Handle, error) {
	list := make([]C.ConnectionHandle, len(data))
	for i, v := range data {
		list[i] = C.ConnectionHandle(v)
	}
	return cmemoryallocation.NewAllocation(
		func() (unsafe.Pointer, error) {
			return unsafe.Pointer(C.ListConnection_create(&list[0], C.size_t(len(data)))), nil
		},
		construct,
		destroy,
	)
...
func (h *Handle) Size() (uint32, error) {
	return cmemoryallocation.Read(h, func() (uint32, error) {
		return uint32(C.ListConnection_size(C.ListConnectionHandle(h.CAPIHandle()))), nil
	})
}
...
func (h *Handle) At(idx uint32) (*connection.Handle, error) {
...
func (h *Handle) Index(value *connection.Handle) (uint32, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, value}, func() (uint32, error) {
		return uint32(C.ListConnection_index(C.ListConnectionHandle(h.CAPIHandle()), C.ConnectionHandle(value.CAPIHandle()))), nil
	})
}
...
func (h *Handle) Equal(b *Handle) (bool, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, b}, func() (bool, error) {
		return bool(C.ListConnection_equal(C.ListConnectionHandle(h.CAPIHandle()), C.ListConnectionHandle(b.CAPIHandle()))), nil
	})
}
func (h *Handle) NotEqual(b *Handle) (bool, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, b}, func() (bool, error) {
		return bool(C.ListConnection_not_equal(C.ListConnectionHandle(h.CAPIHandle()), C.ListConnectionHandle(b.CAPIHandle()))), nil
	})
}
