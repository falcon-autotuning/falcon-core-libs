...
// eqSlice compares two slices of *connection.Handle pointers by dereferencing and calling Equal.
func eqSlice(a, b []*connection.Handle) bool {
	if len(a) != len(b) {
		return false
	}
	for i := range a {
...
func fixtureListData() []*connection.Handle {
	return defaultListData
}
func TestListConnection_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestListConnection_NewFromSliceAndItems(t *testing.T) {
...
func TestListConnection_EraseAtAndClear(t *testing.T) {
...
func TestListConnection_IntersectionEqualNotEqual(t *testing.T) {
...
func TestListConnection_ToJSONAndFromJSON(t *testing.T) {
...
func TestListConnection_ContainsAndIndex(t *testing.T) {
...
func TestListConnection_CAPIHandle(t *testing.T) {
...
func TestListConnection_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestListConnection_CloseTwice(t *testing.T) {
	l, err := New(defaultListData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
