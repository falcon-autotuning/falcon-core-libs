...
func FillValue(count uint32, value *pairstringstring.Handle) (*Handle, error) {
...
func New(data []*pairstringstring.Handle) (*Handle, error) {
	list := make([]C.PairStringStringHandle, len(data))
	for i, v := range data {
		list[i] = C.PairStringStringHandle(v)
	}
	return cmemoryallocation.NewAllocation(
		func() (unsafe.Pointer, error) {
			return unsafe.Pointer(C.ListPairStringString_create(&list[0], C.size_t(len(data)))), nil
		},
		construct,
		destroy,
	)
...
func (h *Handle) Size() (uint32, error) {
	return cmemoryallocation.Read(h, func() (uint32, error) {
		return uint32(C.ListPairStringString_size(C.ListPairStringStringHandle(h.CAPIHandle()))), nil
	})
}
...
func (h *Handle) At(idx uint32) (*pairstringstring.Handle, error) {
...
func (h *Handle) Index(value *pairstringstring.Handle) (uint32, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, value}, func() (uint32, error) {
		return uint32(C.ListPairStringString_index(C.ListPairStringStringHandle(h.CAPIHandle()), C.PairStringStringHandle(value.CAPIHandle()))), nil
	})
}
...
func (h *Handle) Equal(b *Handle) (bool, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, b}, func() (bool, error) {
		return bool(C.ListPairStringString_equal(C.ListPairStringStringHandle(h.CAPIHandle()), C.ListPairStringStringHandle(b.CAPIHandle()))), nil
	})
}
func (h *Handle) NotEqual(b *Handle) (bool, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, b}, func() (bool, error) {
		return bool(C.ListPairStringString_not_equal(C.ListPairStringStringHandle(h.CAPIHandle()), C.ListPairStringStringHandle(b.CAPIHandle()))), nil
	})
}
