...
// eqSlice compares two slices of *pairstringstring.Handle pointers by dereferencing and calling Equal.
func eqSlice(a, b []*pairstringstring.Handle) bool {
	if len(a) != len(b) {
		return false
	}
	for i := range a {
...
func fixtureListData() []*pairstringstring.Handle {
	return defaultListData
}
func TestListPairStringString_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestListPairStringString_NewFromSliceAndItems(t *testing.T) {
...
func TestListPairStringString_EraseAtAndClear(t *testing.T) {
...
func TestListPairStringString_IntersectionEqualNotEqual(t *testing.T) {
...
func TestListPairStringString_ToJSONAndFromJSON(t *testing.T) {
...
func TestListPairStringString_ContainsAndIndex(t *testing.T) {
...
func TestListPairStringString_CAPIHandle(t *testing.T) {
...
func TestListPairStringString_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestListPairStringString_CloseTwice(t *testing.T) {
	l, err := New(defaultListData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
