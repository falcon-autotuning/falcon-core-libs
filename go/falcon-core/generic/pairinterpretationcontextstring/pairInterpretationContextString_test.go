...
func TestPairInterpretationContextString_NewAndAccessors(t *testing.T) {
...
func TestPairInterpretationContextString_EqualAndNotEqual(t *testing.T) {
...
func TestPairInterpretationContextString_ToJSONAndFromJSON(t *testing.T) {
	p, err := New(defaultFirst, defaultSecond)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
...
func TestPairInterpretationContextString_CAPIHandle(t *testing.T) {
	p, err := New(defaultFirst, defaultSecond)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
...
func TestPairInterpretationContextString_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
...
func TestPairInterpretationContextString_CloseTwice(t *testing.T) {
	p, err := New(defaultFirst, defaultSecond)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
...
func pairSecondEqual(a, b string) bool {
