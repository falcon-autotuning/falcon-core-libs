...
func TestListFloat_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestListFloat_EraseAtAndClear(t *testing.T) {
...
func TestListFloat_ContainsAndIndex(t *testing.T) {
...
func TestListFloat_IntersectionEqualNotEqual(t *testing.T) {
...
func TestListFloat_ToJSONAndFromJSON(t *testing.T) {
...
func TestListFloat_CAPIHandle(t *testing.T) {
...
func TestListFloat_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
...
func TestListFloat_CloseTwice(t *testing.T) {
	l, err := New(defaultListData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
