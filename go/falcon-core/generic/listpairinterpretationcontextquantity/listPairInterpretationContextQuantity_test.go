...
// eqSlice compares two slices of *pairinterpretationcontextquantity.Handle pointers by dereferencing and calling Equal.
func eqSlice(a, b []*pairinterpretationcontextquantity.Handle) bool {
	if len(a) != len(b) {
		return false
	}
	for i := range a {
...
func fixtureListData() []*pairinterpretationcontextquantity.Handle {
	return defaultListData
}
func TestListPairInterpretationContextQuantity_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestListPairInterpretationContextQuantity_NewFromSliceAndItems(t *testing.T) {
...
func TestListPairInterpretationContextQuantity_EraseAtAndClear(t *testing.T) {
...
func TestListPairInterpretationContextQuantity_IntersectionEqualNotEqual(t *testing.T) {
...
func TestListPairInterpretationContextQuantity_ToJSONAndFromJSON(t *testing.T) {
...
func TestListPairInterpretationContextQuantity_ContainsAndIndex(t *testing.T) {
...
func TestListPairInterpretationContextQuantity_CAPIHandle(t *testing.T) {
...
func TestListPairInterpretationContextQuantity_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestListPairInterpretationContextQuantity_CloseTwice(t *testing.T) {
	l, err := New(defaultListData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
