...
func FillValue(count uint32, value *pairinterpretationcontextquantity.Handle) (*Handle, error) {
...
func New(data []*pairinterpretationcontextquantity.Handle) (*Handle, error) {
	list := make([]C.PairInterpretationContextQuantityHandle, len(data))
	for i, v := range data {
		list[i] = C.PairInterpretationContextQuantityHandle(v)
	}
	return cmemoryallocation.NewAllocation(
		func() (unsafe.Pointer, error) {
			return unsafe.Pointer(C.ListPairInterpretationContextQuantity_create(&list[0], C.size_t(len(data)))), nil
		},
		construct,
		destroy,
	)
...
func (h *Handle) Size() (uint32, error) {
	return cmemoryallocation.Read(h, func() (uint32, error) {
		return uint32(C.ListPairInterpretationContextQuantity_size(C.ListPairInterpretationContextQuantityHandle(h.CAPIHandle()))), nil
	})
}
...
func (h *Handle) At(idx uint32) (*pairinterpretationcontextquantity.Handle, error) {
...
func (h *Handle) Index(value *pairinterpretationcontextquantity.Handle) (uint32, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, value}, func() (uint32, error) {
		return uint32(C.ListPairInterpretationContextQuantity_index(C.ListPairInterpretationContextQuantityHandle(h.CAPIHandle()), C.PairInterpretationContextQuantityHandle(value.CAPIHandle()))), nil
	})
}
...
func (h *Handle) Equal(b *Handle) (bool, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, b}, func() (bool, error) {
		return bool(C.ListPairInterpretationContextQuantity_equal(C.ListPairInterpretationContextQuantityHandle(h.CAPIHandle()), C.ListPairInterpretationContextQuantityHandle(b.CAPIHandle()))), nil
	})
}
func (h *Handle) NotEqual(b *Handle) (bool, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, b}, func() (bool, error) {
		return bool(C.ListPairInterpretationContextQuantity_not_equal(C.ListPairInterpretationContextQuantityHandle(h.CAPIHandle()), C.ListPairInterpretationContextQuantityHandle(b.CAPIHandle()))), nil
	})
}
