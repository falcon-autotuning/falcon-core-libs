...
var (
	defaultListData = []uint64{0,1}
	val1            = uint64(4)
	otherListData   = []uint64{3}
)


func fixtureListData() []uint64 {
	return defaultListData
}
func TestListSizeT_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestListSizeT_NewAllocateAndFillValue(t *testing.T) {
...
func TestListSizeT_NewFromSliceAndItems(t *testing.T) {
...
func TestListSizeT_EraseAtAndClear(t *testing.T) {
...
func TestListSizeT_ContainsAndIndex(t *testing.T) {
...
func TestListSizeT_IntersectionEqualNotEqual(t *testing.T) {
...
func TestListSizeT_ToJSONAndFromJSON(t *testing.T) {
...
func TestListSizeT_CAPIHandle(t *testing.T) {
...
func TestListSizeT_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestListSizeT_CloseTwice(t *testing.T) {
	l, err := New(defaultListData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
