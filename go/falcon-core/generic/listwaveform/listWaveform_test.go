...
// eqSlice compares two slices of *waveform.Handle pointers by dereferencing and calling Equal.
func eqSlice(a, b []*waveform.Handle) bool {
	if len(a) != len(b) {
		return false
	}
	for i := range a {
...
func fixtureListData() []*waveform.Handle {
	return defaultListData
}
func TestListWaveform_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestListWaveform_NewFromSliceAndItems(t *testing.T) {
...
func TestListWaveform_EraseAtAndClear(t *testing.T) {
...
func TestListWaveform_IntersectionEqualNotEqual(t *testing.T) {
...
func TestListWaveform_ToJSONAndFromJSON(t *testing.T) {
...
func TestListWaveform_ContainsAndIndex(t *testing.T) {
...
func TestListWaveform_CAPIHandle(t *testing.T) {
...
func TestListWaveform_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestListWaveform_CloseTwice(t *testing.T) {
	l, err := New(defaultListData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
