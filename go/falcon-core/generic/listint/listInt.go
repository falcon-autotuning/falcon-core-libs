...
func FillValue(count uint32, value int32) (*Handle, error) {
...
func New(data []int32) (*Handle, error) {
	list := make([]C.int, len(data))
	for i, v := range data {
		list[i] = C.int(v)
	}
	return cmemoryallocation.NewAllocation(
		func() (unsafe.Pointer, error) {
			return unsafe.Pointer(C.ListInt_create(&list[0], C.size_t(len(data)))), nil
		},
		construct,
		destroy,
	)
...
func (h *Handle) Size() (uint32, error) {
	return cmemoryallocation.Read(h, func() (uint32, error) {
		return uint32(C.ListInt_size(C.ListIntHandle(h.CAPIHandle()))), nil
	})
}
...
func (h *Handle) Index(value int32) (uint32, error) {
	return cmemoryallocation.Read(h, func() (uint32, error) {
		return uint32(C.ListInt_index(C.ListIntHandle(h.CAPIHandle()), C.int(value))), nil
	})
}
...
func (h *Handle) Equal(b *Handle) (bool, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, b}, func() (bool, error) {
		return bool(C.ListInt_equal(C.ListIntHandle(h.CAPIHandle()), C.ListIntHandle(b.CAPIHandle()))), nil
	})
}
func (h *Handle) NotEqual(b *Handle) (bool, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, b}, func() (bool, error) {
		return bool(C.ListInt_not_equal(C.ListIntHandle(h.CAPIHandle()), C.ListIntHandle(b.CAPIHandle()))), nil
	})
}
