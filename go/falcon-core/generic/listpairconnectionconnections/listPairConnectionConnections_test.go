...
// eqSlice compares two slices of *pairconnectionconnections.Handle pointers by dereferencing and calling Equal.
func eqSlice(a, b []*pairconnectionconnections.Handle) bool {
	if len(a) != len(b) {
		return false
	}
	for i := range a {
...
func fixtureListData() []*pairconnectionconnections.Handle {
	return defaultListData
}
func TestListPairConnectionConnections_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestListPairConnectionConnections_NewFromSliceAndItems(t *testing.T) {
...
func TestListPairConnectionConnections_EraseAtAndClear(t *testing.T) {
...
func TestListPairConnectionConnections_IntersectionEqualNotEqual(t *testing.T) {
...
func TestListPairConnectionConnections_ToJSONAndFromJSON(t *testing.T) {
...
func TestListPairConnectionConnections_ContainsAndIndex(t *testing.T) {
...
func TestListPairConnectionConnections_CAPIHandle(t *testing.T) {
...
func TestListPairConnectionConnections_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestListPairConnectionConnections_CloseTwice(t *testing.T) {
	l, err := New(defaultListData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
