...
// eqSlice compares two slices of *channel.Handle pointers by dereferencing and calling Equal.
func eqSlice(a, b []*channel.Handle) bool {
	if len(a) != len(b) {
		return false
	}
	for i := range a {
...
func fixtureListData() []*channel.Handle {
	return defaultListData
}
func TestListChannel_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestListChannel_NewFromSliceAndItems(t *testing.T) {
...
func TestListChannel_EraseAtAndClear(t *testing.T) {
...
func TestListChannel_IntersectionEqualNotEqual(t *testing.T) {
...
func TestListChannel_ToJSONAndFromJSON(t *testing.T) {
...
func TestListChannel_ContainsAndIndex(t *testing.T) {
...
func TestListChannel_CAPIHandle(t *testing.T) {
...
func TestListChannel_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestListChannel_CloseTwice(t *testing.T) {
	l, err := New(defaultListData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
