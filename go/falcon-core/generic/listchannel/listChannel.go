...
*/
import "C"
type chandle C.ListChannelHandle
type Handle struct {
	chandle      chandle
	mu           sync.RWMutex
	closed       bool
...
func NewEmpty() (*Handle, error) {
	h := chandle(C.ListChannel_create_empty())
...
func NewFillValue(count int, value *channel.Handle) (*Handle, error) {
  
    capi, err := value.CAPIHandle()
    if err != nil {
      return nil, errors.Join(errors.New(`failed to convert to the capi`), err)
    }
    obj := C.ChannelHandle(capi)
  
  h := chandle(C.ListChannel_fill_value(C.size_t(count), obj))
  err = errorhandling.ErrorHandler.CheckCapiError()
  if err != nil {
    return nil, err
  }
...
func New(data []*channel.Handle) (*Handle, error) {
	var ptr *C.ChannelHandle
	if len(data) > 0 {
		cArray := C.malloc(C.size_t(len(data)) * C.size_t(unsafe.Sizeof(uintptr(0))))
		defer C.free(cArray)
		cSlice := (*[1 << 30]C.ChannelHandle)(cArray)[:len(data):len(data)]
		for i, v := range data {
			...
			cSlice[i] = C.ChannelHandle(obj)
		}
		ptr = (*C.ChannelHandle)(cArray)
		h := chandle(C.ListChannel_create(ptr, C.size_t(len(data))))
		err := errorhandling.ErrorHandler.CheckCapiError()
		if err != nil {
			return nil, err
		}
	...
	h := chandle(C.ListChannel_create(nil, 0))
	err := errorhandling.ErrorHandler.CheckCapiError()
	if err != nil {
		return nil, err
	}
...
func FromJSON(json string) (*Handle, error) {
	...
	h := chandle(C.ListChannel_from_json_string(C.StringHandle(capistr)))
	err = errorhandling.ErrorHandler.CheckCapiError()
	if err != nil {
		return nil, err
	}
...
func (h *Handle) Close() error {
	...
	if !h.closed && h.chandle != utils.NilHandle[chandle]() {
		C.ListChannel_destroy(C.ListChannelHandle(h.chandle))
...
func (h *Handle) PushBack(value *channel.Handle) error {
  var err error
	...
	if err != nil {
		return errors.Join(errors.New(`unable to access capi for *channel.Handle`), err)
	}
	
	C.ListChannel_push_back(C.ListChannelHandle(h.chandle), C.ChannelHandle(obj))
	err = h.errorHandler.CheckCapiError()
	if err != nil {
		return err
	}
...
func (h *Handle) Size() (int, error) {
	...
	val := int(C.ListChannel_size(C.ListChannelHandle(h.chandle)))
	err := h.errorHandler.CheckCapiError()
	if err != nil {
		return 0, err
	}
...
func (h *Handle) Empty() (bool, error) {
	...
	val := bool(C.ListChannel_empty(C.ListChannelHandle(h.chandle)))
	err := h.errorHandler.CheckCapiError()
	if err != nil {
		return false, err
	}
...
func (h *Handle) EraseAt(idx int) error {
	...
	C.ListChannel_erase_at(C.ListChannelHandle(h.chandle), C.size_t(idx))
	err := h.errorHandler.CheckCapiError()
	if err != nil {
		return err
	}
...
func (h *Handle) Clear() error {
	...
	C.ListChannel_clear(C.ListChannelHandle(h.chandle))
	err := h.errorHandler.CheckCapiError()
	if err != nil {
		return err
	}
...
func (h *Handle) At(idx int) (*channel.Handle, error) {
	...
	cHandle := C.ListChannel_at(C.ListChannelHandle(h.chandle), C.size_t(idx))
	val, err := channel.FromCAPI(unsafe.Pointer(cHandle))
	if err != nil {
		return nil, err
	}
...
func (h *Handle) Items() ([]*channel.Handle, error) {
	...
	cHandles := make([]C.ChannelHandle, size)
	C.ListChannel_items(C.ListChannelHandle(h.chandle), &cHandles[0], C.size_t(size))
	capiErr := h.errorHandler.CheckCapiError()
	if capiErr != nil {
		return nil, errors.Join(errors.New(`could not access capi for list`), capiErr)
	}
	out := make([]*channel.Handle, size)
	for i := range cHandles {
		
		goHandle, err := channel.FromCAPI(unsafe.Pointer(cHandles[i]))
		if err != nil {
			return nil, err
		}
		out[i] = goHandle
...
func (h *Handle) Contains(value *channel.Handle) (bool, error) {
  var err error
	...
	obj, err := value.CAPIHandle()
	if err != nil {
		return false, errors.Join(errors.New(`unable to access capi for *channel.Handle`), err)
	}
	
	val := bool(C.ListChannel_contains(C.ListChannelHandle(h.chandle), C.ChannelHandle(obj)))
	err = h.errorHandler.CheckCapiError()
	if err != nil {
		return false, err
	}
...
func (h *Handle) Index(value *channel.Handle) (int, error) {
  var err error
	...
	obj, err := value.CAPIHandle()
	if err != nil {
		return 0, errors.Join(errors.New(`unable to access capi for *channel.Handle`), err)
	}
	
	val := int(C.ListChannel_index(C.ListChannelHandle(h.chandle), C.ChannelHandle(obj)))
	err = h.errorHandler.CheckCapiError()
	if err != nil {
		return 0, err
	}
...
func (h *Handle) Intersection(other *Handle) (*Handle, error) {
  ...
  if other == nil {
	...
	res := chandle(C.ListChannel_intersection(C.ListChannelHandle(h.chandle), C.ListChannelHandle(other.chandle)))
	err := h.errorHandler.CheckCapiError()
	if err != nil {
		return nil, err
	}
...
func (h *Handle) Equal(other *Handle) (bool, error) {
  ...
  if other == nil {
	...
	val := bool(C.ListChannel_equal(C.ListChannelHandle(h.chandle), C.ListChannelHandle(other.chandle)))
	err := h.errorHandler.CheckCapiError()
	if err != nil {
		return false, err
	}
...
func (h *Handle) NotEqual(other *Handle) (bool, error) {
  ...
  if other == nil {
	...
	val := bool(C.ListChannel_not_equal(C.ListChannelHandle(h.chandle), C.ListChannelHandle(other.chandle)))
	err := h.errorHandler.CheckCapiError()
	if err != nil {
		return false, err
	}
...
func (h *Handle) ToJSON() (string, error) {
	...
	strHandle, err := str.FromCAPI(unsafe.Pointer(C.ListChannel_to_json_string(C.ListChannelHandle(h.chandle))))
	if err != nil {
