...
func TestMapStringDouble_NewEmptyAndBasicOps(t *testing.T) {
	m, err := NewEmpty()
	if err != nil {
...
func TestMapStringDouble_InsertAndAt(t *testing.T) {
	m, err := NewEmpty()
	if err != nil {
		t.Fatalf("NewEmpty failed: %v", err)
	}
...
func TestMapStringDouble_InsertOrAssign(t *testing.T) {
	m, err := NewEmpty()
	if err != nil {
		t.Fatalf("NewEmpty failed: %v", err)
	}
...
func TestMapStringDouble_EraseAndClear(t *testing.T) {
	m, err := NewEmpty()
	if err != nil {
		t.Fatalf("NewEmpty failed: %v", err)
	}
...
func TestMapStringDouble_Contains(t *testing.T) {
	m, err := NewEmpty()
	if err != nil {
		t.Fatalf("NewEmpty failed: %v", err)
	}
...
func TestMapStringDouble_KeysValuesItems(t *testing.T) {
	m, err := NewEmpty()
	if err != nil {
		t.Fatalf("NewEmpty failed: %v", err)
	}
...
func TestMapStringDouble_EqualAndNotEqual(t *testing.T) {
	m1, err := NewEmpty()
	if err != nil {
		t.Fatalf("NewEmpty failed: %v", err)
	}
...
func TestMapStringDouble_ToJSONAndFromJSON(t *testing.T) {
	m, err := NewEmpty()
	if err != nil {
		t.Fatalf("NewEmpty failed: %v", err)
	}
...
func TestMapStringDouble_CAPIHandle(t *testing.T) {
	m, err := NewEmpty()
	if err != nil {
		t.Fatalf("NewEmpty failed: %v", err)
	}
...
func TestMapStringDouble_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
...
func TestMapStringDouble_CloseTwice(t *testing.T) {
	m, err := NewEmpty()
	if err != nil {
		t.Fatalf("NewEmpty failed: %v", err)
	}
