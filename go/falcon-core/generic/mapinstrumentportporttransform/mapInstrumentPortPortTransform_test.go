...
var (
	defaultKey   = firstInstrumentPort
	defaultValue = firstPortTransform
	otherKey     = secondInstrumentPort
	otherValue   = secondPortTransform
)

func TestMapInstrumentPortPortTransform_NewEmptyAndBasicOps(t *testing.T) {
	m, err := NewEmpty()
	if err != nil {
...
func TestMapInstrumentPortPortTransform_InsertAndAt(t *testing.T) {
	m, err := NewEmpty()
	if err != nil {
		t.Fatalf("NewEmpty failed: %v", err)
	}
...
func TestMapInstrumentPortPortTransform_InsertOrAssign(t *testing.T) {
	m, err := NewEmpty()
	if err != nil {
		t.Fatalf("NewEmpty failed: %v", err)
	}
...
func TestMapInstrumentPortPortTransform_EraseAndClear(t *testing.T) {
	m, err := NewEmpty()
	if err != nil {
		t.Fatalf("NewEmpty failed: %v", err)
	}
...
func TestMapInstrumentPortPortTransform_Contains(t *testing.T) {
	m, err := NewEmpty()
	if err != nil {
		t.Fatalf("NewEmpty failed: %v", err)
	}
...
func TestMapInstrumentPortPortTransform_KeysValuesItems(t *testing.T) {
	m, err := NewEmpty()
	if err != nil {
		t.Fatalf("NewEmpty failed: %v", err)
	}
...
func TestMapInstrumentPortPortTransform_EqualAndNotEqual(t *testing.T) {
	m1, err := NewEmpty()
	if err != nil {
		t.Fatalf("NewEmpty failed: %v", err)
	}
...
func TestMapInstrumentPortPortTransform_ToJSONAndFromJSON(t *testing.T) {
	m, err := NewEmpty()
	if err != nil {
		t.Fatalf("NewEmpty failed: %v", err)
	}
...
func TestMapInstrumentPortPortTransform_CAPIHandle(t *testing.T) {
	m, err := NewEmpty()
	if err != nil {
		t.Fatalf("NewEmpty failed: %v", err)
	}
...
func TestMapInstrumentPortPortTransform_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
...
func TestMapInstrumentPortPortTransform_CloseTwice(t *testing.T) {
	m, err := NewEmpty()
	if err != nil {
		t.Fatalf("NewEmpty failed: %v", err)
	}
...
func mapValueEqual(a, b *porttransform.Handle) bool {
