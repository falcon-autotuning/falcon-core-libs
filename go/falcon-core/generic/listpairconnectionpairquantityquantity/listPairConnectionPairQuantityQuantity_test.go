...
// eqSlice compares two slices of *pairconnectionpairquantityquantity.Handle pointers by dereferencing and calling Equal.
func eqSlice(a, b []*pairconnectionpairquantityquantity.Handle) bool {
	if len(a) != len(b) {
		return false
	}
	for i := range a {
...
func fixtureListData() []*pairconnectionpairquantityquantity.Handle {
	return defaultListData
}
func TestListPairConnectionPairQuantityQuantity_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestListPairConnectionPairQuantityQuantity_NewFromSliceAndItems(t *testing.T) {
...
func TestListPairConnectionPairQuantityQuantity_EraseAtAndClear(t *testing.T) {
...
func TestListPairConnectionPairQuantityQuantity_IntersectionEqualNotEqual(t *testing.T) {
...
func TestListPairConnectionPairQuantityQuantity_ToJSONAndFromJSON(t *testing.T) {
...
func TestListPairConnectionPairQuantityQuantity_ContainsAndIndex(t *testing.T) {
...
func TestListPairConnectionPairQuantityQuantity_CAPIHandle(t *testing.T) {
...
func TestListPairConnectionPairQuantityQuantity_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestListPairConnectionPairQuantityQuantity_CloseTwice(t *testing.T) {
	l, err := New(defaultListData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
