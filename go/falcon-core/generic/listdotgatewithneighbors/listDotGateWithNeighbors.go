...
func FillValue(count uint32, value *dotgatewithneighbors.Handle) (*Handle, error) {
...
func New(data []*dotgatewithneighbors.Handle) (*Handle, error) {
	list := make([]C.DotGateWithNeighborsHandle, len(data))
	for i, v := range data {
		list[i] = C.DotGateWithNeighborsHandle(v)
	}
	return cmemoryallocation.NewAllocation(
		func() (unsafe.Pointer, error) {
			return unsafe.Pointer(C.ListDotGateWithNeighbors_create(&list[0], C.size_t(len(data)))), nil
		},
		construct,
		destroy,
	)
...
func (h *Handle) Size() (uint32, error) {
	return cmemoryallocation.Read(h, func() (uint32, error) {
		return uint32(C.ListDotGateWithNeighbors_size(C.ListDotGateWithNeighborsHandle(h.CAPIHandle()))), nil
	})
}
...
func (h *Handle) At(idx uint32) (*dotgatewithneighbors.Handle, error) {
...
func (h *Handle) Index(value *dotgatewithneighbors.Handle) (uint32, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, value}, func() (uint32, error) {
		return uint32(C.ListDotGateWithNeighbors_index(C.ListDotGateWithNeighborsHandle(h.CAPIHandle()), C.DotGateWithNeighborsHandle(value.CAPIHandle()))), nil
	})
}
...
func (h *Handle) Equal(b *Handle) (bool, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, b}, func() (bool, error) {
		return bool(C.ListDotGateWithNeighbors_equal(C.ListDotGateWithNeighborsHandle(h.CAPIHandle()), C.ListDotGateWithNeighborsHandle(b.CAPIHandle()))), nil
	})
}
func (h *Handle) NotEqual(b *Handle) (bool, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, b}, func() (bool, error) {
		return bool(C.ListDotGateWithNeighbors_not_equal(C.ListDotGateWithNeighborsHandle(h.CAPIHandle()), C.ListDotGateWithNeighborsHandle(b.CAPIHandle()))), nil
	})
}
