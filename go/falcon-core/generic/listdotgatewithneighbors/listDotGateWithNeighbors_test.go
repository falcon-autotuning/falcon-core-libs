...
// eqSlice compares two slices of *dotgatewithneighbors.Handle pointers by dereferencing and calling Equal.
func eqSlice(a, b []*dotgatewithneighbors.Handle) bool {
	if len(a) != len(b) {
		return false
	}
	for i := range a {
...
func fixtureListData() []*dotgatewithneighbors.Handle {
	return defaultListData
}
func TestListDotGateWithNeighbors_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestListDotGateWithNeighbors_NewFromSliceAndItems(t *testing.T) {
...
func TestListDotGateWithNeighbors_EraseAtAndClear(t *testing.T) {
...
func TestListDotGateWithNeighbors_IntersectionEqualNotEqual(t *testing.T) {
...
func TestListDotGateWithNeighbors_ToJSONAndFromJSON(t *testing.T) {
...
func TestListDotGateWithNeighbors_ContainsAndIndex(t *testing.T) {
...
func TestListDotGateWithNeighbors_CAPIHandle(t *testing.T) {
...
func TestListDotGateWithNeighbors_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestListDotGateWithNeighbors_CloseTwice(t *testing.T) {
	l, err := New(defaultListData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
