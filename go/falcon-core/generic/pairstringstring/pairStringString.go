...
func (h *Handle) Equal(b *Handle) (bool, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, b}, func() (bool, error) {
		return bool(C.PairStringString_equal(C.PairStringStringHandle(h.CAPIHandle()), C.PairStringStringHandle(b.CAPIHandle()))), nil
	})
}
func (h *Handle) NotEqual(b *Handle) (bool, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, b}, func() (bool, error) {
		return bool(C.PairStringString_not_equal(C.PairStringStringHandle(h.CAPIHandle()), C.PairStringStringHandle(b.CAPIHandle()))), nil
	})
}
