...
var (
	...
	defaultSecond = defaultConnections
	otherFirst    = otherConnection
	otherSecond   = otherConnections
)

func TestPairConnectionConnections_NewAndAccessors(t *testing.T) {
...
func TestPairConnectionConnections_EqualAndNotEqual(t *testing.T) {
...
func TestPairConnectionConnections_ToJSONAndFromJSON(t *testing.T) {
	p, err := New(defaultFirst, defaultSecond)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
...
func TestPairConnectionConnections_CAPIHandle(t *testing.T) {
	p, err := New(defaultFirst, defaultSecond)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
...
func TestPairConnectionConnections_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
...
func TestPairConnectionConnections_CloseTwice(t *testing.T) {
	p, err := New(defaultFirst, defaultSecond)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
...
func pairSecondEqual(a, b *connections.Handle) bool {
