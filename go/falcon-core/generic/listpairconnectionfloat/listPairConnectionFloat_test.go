...
// eqSlice compares two slices of *pairconnectionfloat.Handle pointers by dereferencing and calling Equal.
func eqSlice(a, b []*pairconnectionfloat.Handle) bool {
	if len(a) != len(b) {
		return false
	}
	for i := range a {
...
func fixtureListData() []*pairconnectionfloat.Handle {
	return defaultListData
}
func TestListPairConnectionFloat_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestListPairConnectionFloat_NewFromSliceAndItems(t *testing.T) {
...
func TestListPairConnectionFloat_EraseAtAndClear(t *testing.T) {
...
func TestListPairConnectionFloat_IntersectionEqualNotEqual(t *testing.T) {
...
func TestListPairConnectionFloat_ToJSONAndFromJSON(t *testing.T) {
...
func TestListPairConnectionFloat_ContainsAndIndex(t *testing.T) {
...
func TestListPairConnectionFloat_CAPIHandle(t *testing.T) {
...
func TestListPairConnectionFloat_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestListPairConnectionFloat_CloseTwice(t *testing.T) {
	l, err := New(defaultListData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
