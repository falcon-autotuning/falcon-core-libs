...
var (
	...
	defaultSecond = int32(24)
	otherFirst    = int32(99)
	otherSecond   = int32(11)
)

func TestPairIntInt_NewAndAccessors(t *testing.T) {
...
func TestPairIntInt_EqualAndNotEqual(t *testing.T) {
...
func TestPairIntInt_ToJSONAndFromJSON(t *testing.T) {
	p, err := New(defaultFirst, defaultSecond)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
...
func TestPairIntInt_CAPIHandle(t *testing.T) {
	p, err := New(defaultFirst, defaultSecond)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
...
func TestPairIntInt_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
...
func TestPairIntInt_CloseTwice(t *testing.T) {
	p, err := New(defaultFirst, defaultSecond)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
...
func pairSecondEqual(a, b int32) bool {
