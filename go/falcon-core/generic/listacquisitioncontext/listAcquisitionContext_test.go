...
// eqSlice compares two slices of *acquisitioncontext.Handle pointers by dereferencing and calling Equal.
func eqSlice(a, b []*acquisitioncontext.Handle) bool {
	if len(a) != len(b) {
		return false
	}
	for i := range a {
...
func fixtureListData() []*acquisitioncontext.Handle {
	return defaultListData
}
func TestListAcquisitionContext_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestListAcquisitionContext_NewFromSliceAndItems(t *testing.T) {
...
func TestListAcquisitionContext_EraseAtAndClear(t *testing.T) {
...
func TestListAcquisitionContext_IntersectionEqualNotEqual(t *testing.T) {
...
func TestListAcquisitionContext_ToJSONAndFromJSON(t *testing.T) {
...
func TestListAcquisitionContext_ContainsAndIndex(t *testing.T) {
...
func TestListAcquisitionContext_CAPIHandle(t *testing.T) {
...
func TestListAcquisitionContext_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestListAcquisitionContext_CloseTwice(t *testing.T) {
	l, err := New(defaultListData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
