...
func TestMapInterpretationContextDouble_NewEmptyAndBasicOps(t *testing.T) {
	m, err := NewEmpty()
	if err != nil {
...
func TestMapInterpretationContextDouble_InsertAndAt(t *testing.T) {
	m, err := NewEmpty()
	if err != nil {
		t.Fatalf("NewEmpty failed: %v", err)
	}
...
func TestMapInterpretationContextDouble_InsertOrAssign(t *testing.T) {
	m, err := NewEmpty()
	if err != nil {
		t.Fatalf("NewEmpty failed: %v", err)
	}
...
func TestMapInterpretationContextDouble_EraseAndClear(t *testing.T) {
	m, err := NewEmpty()
	if err != nil {
		t.Fatalf("NewEmpty failed: %v", err)
	}
...
func TestMapInterpretationContextDouble_Contains(t *testing.T) {
	m, err := NewEmpty()
	if err != nil {
		t.Fatalf("NewEmpty failed: %v", err)
	}
...
func TestMapInterpretationContextDouble_KeysValuesItems(t *testing.T) {
	m, err := NewEmpty()
	if err != nil {
		t.Fatalf("NewEmpty failed: %v", err)
	}
...
func TestMapInterpretationContextDouble_EqualAndNotEqual(t *testing.T) {
	m1, err := NewEmpty()
	if err != nil {
		t.Fatalf("NewEmpty failed: %v", err)
	}
...
func TestMapInterpretationContextDouble_ToJSONAndFromJSON(t *testing.T) {
	m, err := NewEmpty()
	if err != nil {
		t.Fatalf("NewEmpty failed: %v", err)
	}
...
func TestMapInterpretationContextDouble_CAPIHandle(t *testing.T) {
	m, err := NewEmpty()
	if err != nil {
		t.Fatalf("NewEmpty failed: %v", err)
	}
...
func TestMapInterpretationContextDouble_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
...
func TestMapInterpretationContextDouble_CloseTwice(t *testing.T) {
	m, err := NewEmpty()
	if err != nil {
		t.Fatalf("NewEmpty failed: %v", err)
	}
...
func mapValueEqual(a, b float64) bool {
