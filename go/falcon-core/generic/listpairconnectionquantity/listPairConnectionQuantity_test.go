...
// eqSlice compares two slices of *pairconnectionquantity.Handle pointers by dereferencing and calling Equal.
func eqSlice(a, b []*pairconnectionquantity.Handle) bool {
	if len(a) != len(b) {
		return false
	}
	for i := range a {
...
func fixtureListData() []*pairconnectionquantity.Handle {
	return defaultListData
}
func TestListPairConnectionQuantity_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestListPairConnectionQuantity_NewFromSliceAndItems(t *testing.T) {
...
func TestListPairConnectionQuantity_EraseAtAndClear(t *testing.T) {
...
func TestListPairConnectionQuantity_IntersectionEqualNotEqual(t *testing.T) {
...
func TestListPairConnectionQuantity_ToJSONAndFromJSON(t *testing.T) {
...
func TestListPairConnectionQuantity_ContainsAndIndex(t *testing.T) {
...
func TestListPairConnectionQuantity_CAPIHandle(t *testing.T) {
...
func TestListPairConnectionQuantity_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestListPairConnectionQuantity_CloseTwice(t *testing.T) {
	l, err := New(defaultListData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
