...
func TestPairStringBool_NewAndAccessors(t *testing.T) {
...
func TestPairStringBool_EqualAndNotEqual(t *testing.T) {
...
func TestPairStringBool_ToJSONAndFromJSON(t *testing.T) {
	p, err := New(defaultFirst, defaultSecond)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
...
func TestPairStringBool_CAPIHandle(t *testing.T) {
	p, err := New(defaultFirst, defaultSecond)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
...
func TestPairStringBool_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
...
func TestPairStringBool_CloseTwice(t *testing.T) {
	p, err := New(defaultFirst, defaultSecond)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
...
func pairSecondEqual(a, b bool) bool {
