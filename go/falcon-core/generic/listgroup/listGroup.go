...
*/
import "C"
type chandle C.ListGroupHandle
type Handle struct {
	chandle      chandle
	mu           sync.RWMutex
	closed       bool
...
func NewEmpty() (*Handle, error) {
	h := chandle(C.ListGroup_create_empty())
...
func NewFillValue(count int, value *group.Handle) (*Handle, error) {
  
    capi, err := value.CAPIHandle()
    if err != nil {
      return nil, errors.Join(errors.New(`failed to convert to the capi`), err)
    }
    obj := C.GroupHandle(capi)
  
  h := chandle(C.ListGroup_fill_value(C.size_t(count), obj))
  err = errorhandling.ErrorHandler.CheckCapiError()
  if err != nil {
    return nil, err
  }
...
func New(data []*group.Handle) (*Handle, error) {
	var ptr *C.GroupHandle
	if len(data) > 0 {
		cArray := C.malloc(C.size_t(len(data)) * C.size_t(unsafe.Sizeof(uintptr(0))))
		defer C.free(cArray)
		cSlice := (*[1 << 30]C.GroupHandle)(cArray)[:len(data):len(data)]
		for i, v := range data {
			...
			cSlice[i] = C.GroupHandle(obj)
		}
		ptr = (*C.GroupHandle)(cArray)
		h := chandle(C.ListGroup_create(ptr, C.size_t(len(data))))
		err := errorhandling.ErrorHandler.CheckCapiError()
		if err != nil {
			return nil, err
		}
	...
	h := chandle(C.ListGroup_create(nil, 0))
	err := errorhandling.ErrorHandler.CheckCapiError()
	if err != nil {
		return nil, err
	}
...
func FromJSON(json string) (*Handle, error) {
	...
	h := chandle(C.ListGroup_from_json_string(C.StringHandle(capistr)))
	err = errorhandling.ErrorHandler.CheckCapiError()
	if err != nil {
		return nil, err
	}
...
func (h *Handle) Close() error {
	...
	if !h.closed && h.chandle != utils.NilHandle[chandle]() {
		C.ListGroup_destroy(C.ListGroupHandle(h.chandle))
...
func (h *Handle) PushBack(value *group.Handle) error {
  var err error
	...
	if err != nil {
		return errors.Join(errors.New(`unable to access capi for *group.Handle`), err)
	}
	
	C.ListGroup_push_back(C.ListGroupHandle(h.chandle), C.GroupHandle(obj))
	err = h.errorHandler.CheckCapiError()
	if err != nil {
		return err
	}
...
func (h *Handle) Size() (int, error) {
	...
	val := int(C.ListGroup_size(C.ListGroupHandle(h.chandle)))
	err := h.errorHandler.CheckCapiError()
	if err != nil {
		return 0, err
	}
...
func (h *Handle) Empty() (bool, error) {
	...
	val := bool(C.ListGroup_empty(C.ListGroupHandle(h.chandle)))
	err := h.errorHandler.CheckCapiError()
	if err != nil {
		return false, err
	}
...
func (h *Handle) EraseAt(idx int) error {
	...
	C.ListGroup_erase_at(C.ListGroupHandle(h.chandle), C.size_t(idx))
	err := h.errorHandler.CheckCapiError()
	if err != nil {
		return err
	}
...
func (h *Handle) Clear() error {
	...
	C.ListGroup_clear(C.ListGroupHandle(h.chandle))
	err := h.errorHandler.CheckCapiError()
	if err != nil {
		return err
	}
...
func (h *Handle) At(idx int) (*group.Handle, error) {
	h.mu.RLock()
	defer h.mu.RUnlock()
	if h.closed || h.chandle == utils.NilHandle[chandle]() {
	...
	cHandle := C.ListGroup_at(C.ListGroupHandle(h.chandle), C.size_t(idx))
...
func (h *Handle) Items() ([]*group.Handle, error) {
	...
	cHandles := make([]C.GroupHandle, size)
	C.ListGroup_items(C.ListGroupHandle(h.chandle), &cHandles[0], C.size_t(size))
	capiErr := h.errorHandler.CheckCapiError()
	if capiErr != nil {
		return nil, errors.Join(errors.New(`could not access capi for list`), capiErr)
	}
	out := make([]*group.Handle, size)
	for i := range cHandles {
		
		goHandle, err := group.FromCAPI(unsafe.Pointer(cHandles[i]))
		if err != nil {
			return nil, err
		}
		out[i] = goHandle
...
func (h *Handle) Contains(value *group.Handle) (bool, error) {
  var err error
	...
	obj, err := value.CAPIHandle()
	if err != nil {
		return false, errors.Join(errors.New(`unable to access capi for *group.Handle`), err)
	}
	
	val := bool(C.ListGroup_contains(C.ListGroupHandle(h.chandle), C.GroupHandle(obj)))
	err = h.errorHandler.CheckCapiError()
	if err != nil {
		return false, err
	}
...
func (h *Handle) Index(value *group.Handle) (int, error) {
  var err error
	h.mu.RLock()
	defer h.mu.RUnlock()
	if h.closed || h.chandle == utils.NilHandle[chandle]() {
	...
	obj, err := value.CAPIHandle()
	if err != nil {
		return 0, errors.Join(errors.New(`unable to access capi for *group.Handle`), err)
	}
	
	val := int(C.ListGroup_index(C.ListGroupHandle(h.chandle), C.GroupHandle(obj)))
	err = h.errorHandler.CheckCapiError()
	if err != nil {
		return 0, err
	}
...
func (h *Handle) Intersection(other *Handle) (*Handle, error) {
  ...
  if other == nil {
	...
	res := chandle(C.ListGroup_intersection(C.ListGroupHandle(h.chandle), C.ListGroupHandle(other.chandle)))
	err := h.errorHandler.CheckCapiError()
	if err != nil {
		return nil, err
	}
...
func (h *Handle) Equal(other *Handle) (bool, error) {
  ...
  if other == nil {
	...
	val := bool(C.ListGroup_equal(C.ListGroupHandle(h.chandle), C.ListGroupHandle(other.chandle)))
	err := h.errorHandler.CheckCapiError()
	if err != nil {
		return false, err
	}
...
func (h *Handle) NotEqual(other *Handle) (bool, error) {
  ...
  if other == nil {
	...
	val := bool(C.ListGroup_not_equal(C.ListGroupHandle(h.chandle), C.ListGroupHandle(other.chandle)))
	err := h.errorHandler.CheckCapiError()
	if err != nil {
		return false, err
	}
...
func (h *Handle) ToJSON() (string, error) {
	...
	strHandle, err := str.FromCAPI(unsafe.Pointer(C.ListGroup_to_json_string(C.ListGroupHandle(h.chandle))))
	if err != nil {
