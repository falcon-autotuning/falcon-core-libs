...
// eqSlice compares two slices of *group.Handle pointers by dereferencing and calling Equal.
func eqSlice(a, b []*group.Handle) bool {
	if len(a) != len(b) {
		return false
	}
	for i := range a {
...
func fixtureListData() []*group.Handle {
	return defaultListData
}
func TestListGroup_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestListGroup_NewFromSliceAndItems(t *testing.T) {
...
func TestListGroup_EraseAtAndClear(t *testing.T) {
...
func TestListGroup_IntersectionEqualNotEqual(t *testing.T) {
...
func TestListGroup_ToJSONAndFromJSON(t *testing.T) {
...
func TestListGroup_ContainsAndIndex(t *testing.T) {
...
func TestListGroup_CAPIHandle(t *testing.T) {
...
func TestListGroup_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestListGroup_CloseTwice(t *testing.T) {
	l, err := New(defaultListData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
