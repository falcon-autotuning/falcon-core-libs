...
// eqSlice compares two slices of *interpretationcontext.Handle pointers by dereferencing and calling Equal.
func eqSlice(a, b []*interpretationcontext.Handle) bool {
	if len(a) != len(b) {
		return false
	}
	for i := range a {
...
func fixtureListData() []*interpretationcontext.Handle {
	return defaultListData
}
func TestListInterpretationContext_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestListInterpretationContext_NewFromSliceAndItems(t *testing.T) {
...
func TestListInterpretationContext_EraseAtAndClear(t *testing.T) {
...
func TestListInterpretationContext_IntersectionEqualNotEqual(t *testing.T) {
...
func TestListInterpretationContext_ToJSONAndFromJSON(t *testing.T) {
...
func TestListInterpretationContext_ContainsAndIndex(t *testing.T) {
...
func TestListInterpretationContext_CAPIHandle(t *testing.T) {
...
func TestListInterpretationContext_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestListInterpretationContext_CloseTwice(t *testing.T) {
	l, err := New(defaultListData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
