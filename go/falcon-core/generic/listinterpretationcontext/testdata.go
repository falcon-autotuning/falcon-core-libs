...
func mustListinterpretationContext(indepNames []string, depNames []string) *interpretationcontext.Handle {
...
var (
	defaultListData = []*interpretationcontext.Handle{
		mustListinterpretationContext([]string{"A", "B"}, []string{"C"}),
		mustListinterpretationContext([]string{"D", "E"}, []string{"C"}),
	}
	otherListData = []*interpretationcontext.Handle{
		mustListinterpretationContext([]string{"B", "D"}, []string{"C"}),
	}
)
