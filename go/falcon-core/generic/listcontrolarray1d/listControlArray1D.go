...
func FillValue(count uint32, value *controlarray1d.Handle) (*Handle, error) {
...
func New(data []*controlarray1d.Handle) (*Handle, error) {
	list := make([]C.ControlArray1DHandle, len(data))
	for i, v := range data {
		list[i] = C.ControlArray1DHandle(v)
	}
	return cmemoryallocation.NewAllocation(
		func() (unsafe.Pointer, error) {
			return unsafe.Pointer(C.ListControlArray1D_create(&list[0], C.size_t(len(data)))), nil
		},
		construct,
		destroy,
	)
...
func (h *Handle) Size() (uint32, error) {
	return cmemoryallocation.Read(h, func() (uint32, error) {
		return uint32(C.ListControlArray1D_size(C.ListControlArray1DHandle(h.CAPIHandle()))), nil
	})
}
...
func (h *Handle) Index(value *controlarray1d.Handle) (uint32, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, value}, func() (uint32, error) {
		return uint32(C.ListControlArray1D_index(C.ListControlArray1DHandle(h.CAPIHandle()), C.ControlArray1DHandle(value.CAPIHandle()))), nil
	})
}
...
func (h *Handle) Equal(b *Handle) (bool, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, b}, func() (bool, error) {
		return bool(C.ListControlArray1D_equal(C.ListControlArray1DHandle(h.CAPIHandle()), C.ListControlArray1DHandle(b.CAPIHandle()))), nil
	})
}
func (h *Handle) NotEqual(b *Handle) (bool, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, b}, func() (bool, error) {
		return bool(C.ListControlArray1D_not_equal(C.ListControlArray1DHandle(h.CAPIHandle()), C.ListControlArray1DHandle(b.CAPIHandle()))), nil
	})
}
