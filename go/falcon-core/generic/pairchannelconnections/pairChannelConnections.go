...
func Copy(handle *Handle) (*Handle, error) {
	return cmemoryallocation.Read(handle, func() (*Handle, error) {
		...
		return cmemoryallocation.NewAllocation(
			func() (unsafe.Pointer, error) {
				return unsafe.Pointer(C.PairChannelConnections_copy(C.PairChannelConnectionsHandle(handle.CAPIHandle()))), nil
			},
			construct,
			destroy,
		)
...
func (h *Handle) Equal(other *Handle) (bool, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, other}, func() (bool, error) {
		return bool(C.PairChannelConnections_equal(C.PairChannelConnectionsHandle(h.CAPIHandle()), C.PairChannelConnectionsHandle(other.CAPIHandle()))), nil
	})
}
func (h *Handle) NotEqual(other *Handle) (bool, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, other}, func() (bool, error) {
		return bool(C.PairChannelConnections_not_equal(C.PairChannelConnectionsHandle(h.CAPIHandle()), C.PairChannelConnectionsHandle(other.CAPIHandle()))), nil
	})
}
