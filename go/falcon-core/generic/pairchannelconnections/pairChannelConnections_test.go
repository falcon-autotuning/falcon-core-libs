...
var (
	defaultFirst  = defaultChannel
	defaultSecond = defaultConnections
	otherFirst    = otherChannel
	otherSecond   = otherConnections
)

func TestPairChannelConnections_NewAndAccessors(t *testing.T) {
...
func TestPairChannelConnections_EqualAndNotEqual(t *testing.T) {
...
func TestPairChannelConnections_ToJSONAndFromJSON(t *testing.T) {
	p, err := New(defaultFirst, defaultSecond)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
...
func TestPairChannelConnections_CAPIHandle(t *testing.T) {
	p, err := New(defaultFirst, defaultSecond)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
...
func TestPairChannelConnections_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
...
func TestPairChannelConnections_CloseTwice(t *testing.T) {
	p, err := New(defaultFirst, defaultSecond)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
...
func pairFirstEqual(a, b *channel.Handle) bool {
