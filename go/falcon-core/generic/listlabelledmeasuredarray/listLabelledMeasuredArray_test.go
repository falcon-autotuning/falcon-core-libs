...
func TestListLabelledMeasuredArray_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestListLabelledMeasuredArray_NewFromSliceAndItems(t *testing.T) {
...
func TestListLabelledMeasuredArray_EraseAtAndClear(t *testing.T) {
...
func TestListLabelledMeasuredArray_IntersectionEqualNotEqual(t *testing.T) {
...
func TestListLabelledMeasuredArray_ToJSONAndFromJSON(t *testing.T) {
...
func TestListLabelledMeasuredArray_ContainsAndIndex(t *testing.T) {
...
func TestListLabelledMeasuredArray_CAPIHandle(t *testing.T) {
...
func TestListLabelledMeasuredArray_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestListLabelledMeasuredArray_CloseTwice(t *testing.T) {
	l, err := New(defaultListData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
