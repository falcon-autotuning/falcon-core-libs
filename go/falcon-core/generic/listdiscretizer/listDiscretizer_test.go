...
func fixtureListData() []*discretizer.Handle {
	return defaultListData
}
func TestListDiscretizer_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestListDiscretizer_NewFromSliceAndItems(t *testing.T) {
...
func TestListDiscretizer_EraseAtAndClear(t *testing.T) {
...
func TestListDiscretizer_IntersectionEqualNotEqual(t *testing.T) {
...
func TestListDiscretizer_ToJSONAndFromJSON(t *testing.T) {
...
func TestListDiscretizer_ContainsAndIndex(t *testing.T) {
...
func TestListDiscretizer_CAPIHandle(t *testing.T) {
...
func TestListDiscretizer_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestListDiscretizer_CloseTwice(t *testing.T) {
	l, err := New(defaultListData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
