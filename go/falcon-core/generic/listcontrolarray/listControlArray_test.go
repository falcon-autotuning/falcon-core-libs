...
func fixtureListData() []*controlarray.Handle {
	return defaultListData
}
func TestListControlArray_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestListControlArray_NewFromSliceAndItems(t *testing.T) {
...
func TestListControlArray_EraseAtAndClear(t *testing.T) {
...
func TestListControlArray_IntersectionEqualNotEqual(t *testing.T) {
...
func TestListControlArray_ToJSONAndFromJSON(t *testing.T) {
...
func TestListControlArray_ContainsAndIndex(t *testing.T) {
...
func TestListControlArray_CAPIHandle(t *testing.T) {
...
func TestListControlArray_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestListControlArray_CloseTwice(t *testing.T) {
	l, err := New(defaultListData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
