...
func FillValue(count uint32, value *controlarray.Handle) (*Handle, error) {
...
func New(data []*controlarray.Handle) (*Handle, error) {
	list := make([]C.ControlArrayHandle, len(data))
	for i, v := range data {
		list[i] = C.ControlArrayHandle(v)
	}
	return cmemoryallocation.NewAllocation(
		func() (unsafe.Pointer, error) {
			return unsafe.Pointer(C.ListControlArray_create(&list[0], C.size_t(len(data)))), nil
		},
		construct,
		destroy,
	)
...
func (h *Handle) Size() (uint32, error) {
	return cmemoryallocation.Read(h, func() (uint32, error) {
		return uint32(C.ListControlArray_size(C.ListControlArrayHandle(h.CAPIHandle()))), nil
	})
}
...
func (h *Handle) Index(value *controlarray.Handle) (uint32, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, value}, func() (uint32, error) {
		return uint32(C.ListControlArray_index(C.ListControlArrayHandle(h.CAPIHandle()), C.ControlArrayHandle(value.CAPIHandle()))), nil
	})
}
...
func (h *Handle) Equal(b *Handle) (bool, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, b}, func() (bool, error) {
		return bool(C.ListControlArray_equal(C.ListControlArrayHandle(h.CAPIHandle()), C.ListControlArrayHandle(b.CAPIHandle()))), nil
	})
}
func (h *Handle) NotEqual(b *Handle) (bool, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, b}, func() (bool, error) {
		return bool(C.ListControlArray_not_equal(C.ListControlArrayHandle(h.CAPIHandle()), C.ListControlArrayHandle(b.CAPIHandle()))), nil
	})
}
