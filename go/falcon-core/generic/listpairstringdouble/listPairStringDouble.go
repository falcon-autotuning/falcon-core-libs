...
func FillValue(count uint32, value *pairstringdouble.Handle) (*Handle, error) {
...
func New(data []*pairstringdouble.Handle) (*Handle, error) {
	...
	return cmemoryallocation.NewAllocation(
		func() (unsafe.Pointer, error) {
			return unsafe.Pointer(C.ListPairStringDouble_create(&list[0], C.size_t(len(data)))), nil
		},
		construct,
		destroy,
	)
...
func (h *Handle) Size() (uint32, error) {
	return cmemoryallocation.Read(h, func() (uint32, error) {
		return uint32(C.ListPairStringDouble_size(C.ListPairStringDoubleHandle(h.CAPIHandle()))), nil
	})
}
...
func (h *Handle) At(idx uint32) (*pairstringdouble.Handle, error) {
...
func (h *Handle) Index(value *pairstringdouble.Handle) (uint32, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, value}, func() (uint32, error) {
		return uint32(C.ListPairStringDouble_index(C.ListPairStringDoubleHandle(h.CAPIHandle()), C.PairStringDoubleHandle(value.CAPIHandle()))), nil
	})
}
...
func (h *Handle) Equal(b *Handle) (bool, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, b}, func() (bool, error) {
		return bool(C.ListPairStringDouble_equal(C.ListPairStringDoubleHandle(h.CAPIHandle()), C.ListPairStringDoubleHandle(b.CAPIHandle()))), nil
	})
}
func (h *Handle) NotEqual(b *Handle) (bool, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, b}, func() (bool, error) {
		return bool(C.ListPairStringDouble_not_equal(C.ListPairStringDoubleHandle(h.CAPIHandle()), C.ListPairStringDoubleHandle(b.CAPIHandle()))), nil
	})
}
