...
// eqSlice compares two slices of *pairstringdouble.Handle pointers by dereferencing and calling Equal.
func eqSlice(a, b []*pairstringdouble.Handle) bool {
	if len(a) != len(b) {
		return false
	}
	for i := range a {
...
func fixtureListData() []*pairstringdouble.Handle {
	return defaultListData
}
func TestListPairStringDouble_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestListPairStringDouble_NewFromSliceAndItems(t *testing.T) {
...
func TestListPairStringDouble_EraseAtAndClear(t *testing.T) {
...
func TestListPairStringDouble_IntersectionEqualNotEqual(t *testing.T) {
...
func TestListPairStringDouble_ToJSONAndFromJSON(t *testing.T) {
...
func TestListPairStringDouble_ContainsAndIndex(t *testing.T) {
...
func TestListPairStringDouble_CAPIHandle(t *testing.T) {
...
func TestListPairStringDouble_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestListPairStringDouble_CloseTwice(t *testing.T) {
	l, err := New(defaultListData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
