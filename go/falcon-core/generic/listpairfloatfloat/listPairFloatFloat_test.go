...
// eqSlice compares two slices of *pairfloatfloat.Handle pointers by dereferencing and calling Equal.
func eqSlice(a, b []*pairfloatfloat.Handle) bool {
	if len(a) != len(b) {
		return false
	}
	for i := range a {
...
func fixtureListData() []*pairfloatfloat.Handle {
	return defaultListData
}
func TestListPairFloatFloat_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestListPairFloatFloat_NewFromSliceAndItems(t *testing.T) {
...
func TestListPairFloatFloat_EraseAtAndClear(t *testing.T) {
...
func TestListPairFloatFloat_IntersectionEqualNotEqual(t *testing.T) {
...
func TestListPairFloatFloat_ToJSONAndFromJSON(t *testing.T) {
...
func TestListPairFloatFloat_ContainsAndIndex(t *testing.T) {
...
func TestListPairFloatFloat_CAPIHandle(t *testing.T) {
...
func TestListPairFloatFloat_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestListPairFloatFloat_CloseTwice(t *testing.T) {
	l, err := New(defaultListData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
