...
func fixtureListData() []*instrumentport.Handle {
	return defaultListData
}
func TestListInstrumentPort_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestListInstrumentPort_NewFromSliceAndItems(t *testing.T) {
...
func TestListInstrumentPort_EraseAtAndClear(t *testing.T) {
...
func TestListInstrumentPort_IntersectionEqualNotEqual(t *testing.T) {
...
func TestListInstrumentPort_ToJSONAndFromJSON(t *testing.T) {
...
func TestListInstrumentPort_ContainsAndIndex(t *testing.T) {
...
func TestListInstrumentPort_CAPIHandle(t *testing.T) {
...
func TestListInstrumentPort_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestListInstrumentPort_CloseTwice(t *testing.T) {
	l, err := New(defaultListData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
