...
// eqSlice compares two slices of *pairgnamegroup.Handle pointers by dereferencing and calling Equal.
func eqSlice(a, b []*pairgnamegroup.Handle) bool {
	if len(a) != len(b) {
		return false
	}
	for i := range a {
...
func fixtureListData() []*pairgnamegroup.Handle {
	return defaultListData
}
func TestListPairGnameGroup_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestListPairGnameGroup_NewFromSliceAndItems(t *testing.T) {
...
func TestListPairGnameGroup_EraseAtAndClear(t *testing.T) {
...
func TestListPairGnameGroup_IntersectionEqualNotEqual(t *testing.T) {
...
func TestListPairGnameGroup_ToJSONAndFromJSON(t *testing.T) {
...
func TestListPairGnameGroup_ContainsAndIndex(t *testing.T) {
...
func TestListPairGnameGroup_CAPIHandle(t *testing.T) {
...
func TestListPairGnameGroup_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestListPairGnameGroup_CloseTwice(t *testing.T) {
	l, err := New(defaultListData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
