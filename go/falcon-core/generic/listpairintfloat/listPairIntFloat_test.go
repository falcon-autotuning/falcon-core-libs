...
// eqSlice compares two slices of *pairintfloat.Handle pointers by dereferencing and calling Equal.
func eqSlice(a, b []*pairintfloat.Handle) bool {
	if len(a) != len(b) {
		return false
	}
	for i := range a {
...
func fixtureListData() []*pairintfloat.Handle {
	return defaultListData
}
func TestListPairIntFloat_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestListPairIntFloat_NewFromSliceAndItems(t *testing.T) {
...
func TestListPairIntFloat_EraseAtAndClear(t *testing.T) {
...
func TestListPairIntFloat_IntersectionEqualNotEqual(t *testing.T) {
...
func TestListPairIntFloat_ToJSONAndFromJSON(t *testing.T) {
...
func TestListPairIntFloat_ContainsAndIndex(t *testing.T) {
...
func TestListPairIntFloat_CAPIHandle(t *testing.T) {
...
func TestListPairIntFloat_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestListPairIntFloat_CloseTwice(t *testing.T) {
	l, err := New(defaultListData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
