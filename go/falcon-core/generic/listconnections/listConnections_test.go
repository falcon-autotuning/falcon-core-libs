...
// eqSlice compares two slices of *connections.Handle pointers by dereferencing and calling Equal.
func eqSlice(a, b []*connections.Handle) bool {
	if len(a) != len(b) {
		return false
	}
	for i := range a {
...
func fixtureListData() []*connections.Handle {
	return defaultListData
}
func TestListConnections_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestListConnections_NewFromSliceAndItems(t *testing.T) {
...
func TestListConnections_EraseAtAndClear(t *testing.T) {
...
func TestListConnections_IntersectionEqualNotEqual(t *testing.T) {
...
func TestListConnections_ToJSONAndFromJSON(t *testing.T) {
...
func TestListConnections_ContainsAndIndex(t *testing.T) {
...
func TestListConnections_CAPIHandle(t *testing.T) {
...
func TestListConnections_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestListConnections_CloseTwice(t *testing.T) {
	l, err := New(defaultListData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
