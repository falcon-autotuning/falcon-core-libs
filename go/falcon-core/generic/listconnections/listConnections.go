...
func FillValue(count uint32, value *connections.Handle) (*Handle, error) {
...
func New(data []*connections.Handle) (*Handle, error) {
	list := make([]C.ConnectionsHandle, len(data))
	for i, v := range data {
		list[i] = C.ConnectionsHandle(v)
	}
	return cmemoryallocation.NewAllocation(
		func() (unsafe.Pointer, error) {
			return unsafe.Pointer(C.ListConnections_create(&list[0], C.size_t(len(data)))), nil
		},
		construct,
		destroy,
	)
...
func (h *Handle) Size() (uint32, error) {
	return cmemoryallocation.Read(h, func() (uint32, error) {
		return uint32(C.ListConnections_size(C.ListConnectionsHandle(h.CAPIHandle()))), nil
	})
}
...
func (h *Handle) At(idx uint32) (*connections.Handle, error) {
...
func (h *Handle) Index(value *connections.Handle) (uint32, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, value}, func() (uint32, error) {
		return uint32(C.ListConnections_index(C.ListConnectionsHandle(h.CAPIHandle()), C.ConnectionsHandle(value.CAPIHandle()))), nil
	})
}
...
func (h *Handle) Equal(b *Handle) (bool, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, b}, func() (bool, error) {
		return bool(C.ListConnections_equal(C.ListConnectionsHandle(h.CAPIHandle()), C.ListConnectionsHandle(b.CAPIHandle()))), nil
	})
}
func (h *Handle) NotEqual(b *Handle) (bool, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, b}, func() (bool, error) {
		return bool(C.ListConnections_not_equal(C.ListConnectionsHandle(h.CAPIHandle()), C.ListConnectionsHandle(b.CAPIHandle()))), nil
	})
}
