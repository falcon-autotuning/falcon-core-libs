...
var (
	defaultFirst  = int32(42)
	defaultSecond = float32(2.2)
	otherFirst    = int32(99)
	otherSecond   = float32(4.4)
)

func TestPairIntFloat_NewAndAccessors(t *testing.T) {
...
func TestPairIntFloat_EqualAndNotEqual(t *testing.T) {
...
func TestPairIntFloat_ToJSONAndFromJSON(t *testing.T) {
	p, err := New(defaultFirst, defaultSecond)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
...
func TestPairIntFloat_CAPIHandle(t *testing.T) {
	p, err := New(defaultFirst, defaultSecond)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
...
func TestPairIntFloat_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
...
func TestPairIntFloat_CloseTwice(t *testing.T) {
	p, err := New(defaultFirst, defaultSecond)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
...
func pairFirstEqual(a, b int32) bool {
