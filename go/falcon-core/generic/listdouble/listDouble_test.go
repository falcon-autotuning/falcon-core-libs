...
func TestListDouble_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestListDouble_AllocateAndFillValue(t *testing.T) {
	l2, err := Allocate(3)
	if err != nil {
...
func TestListDouble_EraseAtAndClear(t *testing.T) {
...
func TestListDouble_IntersectionEqualNotEqual(t *testing.T) {
...
func TestListDouble_ToJSONAndFromJSON(t *testing.T) {
...
func TestListDouble_ContainsAndIndex(t *testing.T) {
...
func TestListDouble_CAPIHandle(t *testing.T) {
...
func TestListDouble_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestListDouble_CloseTwice(t *testing.T) {
	l, err := New(defaultListData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
