...
var (
	...
	defaultSecond = float64(24)
	otherFirst    = otherInterpretationContext
	otherSecond   = float64(11)
)

func TestPairInterpretationContextDouble_NewAndAccessors(t *testing.T) {
...
func TestPairInterpretationContextDouble_EqualAndNotEqual(t *testing.T) {
...
func TestPairInterpretationContextDouble_ToJSONAndFromJSON(t *testing.T) {
	p, err := New(defaultFirst, defaultSecond)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
...
func TestPairInterpretationContextDouble_CAPIHandle(t *testing.T) {
	p, err := New(defaultFirst, defaultSecond)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
...
func TestPairInterpretationContextDouble_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
...
func TestPairInterpretationContextDouble_CloseTwice(t *testing.T) {
	p, err := New(defaultFirst, defaultSecond)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
