...
func Copy(handle *Handle) (*Handle, error) {
	return cmemoryallocation.Read(handle, func() (*Handle, error) {
		...
		return cmemoryallocation.NewAllocation(
			func() (unsafe.Pointer, error) {
				return unsafe.Pointer(C.ListPortTransform_copy(C.ListPortTransformHandle(handle.CAPIHandle()))), nil
			},
			construct,
			destroy,
		)
...
func FillValue(count uint64, value *porttransform.Handle) (*Handle, error) {
...
func New(data []*porttransform.Handle) (*Handle, error) {
	...
	cData := C.malloc(C.size_t(nData) * C.size_t(unsafe.Sizeof(C.PortTransformHandle(nil))))
	if cData == nil {
		return nil, errors.New("C.malloc failed")
	}
	slicecData := (*[1 << 30]C.PortTransformHandle)(cData)[:nData:nData]
	for i, v := range data {
		slicecData[i] = C.PortTransformHandle(v.CAPIHandle())
	}
	return cmemoryallocation.NewAllocation(
		func() (unsafe.Pointer, error) {
			res := unsafe.Pointer(C.ListPortTransform_create((*C.PortTransformHandle)(cData), C.size_t(nData)))
			C.free(cData)
			return res, nil
		},
		construct,
...
func (h *Handle) Size() (uint64, error) {
	return cmemoryallocation.Read(h, func() (uint64, error) {
		return uint64(C.ListPortTransform_size(C.ListPortTransformHandle(h.CAPIHandle()))), nil
	})
}
...
func (h *Handle) Index(value *porttransform.Handle) (uint64, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, value}, func() (uint64, error) {
		return uint64(C.ListPortTransform_index(C.ListPortTransformHandle(h.CAPIHandle()), C.PortTransformHandle(value.CAPIHandle()))), nil
	})
}
...
func (h *Handle) Equal(other *Handle) (bool, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, other}, func() (bool, error) {
		return bool(C.ListPortTransform_equal(C.ListPortTransformHandle(h.CAPIHandle()), C.ListPortTransformHandle(other.CAPIHandle()))), nil
	})
}
func (h *Handle) NotEqual(other *Handle) (bool, error) {
	return cmemoryallocation.MultiRead([]cmemoryallocation.HasCAPIHandle{h, other}, func() (bool, error) {
		return bool(C.ListPortTransform_not_equal(C.ListPortTransformHandle(h.CAPIHandle()), C.ListPortTransformHandle(other.CAPIHandle()))), nil
	})
}
