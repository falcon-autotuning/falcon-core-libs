...
*/
import "C"
type chandle C.ListPortTransformHandle
type Handle struct {
	chandle      chandle
	mu           sync.RWMutex
	closed       bool
...
func NewEmpty() (*Handle, error) {
	h := chandle(C.ListPortTransform_create_empty())
...
func NewFillValue(count int, value *porttransform.Handle) (*Handle, error) {
  
    capi, err := value.CAPIHandle()
    if err != nil {
      return nil, errors.Join(errors.New(`failed to convert to the capi`), err)
    }
    obj := C.PortTransformHandle(capi)
  
  h := chandle(C.ListPortTransform_fill_value(C.size_t(count), obj))
  err = errorhandling.ErrorHandler.CheckCapiError()
  if err != nil {
    return nil, err
  }
...
func New(data []*porttransform.Handle) (*Handle, error) {
	var ptr *C.PortTransformHandle
	if len(data) > 0 {
		cArray := C.malloc(C.size_t(len(data)) * C.size_t(unsafe.Sizeof(uintptr(0))))
		defer C.free(cArray)
		cSlice := (*[1 << 30]C.PortTransformHandle)(cArray)[:len(data):len(data)]
		for i, v := range data {
			...
			cSlice[i] = C.PortTransformHandle(obj)
		}
		ptr = (*C.PortTransformHandle)(cArray)
		h := chandle(C.ListPortTransform_create(ptr, C.size_t(len(data))))
		err := errorhandling.ErrorHandler.CheckCapiError()
		if err != nil {
			return nil, err
		}
	...
	h := chandle(C.ListPortTransform_create(nil, 0))
	err := errorhandling.ErrorHandler.CheckCapiError()
	if err != nil {
		return nil, err
	}
...
func FromJSON(json string) (*Handle, error) {
	...
	h := chandle(C.ListPortTransform_from_json_string(C.StringHandle(capistr)))
	err = errorhandling.ErrorHandler.CheckCapiError()
	if err != nil {
		return nil, err
	}
...
func (h *Handle) Close() error {
	...
	if !h.closed && h.chandle != utils.NilHandle[chandle]() {
		C.ListPortTransform_destroy(C.ListPortTransformHandle(h.chandle))
...
func (h *Handle) PushBack(value *porttransform.Handle) error {
  var err error
	...
	if err != nil {
		return errors.Join(errors.New(`unable to access capi for *porttransform.Handle`), err)
	}
	
	C.ListPortTransform_push_back(C.ListPortTransformHandle(h.chandle), C.PortTransformHandle(obj))
	err = h.errorHandler.CheckCapiError()
	if err != nil {
		return err
	}
...
func (h *Handle) Size() (int, error) {
	...
	val := int(C.ListPortTransform_size(C.ListPortTransformHandle(h.chandle)))
	err := h.errorHandler.CheckCapiError()
	if err != nil {
		return 0, err
	}
...
func (h *Handle) Empty() (bool, error) {
	...
	val := bool(C.ListPortTransform_empty(C.ListPortTransformHandle(h.chandle)))
	err := h.errorHandler.CheckCapiError()
	if err != nil {
		return false, err
	}
...
func (h *Handle) EraseAt(idx int) error {
	...
	C.ListPortTransform_erase_at(C.ListPortTransformHandle(h.chandle), C.size_t(idx))
	err := h.errorHandler.CheckCapiError()
	if err != nil {
		return err
	}
...
func (h *Handle) Clear() error {
	...
	C.ListPortTransform_clear(C.ListPortTransformHandle(h.chandle))
	err := h.errorHandler.CheckCapiError()
	if err != nil {
		return err
	}
...
func (h *Handle) At(idx int) (*porttransform.Handle, error) {
	...
	cHandle := C.ListPortTransform_at(C.ListPortTransformHandle(h.chandle), C.size_t(idx))
...
func (h *Handle) Items() ([]*porttransform.Handle, error) {
	...
	cHandles := make([]C.PortTransformHandle, size)
	C.ListPortTransform_items(C.ListPortTransformHandle(h.chandle), &cHandles[0], C.size_t(size))
	capiErr := h.errorHandler.CheckCapiError()
	if capiErr != nil {
		return nil, errors.Join(errors.New(`could not access capi for list`), capiErr)
	}
	out := make([]*porttransform.Handle, size)
	for i := range cHandles {
		
		goHandle, err := porttransform.FromCAPI(unsafe.Pointer(cHandles[i]))
		if err != nil {
			return nil, err
		}
		out[i] = goHandle
...
func (h *Handle) Contains(value *porttransform.Handle) (bool, error) {
  var err error
	...
	obj, err := value.CAPIHandle()
	if err != nil {
		return false, errors.Join(errors.New(`unable to access capi for *porttransform.Handle`), err)
	}
	
	val := bool(C.ListPortTransform_contains(C.ListPortTransformHandle(h.chandle), C.PortTransformHandle(obj)))
	err = h.errorHandler.CheckCapiError()
	if err != nil {
		return false, err
	}
...
func (h *Handle) Index(value *porttransform.Handle) (int, error) {
  var err error
	...
	obj, err := value.CAPIHandle()
	if err != nil {
		return 0, errors.Join(errors.New(`unable to access capi for *porttransform.Handle`), err)
	}
	
	val := int(C.ListPortTransform_index(C.ListPortTransformHandle(h.chandle), C.PortTransformHandle(obj)))
	err = h.errorHandler.CheckCapiError()
	if err != nil {
		return 0, err
	}
...
func (h *Handle) Intersection(other *Handle) (*Handle, error) {
  ...
  if other == nil {
	...
	res := chandle(C.ListPortTransform_intersection(C.ListPortTransformHandle(h.chandle), C.ListPortTransformHandle(other.chandle)))
	err := h.errorHandler.CheckCapiError()
	if err != nil {
		return nil, err
	}
...
func (h *Handle) Equal(other *Handle) (bool, error) {
  ...
  if other == nil {
	...
	val := bool(C.ListPortTransform_equal(C.ListPortTransformHandle(h.chandle), C.ListPortTransformHandle(other.chandle)))
	err := h.errorHandler.CheckCapiError()
	if err != nil {
		return false, err
	}
...
func (h *Handle) NotEqual(other *Handle) (bool, error) {
  ...
  if other == nil {
	...
	val := bool(C.ListPortTransform_not_equal(C.ListPortTransformHandle(h.chandle), C.ListPortTransformHandle(other.chandle)))
	err := h.errorHandler.CheckCapiError()
	if err != nil {
		return false, err
	}
...
func (h *Handle) ToJSON() (string, error) {
	...
	strHandle, err := str.FromCAPI(unsafe.Pointer(C.ListPortTransform_to_json_string(C.ListPortTransformHandle(h.chandle))))
	if err != nil {
