...
// eqSlice compares two slices of *porttransform.Handle pointers by dereferencing and calling Equal.
func eqSlice(a, b []*porttransform.Handle) bool {
	if len(a) != len(b) {
		return false
	}
	for i := range a {
...
func fixtureListData() []*porttransform.Handle {
	return defaultListData
}
func TestListPortTransform_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestListPortTransform_NewFromSliceAndItems(t *testing.T) {
...
func TestListPortTransform_EraseAtAndClear(t *testing.T) {
...
func TestListPortTransform_IntersectionEqualNotEqual(t *testing.T) {
...
func TestListPortTransform_ToJSONAndFromJSON(t *testing.T) {
...
func TestListPortTransform_ContainsAndIndex(t *testing.T) {
...
func TestListPortTransform_CAPIHandle(t *testing.T) {
...
func TestListPortTransform_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestListPortTransform_CloseTwice(t *testing.T) {
	l, err := New(defaultListData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
