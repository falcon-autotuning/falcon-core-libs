...
var (
	defaultListData = []string{"foo","bar"}
	val1            = "baz"
	otherListData   = []string{"qux"}
)
...
func fixtureListData() []string {
	return defaultListData
}
func TestListString_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestListString_NewFromSliceAndItems(t *testing.T) {
...
func TestListString_EraseAtAndClear(t *testing.T) {
...
func TestListString_IntersectionEqualNotEqual(t *testing.T) {
...
func TestListString_ToJSONAndFromJSON(t *testing.T) {
...
func TestListString_ContainsAndIndex(t *testing.T) {
...
func TestListString_CAPIHandle(t *testing.T) {
...
func TestListString_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestListString_CloseTwice(t *testing.T) {
	l, err := New(defaultListData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
