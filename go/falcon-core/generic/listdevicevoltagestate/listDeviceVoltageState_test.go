...
// eqSlice compares two slices of *devicevoltagestate.Handle pointers by dereferencing and calling Equal.
func eqSlice(a, b []*devicevoltagestate.Handle) bool {
	if len(a) != len(b) {
		return false
	}
	for i := range a {
...
func fixtureListData() []*devicevoltagestate.Handle {
	return defaultListData
}
func TestListDeviceVoltageState_NewEmptyAndPushBack(t *testing.T) {
	l, err := NewEmpty()
	if err != nil {
...
func TestListDeviceVoltageState_NewFromSliceAndItems(t *testing.T) {
...
func TestListDeviceVoltageState_EraseAtAndClear(t *testing.T) {
...
func TestListDeviceVoltageState_IntersectionEqualNotEqual(t *testing.T) {
...
func TestListDeviceVoltageState_ToJSONAndFromJSON(t *testing.T) {
...
func TestListDeviceVoltageState_ContainsAndIndex(t *testing.T) {
...
func TestListDeviceVoltageState_CAPIHandle(t *testing.T) {
...
func TestListDeviceVoltageState_FromCAPI(t *testing.T) {
	h, err := FromCAPI(nil)
	if err == nil || h != nil {
		t.Errorf("FromCAPI(nil) should error and return nil")
	}
}
func TestListDeviceVoltageState_CloseTwice(t *testing.T) {
	l, err := New(defaultListData)
	if err != nil {
		t.Fatalf("New failed: %v", err)
	}
