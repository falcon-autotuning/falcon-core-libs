...
class _InterpretationContainerFactory:
    ...
    def __call__(self, *args, **kwargs):
        ...
        # Users should use class methods like InterpretationContainer[T].new_empty(...)
        raise TypeError(f'Use InterpretationContainer[{self.element_type}].new_*() class methods to construct instances')
