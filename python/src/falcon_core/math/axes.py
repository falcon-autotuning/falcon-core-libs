...
class _AxesFactory:
    ...
    def __call__(self, *args, **kwargs):
        ...
        # Users should use class methods like Axes[T].new_empty(...)
        raise TypeError(f'Use Axes[{self.element_type}].new_*() class methods to construct instances')
...
class Axes:
    ...
    def __repr__(self):
        return f"Axes[{self._element_type}]({self._c})"
