...
class LabelledControlArray1D:
    ...
    def copy(self, ) -> LabelledControlArray1D:
        ret = self._c.copy()
        return LabelledControlArray1D._from_capi(ret)

    def equal(self, other: LabelledControlArray1D) -> bool:
        ret = self._c.equal(other._c if other is not None else None)
        return ret

    def not_equal(self, other: LabelledControlArray1D) -> bool:
    ...
    def get_summed_diff_array_of_squares(self, other: LabelledControlArray1D) -> float:
    ...
    def __repr__(self):
        return f"LabelledControlArray1D({self.to_json()})"
