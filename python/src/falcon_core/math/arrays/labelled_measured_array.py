...
class LabelledMeasuredArray:
    ...
    def equal(self, other: LabelledMeasuredArray) -> bool:
        ret = self._c.equal(other._c if other is not None else None)
        return ret

    def not_equal(self, other: LabelledMeasuredArray) -> bool:
    ...
    def full_gradient(self, out_buffer: LabelledMeasuredArray, buffer_size: Any) -> int:
    ...
    def get_summed_diff_array_of_squares(self, other: LabelledMeasuredArray) -> float:
    ...
    def __repr__(self):
        return f"LabelledMeasuredArray({self.to_json()})"
