...
class MeasuredArray:
    ...
    def equal(self, other: MeasuredArray) -> bool:
        ret = self._c.equal(other._c if other is not None else None)
        return ret

    def not_equal(self, other: MeasuredArray) -> bool:
    ...
    def full_gradient(self, out_buffer: MeasuredArray, buffer_size: Any) -> int:
    ...
    def get_summed_diff_array_of_squares(self, other: MeasuredArray) -> float:
    ...
    def __repr__(self):
        return f"MeasuredArray({self.to_json()})"
