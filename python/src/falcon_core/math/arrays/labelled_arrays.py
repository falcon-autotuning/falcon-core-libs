...
class _LabelledArraysFactory:
    ...
    def __call__(self, *args, **kwargs):
        ...
        # Users should use class methods like LabelledArrays[T].new_empty(...)
        raise TypeError(f'Use LabelledArrays[{self.element_type}].new_*() class methods to construct instances')
