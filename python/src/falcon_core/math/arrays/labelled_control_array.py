...
from falcon_core._capi.labelled_control_array import LabelledControlArray as _CLabelledControlArray
...
class LabelledControlArray:
    """Python wrapper for LabelledControlArray."""
    ...
    @classmethod
    def from_farray(cls, farray: FArrayDouble, label: AcquisitionContext) -> LabelledControlArray:
        ret = _CLabelledControlArray.from_farray(farray._c, label._c)
        return cls._from_capi(ret)

    @classmethod
    def from_control_array(cls, controlarray: ControlArray, label: AcquisitionContext) -> LabelledControlArray:
        ret = _CLabelledControlArray.from_control_array(controlarray._c, label._c)
        return cls._from_capi(ret)
    ...
    def plus_control_array(self, other: LabelledControlArray) -> LabelledControlArray:
        ret = self._c.plus_control_array(other._c)
        return cls._from_capi(ret)

    def plus_farray(self, other: FArrayDouble) -> LabelledControlArray:
        ret = self._c.plus_farray(other._c)
        return cls._from_capi(ret)

    def plus_double(self, other: Any) -> LabelledControlArray:
        ret = self._c.plus_double(other)
        return cls._from_capi(ret)

    def plus_int(self, other: Any) -> LabelledControlArray:
        ret = self._c.plus_int(other)
        return cls._from_capi(ret)

    def minusequals_control_array(self, other: LabelledControlArray) -> None:
        ret = self._c.minusequals_control_array(other._c)
        return ret
    ...
    def minus_control_array(self, other: LabelledControlArray) -> LabelledControlArray:
        ret = self._c.minus_control_array(other._c)
        return cls._from_capi(ret)

    def minus_farray(self, other: FArrayDouble) -> LabelledControlArray:
        ret = self._c.minus_farray(other._c)
        return cls._from_capi(ret)

    def minus_double(self, other: Any) -> LabelledControlArray:
        ret = self._c.minus_double(other)
        return cls._from_capi(ret)

    def minus_int(self, other: Any) -> LabelledControlArray:
        ret = self._c.minus_int(other)
        return cls._from_capi(ret)

    def negation(self, ) -> LabelledControlArray:
    ...
    def times_double(self, other: Any) -> LabelledControlArray:
        ret = self._c.times_double(other)
        return cls._from_capi(ret)

    def times_int(self, other: Any) -> LabelledControlArray:
    ...
    def divides_double(self, other: Any) -> LabelledControlArray:
        ret = self._c.divides_double(other)
        return cls._from_capi(ret)

    def divides_int(self, other: Any) -> LabelledControlArray:
        ret = self._c.divides_int(other)
        return cls._from_capi(ret)

    def pow(self, other: Any) -> LabelledControlArray:
        ret = self._c.pow(other)
        return cls._from_capi(ret)

    def abs(self, ) -> LabelledControlArray:
        ret = self._c.abs()
        return cls._from_capi(ret)

    def min(self, ) -> LabelledControlArray:
        ret = self._c.min()
        return cls._from_capi(ret)

    def min_farray(self, other: FArrayDouble) -> LabelledControlArray:
        ret = self._c.min_farray(other._c)
        return cls._from_capi(ret)

    def min_control_array(self, other: LabelledControlArray) -> LabelledControlArray:
        ret = self._c.min_control_array(other._c)
        return cls._from_capi(ret)

    def max(self, ) -> LabelledControlArray:
        ret = self._c.max()
        return cls._from_capi(ret)

    def max_farray(self, other: FArrayDouble) -> LabelledControlArray:
        ret = self._c.max_farray(other._c)
        return cls._from_capi(ret)

    def max_control_array(self, other: LabelledControlArray) -> LabelledControlArray:
        ret = self._c.max_control_array(other._c)
        return cls._from_capi(ret)

    def equality(self, other: LabelledControlArray) -> None:
        ret = self._c.equality(other._c)
        return ret

    def notequality(self, other: LabelledControlArray) -> None:
    ...
    def reshape(self, shape: Any, ndims: Any) -> LabelledControlArray:
    ...
    def flip(self, axis: Any) -> LabelledControlArray:
