...
class MeasuredArray1D:
    ...
    @classmethod
    def MeasuredArray1D_from_json_string(cls, json: str) -> MeasuredArray1D:
        return cls(_CMeasuredArray1D.MeasuredArray1D_from_json_string(json))
    ...
    def __neg__(self, ) -> MeasuredArray1D:
    ...
    def equality(self, other: MeasuredArray1D) -> None:
        ret = self._c.equality(other._c)
        return ret

    def notequality(self, other: MeasuredArray1D) -> None:
