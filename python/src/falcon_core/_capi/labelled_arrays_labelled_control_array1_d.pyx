...
cdef LabelledArraysLabelledControlArray1D _labelled_arrays_labelled_control_array1_d_from_capi(_c_api.LabelledArraysLabelledControlArray1DHandle h):
    ...
    @classmethod
    def create(cls, ListLabelledControlArray1D arrays):
        cdef _c_api.LabelledArraysLabelledControlArray1DHandle h
        h = _c_api.LabelledArraysLabelledControlArray1D_create(arrays.handle)
        if h == <_c_api.LabelledArraysLabelledControlArray1DHandle>0:
    ...
    def arrays(self, ):
        ...
        if h_ret == <_c_api.ListLabelledControlArray1DHandle>0:
            return None
        return list_labelled_control_array1_d._list_labelled_control_array1_d_from_capi(h_ret)
    ...
    def isControlArrays(self, ):
        return _c_api.LabelledArraysLabelledControlArray1D_isControlArrays(self.handle)

    def isMeasuredArrays(self, ):
        return _c_api.LabelledArraysLabelledControlArray1D_isMeasuredArrays(self.handle)

    def push_back(self, LabelledControlArray1D value):
        _c_api.LabelledArraysLabelledControlArray1D_push_back(self.handle, value.handle)
    ...
    def contains(self, LabelledControlArray1D value):
        return _c_api.LabelledArraysLabelledControlArray1D_contains(self.handle, value.handle)

    def index(self, LabelledControlArray1D value):
        return _c_api.LabelledArraysLabelledControlArray1D_index(self.handle, value.handle)

    def intersection(self, LabelledArraysLabelledControlArray1D other):
        cdef _c_api.LabelledArraysLabelledControlArray1DHandle h_ret = _c_api.LabelledArraysLabelledControlArray1D_intersection(self.handle, other.handle)
    ...
    def equal(self, LabelledArraysLabelledControlArray1D other):
        return _c_api.LabelledArraysLabelledControlArray1D_equal(self.handle, other.handle)
    ...
    def not_equal(self, LabelledArraysLabelledControlArray1D other):
        return _c_api.LabelledArraysLabelledControlArray1D_not_equal(self.handle, other.handle)
