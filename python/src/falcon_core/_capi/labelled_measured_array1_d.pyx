...
cdef LabelledMeasuredArray1D _labelled_measured_array1_d_from_capi(_c_api.LabelledMeasuredArray1DHandle h):
    ...
    def from_farray(FArrayDouble farray, AcquisitionContext label):
        cdef _c_api.LabelledMeasuredArray1DHandle h_ret = _c_api.LabelledMeasuredArray1D_from_farray(farray.handle, label.handle)
    ...
    def from_measured_array(MeasuredArray measuredarray, AcquisitionContext label):
        cdef _c_api.LabelledMeasuredArray1DHandle h_ret = _c_api.LabelledMeasuredArray1D_from_measured_array(measuredarray.handle, label.handle)
        if h_ret == <_c_api.LabelledMeasuredArray1DHandle>0:
            return None
        return _labelled_measured_array1_d_from_capi(h_ret)
    ...
    def shape(self, size_t out_buffer, size_t ndim):
        return _c_api.LabelledMeasuredArray1D_shape(self.handle, out_buffer, ndim)

    def data(self, double out_buffer, size_t numdata):
        return _c_api.LabelledMeasuredArray1D_data(self.handle, out_buffer, numdata)

    def plusequals_farray(self, FArrayDouble other):
        _c_api.LabelledMeasuredArray1D_plusequals_farray(self.handle, other.handle)

    def plusequals_double(self, double other):
        _c_api.LabelledMeasuredArray1D_plusequals_double(self.handle, other)

    def plusequals_int(self, int other):
        _c_api.LabelledMeasuredArray1D_plusequals_int(self.handle, other)

    def plus_measured_array(self, LabelledMeasuredArray1D other):
        cdef _c_api.LabelledMeasuredArray1DHandle h_ret = _c_api.LabelledMeasuredArray1D_plus_measured_array(self.handle, other.handle)
        if h_ret == <_c_api.LabelledMeasuredArray1DHandle>0:
            return None
        return _labelled_measured_array1_d_from_capi(h_ret)

    def plus_farray(self, FArrayDouble other):
        cdef _c_api.LabelledMeasuredArray1DHandle h_ret = _c_api.LabelledMeasuredArray1D_plus_farray(self.handle, other.handle)
        if h_ret == <_c_api.LabelledMeasuredArray1DHandle>0:
            return None
        return _labelled_measured_array1_d_from_capi(h_ret)
    ...
    def minusequals_measured_array(self, LabelledMeasuredArray1D other):
        _c_api.LabelledMeasuredArray1D_minusequals_measured_array(self.handle, other.handle)

    def minusequals_farray(self, FArrayDouble other):
        _c_api.LabelledMeasuredArray1D_minusequals_farray(self.handle, other.handle)

    def minusequals_double(self, double other):
        _c_api.LabelledMeasuredArray1D_minusequals_double(self.handle, other)

    def minusequals_int(self, int other):
        _c_api.LabelledMeasuredArray1D_minusequals_int(self.handle, other)

    def minus_measured_array(self, MeasuredArray other):
        cdef _c_api.LabelledMeasuredArray1DHandle h_ret = _c_api.LabelledMeasuredArray1D_minus_measured_array(self.handle, other.handle)
        if h_ret == <_c_api.LabelledMeasuredArray1DHandle>0:
            return None
        return _labelled_measured_array1_d_from_capi(h_ret)

    def minus_farray(self, FArrayDouble other):
        cdef _c_api.LabelledMeasuredArray1DHandle h_ret = _c_api.LabelledMeasuredArray1D_minus_farray(self.handle, other.handle)
        if h_ret == <_c_api.LabelledMeasuredArray1DHandle>0:
            return None
        return _labelled_measured_array1_d_from_capi(h_ret)
    ...
    def timesequals_measured_array(self, LabelledMeasuredArray1D other):
        cdef _c_api.LabelledMeasuredArray1DHandle h_ret = _c_api.LabelledMeasuredArray1D_timesequals_measured_array(self.handle, other.handle)
        if h_ret == <_c_api.LabelledMeasuredArray1DHandle>0:
            return None
        return _labelled_measured_array1_d_from_capi(h_ret)

    def timesequals_farray(self, FArrayDouble other):
        cdef _c_api.LabelledMeasuredArray1DHandle h_ret = _c_api.LabelledMeasuredArray1D_timesequals_farray(self.handle, other.handle)
        if h_ret == <_c_api.LabelledMeasuredArray1DHandle>0:
            return None
        return _labelled_measured_array1_d_from_capi(h_ret)

    def timesequals_double(self, double other):
        _c_api.LabelledMeasuredArray1D_timesequals_double(self.handle, other)

    def timesequals_int(self, int other):
        _c_api.LabelledMeasuredArray1D_timesequals_int(self.handle, other)

    def times_measured_array(self, LabelledMeasuredArray1D other):
        cdef _c_api.LabelledMeasuredArray1DHandle h_ret = _c_api.LabelledMeasuredArray1D_times_measured_array(self.handle, other.handle)
        if h_ret == <_c_api.LabelledMeasuredArray1DHandle>0:
            return None
        return _labelled_measured_array1_d_from_capi(h_ret)

    def times_farray(self, FArrayDouble other):
        cdef _c_api.LabelledMeasuredArray1DHandle h_ret = _c_api.LabelledMeasuredArray1D_times_farray(self.handle, other.handle)
        if h_ret == <_c_api.LabelledMeasuredArray1DHandle>0:
            return None
        return _labelled_measured_array1_d_from_capi(h_ret)
    ...
    def dividesequals_measured_array(self, LabelledMeasuredArray1D other):
        cdef _c_api.LabelledMeasuredArray1DHandle h_ret = _c_api.LabelledMeasuredArray1D_dividesequals_measured_array(self.handle, other.handle)
        if h_ret == <_c_api.LabelledMeasuredArray1DHandle>0:
            return None
        return _labelled_measured_array1_d_from_capi(h_ret)

    def dividesequals_farray(self, FArrayDouble other):
        cdef _c_api.LabelledMeasuredArray1DHandle h_ret = _c_api.LabelledMeasuredArray1D_dividesequals_farray(self.handle, other.handle)
        if h_ret == <_c_api.LabelledMeasuredArray1DHandle>0:
            return None
        return _labelled_measured_array1_d_from_capi(h_ret)

    def dividesequals_double(self, double other):
        _c_api.LabelledMeasuredArray1D_dividesequals_double(self.handle, other)

    def dividesequals_int(self, int other):
        _c_api.LabelledMeasuredArray1D_dividesequals_int(self.handle, other)

    def divides_measured_array(self, LabelledMeasuredArray1D other):
        cdef _c_api.LabelledMeasuredArray1DHandle h_ret = _c_api.LabelledMeasuredArray1D_divides_measured_array(self.handle, other.handle)
        if h_ret == <_c_api.LabelledMeasuredArray1DHandle>0:
            return None
        return _labelled_measured_array1_d_from_capi(h_ret)

    def divides_farray(self, FArrayDouble other):
        cdef _c_api.LabelledMeasuredArray1DHandle h_ret = _c_api.LabelledMeasuredArray1D_divides_farray(self.handle, other.handle)
        if h_ret == <_c_api.LabelledMeasuredArray1DHandle>0:
            return None
        return _labelled_measured_array1_d_from_capi(h_ret)
    ...
    def min_farray(self, FArrayDouble other):
        cdef _c_api.LabelledMeasuredArray1DHandle h_ret = _c_api.LabelledMeasuredArray1D_min_farray(self.handle, other.handle)
        if h_ret == <_c_api.LabelledMeasuredArray1DHandle>0:
            return None
        return _labelled_measured_array1_d_from_capi(h_ret)

    def min_measured_array(self, LabelledMeasuredArray1D other):
        cdef _c_api.LabelledMeasuredArray1DHandle h_ret = _c_api.LabelledMeasuredArray1D_min_measured_array(self.handle, other.handle)
        if h_ret == <_c_api.LabelledMeasuredArray1DHandle>0:
            return None
        return _labelled_measured_array1_d_from_capi(h_ret)

    def max_farray(self, FArrayDouble other):
        cdef _c_api.LabelledMeasuredArray1DHandle h_ret = _c_api.LabelledMeasuredArray1D_max_farray(self.handle, other.handle)
        if h_ret == <_c_api.LabelledMeasuredArray1DHandle>0:
            return None
        return _labelled_measured_array1_d_from_capi(h_ret)

    def max_measured_array(self, LabelledMeasuredArray1D other):
        cdef _c_api.LabelledMeasuredArray1DHandle h_ret = _c_api.LabelledMeasuredArray1D_max_measured_array(self.handle, other.handle)
        if h_ret == <_c_api.LabelledMeasuredArray1DHandle>0:
            return None
        return _labelled_measured_array1_d_from_capi(h_ret)

    def equality(self, LabelledMeasuredArray1D other):
        return _c_api.LabelledMeasuredArray1D_equality(self.handle, other.handle)

    def notequality(self, LabelledMeasuredArray1D other):
        return _c_api.LabelledMeasuredArray1D_notequality(self.handle, other.handle)

    def greaterthan(self, double value):
        return _c_api.LabelledMeasuredArray1D_greaterthan(self.handle, value)

    def lessthan(self, double value):
        return _c_api.LabelledMeasuredArray1D_lessthan(self.handle, value)
    ...
    def reshape(self, size_t shape, size_t ndims):
        cdef _c_api.LabelledMeasuredArray1DHandle h_ret = _c_api.LabelledMeasuredArray1D_reshape(self.handle, shape, ndims)
        if h_ret == <_c_api.LabelledMeasuredArray1DHandle>0:
            return None
        return _labelled_measured_array1_d_from_capi(h_ret)
    ...
    def full_gradient(self, LabelledMeasuredArray1D out_buffer, size_t buffer_size):
        return _c_api.LabelledMeasuredArray1D_full_gradient(self.handle, out_buffer.handle, buffer_size)
    ...
    def get_summed_diff_array_of_squares(self, LabelledMeasuredArray1D other):
        return _c_api.LabelledMeasuredArray1D_get_summed_diff_array_of_squares(self.handle, other.handle)
