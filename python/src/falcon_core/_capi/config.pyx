...
cdef Config _config_from_capi(_c_api.ConfigHandle h):
    ...
    @classmethod
    def create(cls, Connections screening_gates, Connections plunger_gates, Connections ohmics, Connections barrier_gates, Connections reservoir_gates, MapGnameGroup groups, Impedances wiring_DC, VoltageConstraints constraints):
