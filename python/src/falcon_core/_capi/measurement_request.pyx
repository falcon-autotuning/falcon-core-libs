...
cdef MeasurementRequest _measurement_request_from_capi(_c_api.MeasurementRequestHandle h):
    ...
    @classmethod
    def create(cls, str message, str measurement_name, ListWaveform waveforms, Ports getters, MapInstrumentPortPortTransform meter_transforms, LabelledDomain time_domain):
