...
class TestListDotGateWithNeighbors:
    def setup_method(self):
        self.obj = None
        try:
            # Found empty constructor: ListDotGateWithNeighbors_create_empty
            self.obj = List[DotGateWithNeighbors]()
    ...
    def test_ctor_new_empty(self):
        try:
            List[DotGateWithNeighbors]()
        except Exception as e:
            print(f'Constructor new_empty failed: {e}')

    def test_ctor_new(self):
        try:
            List[DotGateWithNeighbors](array.array('L', [0]), 1)
        except Exception as e:
            print(f'Constructor new failed: {e}')

    def test_ctor_from_json(self):
        try:
            List[DotGateWithNeighbors]("test_string")
        except Exception as e:
