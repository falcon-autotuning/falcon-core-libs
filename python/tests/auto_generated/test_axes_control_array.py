...
class TestAxesControlArray:
    def setup_method(self):
        self.obj = None
        try:
            # Found empty constructor: AxesControlArray_create_empty
            self.obj = Axes[ControlArray]()
    ...
    def test_ctor_new(self):
        try:
            Axes[ControlArray](None)
        except Exception as e:
            print(f'Constructor new failed: {e}')

    def test_ctor_from_json(self):
        try:
            Axes[ControlArray]("test_string")
        except Exception as e:
