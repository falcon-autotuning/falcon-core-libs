...
class TestLabelledArraysLabelledMeasuredArray:
    def setup_method(self):
        self.obj = None
        try:
            # Using recipe for LabelledArraysLabelledMeasuredArray
            self.obj = LabelledArrays[LabelledMeasuredArray](List[LabelledMeasuredArray]())
    ...
    def test_intersection(self):
        if self.obj is None:
            pytest.skip('Skipping test because object could not be instantiated')
        try:
            self.obj.intersection(LabelledArrays[LabelledMeasuredArray](List[LabelledMeasuredArray]()))
        except Exception as e:
            print(f'Method call failed: {e}')
    ...
    def test_equal(self):
        if self.obj is None:
            pytest.skip('Skipping test because object could not be instantiated')
        try:
            self.obj.equal(LabelledArrays[LabelledMeasuredArray](List[LabelledMeasuredArray]()))
        except Exception as e:
            print(f'Method call failed: {e}')
    ...
    def test_not_equal(self):
        if self.obj is None:
            pytest.skip('Skipping test because object could not be instantiated')
        try:
            self.obj.not_equal(LabelledArrays[LabelledMeasuredArray](List[LabelledMeasuredArray]()))
        except Exception as e:
            print(f'Method call failed: {e}')
    ...
    def test_ctor_new(self):
        try:
            LabelledArrays[LabelledMeasuredArray](None)
        except Exception as e:
            print(f'Constructor new failed: {e}')

    def test_ctor_from_json(self):
        try:
            LabelledArrays[LabelledMeasuredArray]("test_string")
        except Exception as e:
