...
class TestListPairInterpretationContextQuantity:
    def setup_method(self):
        self.obj = None
        try:
            # Found empty constructor: ListPairInterpretationContextQuantity_create_empty
            self.obj = List[Pair[InterpretationContext, Quantity]]()
    ...
    def test_ctor_new_empty(self):
        try:
            List[Pair[InterpretationContext, Quantity]]()
        except Exception as e:
            print(f'Constructor new_empty failed: {e}')

    def test_ctor_new(self):
        try:
            List[Pair[InterpretationContext, Quantity]](array.array('L', [0]), 1)
        except Exception as e:
            print(f'Constructor new failed: {e}')

    def test_ctor_from_json(self):
        try:
            List[Pair[InterpretationContext, Quantity]]("test_string")
        except Exception as e:
