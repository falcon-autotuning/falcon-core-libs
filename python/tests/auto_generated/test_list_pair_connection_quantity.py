...
class TestListPairConnectionQuantity:
    def setup_method(self):
        self.obj = None
        try:
            # Found empty constructor: ListPairConnectionQuantity_create_empty
            self.obj = List[Pair[Connection, Quantity]]()
    ...
    def test_ctor_new_empty(self):
        try:
            List[Pair[Connection, Quantity]]()
        except Exception as e:
            print(f'Constructor new_empty failed: {e}')

    def test_ctor_new(self):
        try:
            List[Pair[Connection, Quantity]](array.array('L', [0]), 1)
        except Exception as e:
            print(f'Constructor new failed: {e}')

    def test_ctor_from_json(self):
        try:
            List[Pair[Connection, Quantity]]("test_string")
        except Exception as e:
