...
class TestListBool:
    def setup_method(self):
        self.obj = None
        try:
            # Found empty constructor: ListBool_create_empty
            self.obj = List[bool]()
    ...
    def test_items(self):
        if self.obj is None:
            pytest.skip('Skipping test because object could not be instantiated')
        try:
            self.obj.items(array.array('B', [0]), 1)
        except Exception as e:
            print(f'Method call failed: {e}')
    ...
    def test_ctor_new(self):
        try:
            List[bool](array.array('B', [0]), 1)
        except Exception as e:
            print(f'Constructor new failed: {e}')

    def test_ctor_from_json(self):
        try:
            List[bool]("test_string")
        except Exception as e:
