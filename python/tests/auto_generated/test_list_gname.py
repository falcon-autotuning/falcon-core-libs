...
class TestListGname:
    def setup_method(self):
        self.obj = None
        try:
            # Found empty constructor: ListGname_create_empty
            self.obj = List[Gname]()
    ...
    def test_fill_value(self):
        if self.obj is None:
            pytest.skip('Skipping test because object could not be instantiated')
        try:
            self.obj.fill_value(1, Gname.new('test_gname'))
        except Exception as e:
            print(f'Method call failed: {e}')
    ...
    def test_push_back(self):
        if self.obj is None:
            pytest.skip('Skipping test because object could not be instantiated')
        try:
            self.obj.push_back(Gname.new('test_gname'))
        except Exception as e:
            print(f'Method call failed: {e}')
    ...
    def test_index(self):
        if self.obj is None:
            pytest.skip('Skipping test because object could not be instantiated')
        try:
            self.obj.index(Gname.new('test_gname'))
        except Exception as e:
            print(f'Method call failed: {e}')
    ...
    def test_ctor_new(self):
        try:
            List[Gname](array.array('L', [0]), 1)
        except Exception as e:
            print(f'Constructor new failed: {e}')

    def test_ctor_from_json(self):
        try:
            List[Gname]("test_string")
        except Exception as e:
