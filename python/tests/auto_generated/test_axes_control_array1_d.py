...
class TestAxesControlArray1D:
    def setup_method(self):
        self.obj = None
        try:
            # Found empty constructor: AxesControlArray1D_create_empty
            self.obj = Axes[ControlArray1D]()
    ...
    def test_ctor_new(self):
        try:
            Axes[ControlArray1D](None)
        except Exception as e:
            print(f'Constructor new failed: {e}')

    def test_ctor_from_json(self):
        try:
            Axes[ControlArray1D]("test_string")
        except Exception as e:
