...
class TestAxesLabelledControlArray:
    def setup_method(self):
        self.obj = None
        try:
            # Found empty constructor: AxesLabelledControlArray_create_empty
            self.obj = Axes[LabelledControlArray]()
    ...
    def test_ctor_new(self):
        try:
            Axes[LabelledControlArray](None)
        except Exception as e:
            print(f'Constructor new failed: {e}')

    def test_ctor_from_json(self):
        try:
            Axes[LabelledControlArray]("test_string")
        except Exception as e:
