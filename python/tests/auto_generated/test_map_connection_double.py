...
class TestMapConnectionDouble:
    def setup_method(self):
        self.obj = None
        try:
            # Found empty constructor: MapConnectionDouble_create_empty
            self.obj = Map[Connection, float]()
    ...
    def test_ctor_new_empty(self):
        try:
            Map[Connection, float]()
        except Exception as e:
            print(f'Constructor new_empty failed: {e}')

    def test_ctor_new(self):
        try:
            Map[Connection, float](array.array('L', [0]), 1)
        except Exception as e:
            print(f'Constructor new failed: {e}')

    def test_ctor_from_json(self):
        try:
            Map[Connection, float]("test_string")
        except Exception as e:
