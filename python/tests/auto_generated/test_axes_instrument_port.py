...
class TestAxesInstrumentPort:
    def setup_method(self):
        self.obj = None
        try:
            # Found empty constructor: AxesInstrumentPort_create_empty
            self.obj = Axes[InstrumentPort]()
    ...
    def test_ctor_new(self):
        try:
            Axes[InstrumentPort](None)
        except Exception as e:
            print(f'Constructor new failed: {e}')

    def test_ctor_from_json(self):
        try:
            Axes[InstrumentPort]("test_string")
        except Exception as e:
