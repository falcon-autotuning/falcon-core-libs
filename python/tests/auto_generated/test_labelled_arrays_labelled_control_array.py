...
class TestLabelledArraysLabelledControlArray:
    def setup_method(self):
        self.obj = None
        try:
            # Using recipe for LabelledArraysLabelledControlArray
            self.obj = LabelledArrays[LabelledControlArray](List[LabelledControlArray]())
    ...
    def test_ctor_new(self):
        try:
            LabelledArrays[LabelledControlArray](None)
        except Exception as e:
            print(f'Constructor new failed: {e}')

    def test_ctor_from_json(self):
        try:
            LabelledArrays[LabelledControlArray]("test_string")
        except Exception as e:
