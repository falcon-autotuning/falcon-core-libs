...
class TestListConnection:
    def setup_method(self):
        self.obj = None
        try:
            # Found empty constructor: ListConnection_create_empty
            self.obj = List[Connection]()
    ...
    def test_fill_value(self):
        if self.obj is None:
            pytest.skip('Skipping test because object could not be instantiated')
        try:
            self.obj.fill_value(1, Connection.new_barrier('test_conn'))
        except Exception as e:
            print(f'Method call failed as expected: {e}')
    ...
    def test_ctor_new(self):
        try:
            List[Connection](array.array('L', [0]), 1)
        except Exception as e:
            print(f'Constructor new failed: {e}')

    def test_ctor_from_json(self):
        try:
            List[Connection]("test_string")
        except Exception as e:
