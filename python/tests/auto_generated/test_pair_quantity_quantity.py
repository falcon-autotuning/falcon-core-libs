...
class TestPairQuantityQuantity:
    ...
    def test_ctor_new(self):
        try:
            Pair[Quantity, Quantity](Quantity.new(1.0, SymbolUnit.new_meter()), Quantity.new(1.0, SymbolUnit.new_meter()))
        except Exception as e:
            print(f'Constructor new failed: {e}')

    def test_ctor_from_json(self):
        try:
            Pair[Quantity, Quantity]("test_string")
        except Exception as e:
