...
class TestPairConnectionConnection:
    ...
    def test_ctor_new(self):
        try:
            Pair[Connection, Connection](Connection.new_barrier('test_conn'), Connection.new_barrier('test_conn'))
        except Exception as e:
            print(f'Constructor new failed: {e}')

    def test_ctor_from_json(self):
        try:
            Pair[Connection, Connection]("test_string")
        except Exception as e:
