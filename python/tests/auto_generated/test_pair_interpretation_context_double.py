...
class TestPairInterpretationContextDouble:
    def setup_method(self):
        ...
        try:
            ...
            self.obj = Pair[InterpretationContext, float](_make_test_interpretation_context(), 1.0)
    ...
    def test_ctor_new(self):
        try:
            Pair[InterpretationContext, float](_make_test_interpretation_context(), 1.0)
        except Exception as e:
            print(f'Constructor new failed: {e}')

    def test_ctor_from_json(self):
        try:
            Pair[InterpretationContext, float]("test_string")
        except Exception as e:
