...
class TestAxesLabelledMeasuredArray1D:
    def setup_method(self):
        self.obj = None
        try:
            # Found empty constructor: AxesLabelledMeasuredArray1D_create_empty
            self.obj = Axes[LabelledMeasuredArray1D]()
    ...
    def test_ctor_new_empty(self):
        try:
            Axes[LabelledMeasuredArray1D]()
        except Exception as e:
            print(f'Constructor new_empty failed: {e}')

    def test_ctor_new(self):
        try:
            Axes[LabelledMeasuredArray1D](None)
        except Exception as e:
            print(f'Constructor new failed: {e}')

    def test_ctor_from_json(self):
        try:
            Axes[LabelledMeasuredArray1D]("test_string")
        except Exception as e:
