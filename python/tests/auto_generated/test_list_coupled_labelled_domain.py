...
class TestListCoupledLabelledDomain:
    def setup_method(self):
        self.obj = None
        try:
            # Found empty constructor: ListCoupledLabelledDomain_create_empty
            self.obj = List[CoupledLabelledDomain]()
    ...
    def test_fill_value(self):
        if self.obj is None:
            pytest.skip('Skipping test because object could not be instantiated')
        try:
            self.obj.fill_value(1, CoupledLabelledDomain.new_empty())
        except Exception as e:
            print(f'Method call failed as expected: {e}')
    ...
    def test_ctor_new_empty(self):
        try:
            List[CoupledLabelledDomain]()
        except Exception as e:
            print(f'Constructor new_empty failed: {e}')

    def test_ctor_new(self):
        try:
            List[CoupledLabelledDomain](array.array('L', [0]), 1)
        except Exception as e:
            print(f'Constructor new failed: {e}')

    def test_ctor_from_json(self):
        try:
            List[CoupledLabelledDomain]("test_string")
        except Exception as e:
