...
class TestLabelledMeasuredArray1D:
    def setup_method(self):
        self.obj = None
        try:
            # Found constructor: LabelledMeasuredArray1D_from_json_string
            self.obj = LabelledMeasuredArray1D.from_json("test_string")
    ...
    def test_from_measured_array(self):
        if self.obj is None:
            pytest.skip('Skipping test because object could not be instantiated')
        try:
            self.obj.from_measured_array(None, None)
        except Exception as e:
            print(f'Method call failed as expected: {e}')
    ...
    def test_minusequals_measured_array(self):
        if self.obj is None:
            pytest.skip('Skipping test because object could not be instantiated')
        try:
            self.obj.minusequals_measured_array(None)
        except Exception as e:
            print(f'Method call failed as expected: {e}')
    ...
    def test_timesequals_measured_array(self):
        if self.obj is None:
            pytest.skip('Skipping test because object could not be instantiated')
        try:
            self.obj.timesequals_measured_array(None)
        except Exception as e:
            print(f'Method call failed as expected: {e}')
    ...
    def test_dividesequals_measured_array(self):
        if self.obj is None:
            pytest.skip('Skipping test because object could not be instantiated')
        try:
            self.obj.dividesequals_measured_array(None)
        except Exception as e:
            print(f'Method call failed as expected: {e}')

    def test_dividesequals_farray(self):
        if self.obj is None:
            pytest.skip('Skipping test because object could not be instantiated')
        try:
            self.obj.dividesequals_farray(None)
        except Exception as e:
            print(f'Method call failed as expected: {e}')
