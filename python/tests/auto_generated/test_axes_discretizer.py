...
class TestAxesDiscretizer:
    def setup_method(self):
        self.obj = None
        try:
            # Found empty constructor: AxesDiscretizer_create_empty
            self.obj = Axes[Discretizer]()
    ...
    def test_ctor_new(self):
        try:
            Axes[Discretizer](None)
        except Exception as e:
            print(f'Constructor new failed: {e}')

    def test_ctor_from_json(self):
        try:
            Axes[Discretizer]("test_string")
        except Exception as e:
