...
class TestListPairSizeTSizeT:
    def setup_method(self):
        self.obj = None
        try:
            # Found empty constructor: ListPairSizeTSizeT_create_empty
            self.obj = List[Pair[int, int]]()
    ...
    def test_fill_value(self):
        if self.obj is None:
            pytest.skip('Skipping test because object could not be instantiated')
        try:
            self.obj.fill_value(1, Pair[int, int](1, 1))
        except Exception as e:
            print(f'Method call failed as expected: {e}')
    ...
    def test_push_back(self):
        if self.obj is None:
            pytest.skip('Skipping test because object could not be instantiated')
        try:
            self.obj.push_back(Pair[int, int](1, 1))
        except Exception as e:
            print(f'Method call failed as expected: {e}')
    ...
    def test_contains(self):
        if self.obj is None:
            pytest.skip('Skipping test because object could not be instantiated')
        try:
            self.obj.contains(Pair[int, int](1, 1))
        except Exception as e:
            print(f'Method call failed as expected: {e}')
    ...
    def test_index(self):
        if self.obj is None:
            pytest.skip('Skipping test because object could not be instantiated')
        try:
            self.obj.index(Pair[int, int](1, 1))
        except Exception as e:
            print(f'Method call failed as expected: {e}')
    ...
    def test_ctor_new(self):
        try:
            List[Pair[int, int]](array.array('L', [0]), 1)
        except Exception as e:
            print(f'Constructor new failed: {e}')

    def test_ctor_from_json(self):
        try:
            List[Pair[int, int]]("test_string")
        except Exception as e:
