...
class TestListDiscretizer:
    def setup_method(self):
        self.obj = None
        try:
            # Found empty constructor: ListDiscretizer_create_empty
            self.obj = List[Discretizer]()
    ...
    def test_fill_value(self):
        ...
        try:
            self.obj.fill_value(0, Discretizer.new_cartesian_discretizer(1.0))
        except Exception as e:
