...
class TestListLabelledDomain:
    def setup_method(self):
        self.obj = None
        try:
            # Found empty constructor: ListLabelledDomain_create_empty
            self.obj = List[LabelledDomain]()
    ...
    def test_ctor_new(self):
        try:
            List[LabelledDomain](array.array('L', [0]), 1)
        except Exception as e:
            print(f'Constructor new failed: {e}')

    def test_ctor_from_json(self):
        try:
            List[LabelledDomain]("test_string")
        except Exception as e:
