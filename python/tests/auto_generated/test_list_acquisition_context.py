...
class TestListAcquisitionContext:
    def setup_method(self):
        self.obj = None
        try:
            # Found empty constructor: ListAcquisitionContext_create_empty
            self.obj = List[AcquisitionContext]()
    ...
    def test_ctor_new(self):
        try:
            List[AcquisitionContext](array.array('L', [0]), 1)
        except Exception as e:
            print(f'Constructor new failed: {e}')

    def test_ctor_from_json(self):
        try:
            List[AcquisitionContext]("test_string")
        except Exception as e:
