...
class TestListDeviceVoltageState:
    def setup_method(self):
        self.obj = None
        try:
            # Found empty constructor: ListDeviceVoltageState_create_empty
            self.obj = List[DeviceVoltageState]()
    ...
    def test_ctor_new_empty(self):
        try:
            List[DeviceVoltageState]()
        except Exception as e:
            print(f'Constructor new_empty failed: {e}')

    def test_ctor_new(self):
        try:
            List[DeviceVoltageState](array.array('L', [0]), 1)
        except Exception as e:
            print(f'Constructor new failed: {e}')

    def test_ctor_from_json(self):
        try:
            List[DeviceVoltageState]("test_string")
        except Exception as e:
