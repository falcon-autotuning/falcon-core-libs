...
class LabelledControlArray:
    ...
    def copy(self, ) -> LabelledControlArray:
        ret = self._c.copy()
    ...
    def from_farray(cls, farray: FArray, label: AcquisitionContext) -> LabelledControlArray:
        ret = _CLabelledControlArray.from_farray(farray._c if farray is not None else None, label._c if label is not None else None)
        return LabelledControlArray._from_capi(ret)

    @classmethod
    def from_control_array(cls, controlarray: ControlArray, label: AcquisitionContext) -> LabelledControlArray:
        ret = _CLabelledControlArray.from_control_array(controlarray._c if controlarray is not None else None, label._c if label is not None else None)
        return LabelledControlArray._from_capi(ret)
    ...
    def minus_equals_control_array(self, other: LabelledControlArray) -> None:
        ret = self._c.minus_equals_control_array(other._c if other is not None else None)
        return ret
