...
from falcon_core._capi.control_array1_d import ControlArray1D as _CControlArray1D
from falcon_core.generic.f_array import FArray
from falcon_core.generic.list import List
from falcon_core.generic.list import List

class ControlArray1D:
    """Python wrapper for ControlArray1D."""
    ...
    def equal(self, other: ControlArray1D) -> bool:
        ret = self._c.equal(other._c if other is not None else None)
        return ret

    def not_equal(self, other: ControlArray1D) -> bool:
    ...
    @classmethod
    def from_farray(cls, farray: FArray) -> ControlArray1D:
        ret = _CControlArray1D.from_farray(farray._c if farray is not None else None)
        return ControlArray1D._from_capi(ret)
    ...
    def plus_control_array(self, other: ControlArray1D) -> ControlArray1D:
        ret = self._c.plus_control_array(other._c if other is not None else None)
        return ControlArray1D._from_capi(ret)

    def plus_farray(self, other: FArray) -> ControlArray1D:
        ret = self._c.plus_farray(other._c if other is not None else None)
        return ControlArray1D._from_capi(ret)

    def plus_double(self, other: Any) -> ControlArray1D:
        ret = self._c.plus_double(other)
        return ControlArray1D._from_capi(ret)

    def plus_int(self, other: Any) -> ControlArray1D:
    ...
    def minus_control_array(self, other: ControlArray1D) -> ControlArray1D:
        ret = self._c.minus_control_array(other._c if other is not None else None)
        return ControlArray1D._from_capi(ret)

    def minus_farray(self, other: FArray) -> ControlArray1D:
        ret = self._c.minus_farray(other._c if other is not None else None)
        return ControlArray1D._from_capi(ret)

    def minus_double(self, other: Any) -> ControlArray1D:
        ret = self._c.minus_double(other)
        return ControlArray1D._from_capi(ret)

    def minus_int(self, other: Any) -> ControlArray1D:
        ret = self._c.minus_int(other)
        return ControlArray1D._from_capi(ret)

    def negation(self, ) -> ControlArray1D:
    ...
    def times_double(self, other: Any) -> ControlArray1D:
        ret = self._c.times_double(other)
        return ControlArray1D._from_capi(ret)

    def times_int(self, other: Any) -> ControlArray1D:
    ...
    def divides_double(self, other: Any) -> ControlArray1D:
        ret = self._c.divides_double(other)
        return ControlArray1D._from_capi(ret)

    def divides_int(self, other: Any) -> ControlArray1D:
        ret = self._c.divides_int(other)
        return ControlArray1D._from_capi(ret)

    def pow(self, other: Any) -> ControlArray1D:
        ret = self._c.pow(other)
        return ControlArray1D._from_capi(ret)

    def abs(self, ) -> ControlArray1D:
        ret = self._c.abs()
        return ControlArray1D._from_capi(ret)
    ...
    def min_farray(self, other: FArray) -> ControlArray1D:
        ret = self._c.min_farray(other._c if other is not None else None)
        return ControlArray1D._from_capi(ret)

    def min_control_array(self, other: ControlArray1D) -> ControlArray1D:
    ...
    def max_farray(self, other: FArray) -> ControlArray1D:
        ret = self._c.max_farray(other._c if other is not None else None)
        return ControlArray1D._from_capi(ret)

    def max_control_array(self, other: ControlArray1D) -> ControlArray1D:
    ...
    def flip(self, axis: Any) -> ControlArray1D:
    ...
    def get_summed_diff_array_of_squares(self, other: ControlArray1D) -> float:
    ...
    def __repr__(self):
        return f"ControlArray1D({self.to_json()})"
    ...
    def __eq__(self, other):
        """Operator overload for =="""
        if not isinstance(other, ControlArray1D):
            return NotImplemented
