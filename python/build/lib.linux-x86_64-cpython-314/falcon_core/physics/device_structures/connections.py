...
class Connections:
    ...
    def equal(self, other: Connections) -> bool:
        ret = self._c.equal(other._c if other is not None else None)
        return ret

    def not_equal(self, other: Connections) -> bool:
    ...
    def is_gates(self, ) -> bool:
        ret = self._c.is_gates()
        return ret

    def is_ohmics(self, ) -> bool:
        ret = self._c.is_ohmics()
        return ret

    def is_dot_gates(self, ) -> bool:
    ...
    def is_reservoir_gates(self, ) -> bool:
        ret = self._c.is_reservoir_gates()
        return ret

    def is_screening_gates(self, ) -> bool:
    ...
    def contains(self, value: Connection) -> bool:
        ret = self._c.contains(value._c if value is not None else None)
        return ret

    def index(self, value: Connection) -> int:
