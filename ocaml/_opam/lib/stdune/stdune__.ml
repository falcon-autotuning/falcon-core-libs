...
(** @canonical Stdune.File_kind *)
module File_kind = Stdune__File_kind
...
(** @canonical Stdune.Json *)
module Json = Stdune__Json
...
(** @canonical Stdune.Log *)
module Log = Stdune__Log
...
(** @canonical Stdune.Readdir *)
module Readdir = Stdune__Readdir

(** @canonical Stdune.Result *)
module Result = Stdune__Result

(** @canonical Stdune.Root *)
module Root = Stdune__Root
...
(** @canonical Stdune.Unix_error *)
module Unix_error = Stdune__Unix_error
