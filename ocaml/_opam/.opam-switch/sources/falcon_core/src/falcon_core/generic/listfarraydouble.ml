...
module ListFArrayDouble = struct
  ...
  let fillValue (count : int) (value : FArrayDouble.t) : t =
  ...
  let make (data : FArrayDouble.t) (count : int) : t =
  ...
  let fromjson (json : string) : t =
    let ptr = Capi_bindings.listfarraydouble_from_json_string (Capi_bindings.string_wrap json) in
    ErrorHandling.raise_if_error ();
    new c_listfarraydouble ptr

  let pushBack (handle : t) (value : FArrayDouble.t) : unit =
  ...
  let at (handle : t) (idx : int) : FArrayDouble.t =
    ErrorHandling.read handle (fun () ->
  ...
  let items (handle : t) (out_buffer : FArrayDouble.t) (buffer_size : int) : int =
  ...
  let contains (handle : t) (value : FArrayDouble.t) : bool =
    ErrorHandling.multi_read [handle; value] (fun () ->
  ...
  let index (handle : t) (value : FArrayDouble.t) : int =
    ErrorHandling.multi_read [handle; value] (fun () ->
