...
module ListControlArray1D = struct
  ...
  let fillValue (count : int) (value : ControlArray1D.t) : t =
  ...
  let make (data : ControlArray1D.t) (count : int) : t =
  ...
  let fromjson (json : string) : t =
    let ptr = Capi_bindings.listcontrolarray1d_from_json_string (Capi_bindings.string_wrap json) in
    ErrorHandling.raise_if_error ();
    new c_listcontrolarray1d ptr
