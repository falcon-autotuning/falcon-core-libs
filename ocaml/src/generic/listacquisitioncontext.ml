...
module ListAcquisitionContext = struct
  ...
  let fillValue (count : int) (value : Acquisitioncontext.t) : t =
  ...
  let make (data : Acquisitioncontext.t) (count : int) : t =
  ...
  let fromjson (json : string) : t =
    let ptr = Capi_bindings.listacquisitioncontext_from_json_string (Capi_bindings.string_wrap json) in
    ErrorHandling.raise_if_error ();
    new c_listacquisitioncontext ptr

  let pushBack (handle : t) (value : Acquisitioncontext.t) : unit =
  ...
  let at (handle : t) (idx : int) : Acquisitioncontext.t =
    ErrorHandling.read handle (fun () ->
  ...
  let items (handle : t) (out_buffer : Acquisitioncontext.t) (buffer_size : int) : int =
  ...
  let contains (handle : t) (value : Acquisitioncontext.t) : bool =
    ErrorHandling.multi_read [handle; value] (fun () ->
  ...
  let index (handle : t) (value : Acquisitioncontext.t) : int =
    ErrorHandling.multi_read [handle; value] (fun () ->
