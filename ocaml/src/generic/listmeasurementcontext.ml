...
class c_listmeasurementcontext (h : unit ptr) : c_listmeasurementcontext_t = object(self)
  val raw_val = h
  method raw = raw_val
...
module ListMeasurementContext = struct
  ...
  let fillValue (count : int) (value : Measurementcontext.MeasurementContext.t) : t =
  ...
  let make (data : Measurementcontext.MeasurementContext.t) (count : int) : t =
  ...
  let fromjson (json : string) : t =
    let ptr = Capi_bindings.listmeasurementcontext_from_json_string (Falcon_string.of_string json) in
    Error_handling.raise_if_error ();
    new c_listmeasurementcontext ptr
