...
module ListDotGateWithNeighbors = struct
  ...
  let fillValue (count : int) (value : Dotgatewithneighbors.t) : t =
  ...
  let make (data : Dotgatewithneighbors.t) (count : int) : t =
  ...
  let fromjson (json : string) : t =
    let ptr = Capi_bindings.listdotgatewithneighbors_from_json_string (Capi_bindings.string_wrap json) in
    ErrorHandling.raise_if_error ();
    new c_listdotgatewithneighbors ptr
  ...
  let items (handle : t) (out_buffer : Dotgatewithneighbors.t) (buffer_size : int) : int =
