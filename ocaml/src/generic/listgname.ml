...
class c_listgname (h : unit ptr) : c_listgname_t = object(self)
  val raw_val = h
  method raw = raw_val
...
module ListGname = struct
  ...
  let fillValue (count : int) (value : Gname.Gname.t) : t =
  ...
  let make (data : Gname.Gname.t) (count : int) : t =
  ...
  let fromjson (json : string) : t =
    let ptr = Capi_bindings.listgname_from_json_string (Falcon_string.of_string json) in
    Error_handling.raise_if_error ();
    new c_listgname ptr

  let pushBack (handle : t) (value : Gname.Gname.t) : unit =
  ...
  let at (handle : t) (idx : int) : Gname.Gname.t =
    Error_handling.read handle (fun () ->
  ...
  let items (handle : t) (out_buffer : Gname.Gname.t) (buffer_size : int) : int =
  ...
  let contains (handle : t) (value : Gname.Gname.t) : bool =
    Error_handling.multi_read [handle; value] (fun () ->
  ...
  let index (handle : t) (value : Gname.Gname.t) : int =
    Error_handling.multi_read [handle; value] (fun () ->
