...
class c_listpairinterpretationcontextdouble (h : unit ptr) : c_listpairinterpretationcontextdouble_t = object(self)
  val raw_val = h
  method raw = raw_val
...
module ListPairInterpretationContextDouble = struct
  ...
  let fillValue (count : int) (value : Pairinterpretationcontextdouble.PairInterpretationContextDouble.t) : t =
  ...
  let fromjson (json : string) : t =
    let ptr = Capi_bindings.listpairinterpretationcontextdouble_from_json_string (Falcon_string.of_string json) in
    Error_handling.raise_if_error ();
    new c_listpairinterpretationcontextdouble ptr

  let pushBack (handle : t) (value : Pairinterpretationcontextdouble.PairInterpretationContextDouble.t) : unit =
  ...
  let at (handle : t) (idx : int) : Pairinterpretationcontextdouble.PairInterpretationContextDouble.t =
    Error_handling.read handle (fun () ->
      let result = Capi_bindings.listpairinterpretationcontextdouble_at handle#raw (Unsigned.Size_t.of_int idx) in
      Error_handling.raise_if_error ();
      new Pairinterpretationcontextdouble.c_pairinterpretationcontextdouble result
    )

  let items (handle : t) (out_buffer : Pairinterpretationcontextdouble.PairInterpretationContextDouble.t) (buffer_size : int) : int =
  ...
  let contains (handle : t) (value : Pairinterpretationcontextdouble.PairInterpretationContextDouble.t) : bool =
    Error_handling.multi_read [handle; value] (fun () ->
  ...
  let index (handle : t) (value : Pairinterpretationcontextdouble.PairInterpretationContextDouble.t) : int =
    Error_handling.multi_read [handle; value] (fun () ->
