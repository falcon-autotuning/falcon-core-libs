...
class c_listquantity (h : unit ptr) : c_listquantity_t = object(self)
  val raw_val = h
  method raw = raw_val
...
module ListQuantity = struct
  ...
  let fillValue (count : int) (value : Quantity.Quantity.t) : t =
  ...
  let make (data : Quantity.Quantity.t) (count : int) : t =
  ...
  let fromjson (json : string) : t =
    let ptr = Capi_bindings.listquantity_from_json_string (Falcon_string.of_string json) in
    Error_handling.raise_if_error ();
    new c_listquantity ptr

  let pushBack (handle : t) (value : Quantity.Quantity.t) : unit =
  ...
  let at (handle : t) (idx : int) : Quantity.Quantity.t =
    Error_handling.read handle (fun () ->
  ...
  let items (handle : t) (out_buffer : Quantity.Quantity.t) (buffer_size : int) : int =
  ...
  let contains (handle : t) (value : Quantity.Quantity.t) : bool =
    Error_handling.multi_read [handle; value] (fun () ->
  ...
  let index (handle : t) (value : Quantity.Quantity.t) : int =
    Error_handling.multi_read [handle; value] (fun () ->
