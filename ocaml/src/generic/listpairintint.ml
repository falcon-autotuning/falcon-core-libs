...
class c_listpairintint (h : unit ptr) : c_listpairintint_t = object(self)
  val raw_val = h
  method raw = raw_val
...
module ListPairIntInt = struct
  ...
  let fillValue (count : int) (value : Pairintint.PairIntInt.t) : t =
  ...
  let fromjson (json : string) : t =
    let ptr = Capi_bindings.listpairintint_from_json_string (Falcon_string.of_string json) in
    Error_handling.raise_if_error ();
    new c_listpairintint ptr

  let pushBack (handle : t) (value : Pairintint.PairIntInt.t) : unit =
  ...
  let at (handle : t) (idx : int) : Pairintint.PairIntInt.t =
    Error_handling.read handle (fun () ->
      let result = Capi_bindings.listpairintint_at handle#raw (Unsigned.Size_t.of_int idx) in
      Error_handling.raise_if_error ();
      new Pairintint.c_pairintint result
    )

  let items (handle : t) (out_buffer : Pairintint.PairIntInt.t) (buffer_size : int) : int =
  ...
  let contains (handle : t) (value : Pairintint.PairIntInt.t) : bool =
    Error_handling.multi_read [handle; value] (fun () ->
  ...
  let index (handle : t) (value : Pairintint.PairIntInt.t) : int =
    Error_handling.multi_read [handle; value] (fun () ->
