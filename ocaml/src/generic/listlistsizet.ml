...
class c_listlistsizet (h : unit ptr) : c_listlistsizet_t = object(self)
  val raw_val = h
  method raw = raw_val
...
module ListListSizeT = struct
  ...
  let fillValue (count : int) (value : Listsizet.ListSizeT.t) : t =
  ...
  let make (data : Listsizet.ListSizeT.t) (count : int) : t =
  ...
  let fromjson (json : string) : t =
    let ptr = Capi_bindings.listlistsizet_from_json_string (Falcon_string.of_string json) in
    Error_handling.raise_if_error ();
    new c_listlistsizet ptr

  let pushBack (handle : t) (value : Listsizet.ListSizeT.t) : unit =
  ...
  let at (handle : t) (idx : int) : Listsizet.ListSizeT.t =
    Error_handling.read handle (fun () ->
      let result = Capi_bindings.listlistsizet_at handle#raw (Unsigned.Size_t.of_int idx) in
      Error_handling.raise_if_error ();
      new Listsizet.c_listsizet result
    )

  let items (handle : t) (out_buffer : Listsizet.ListSizeT.t) (buffer_size : int) : int =
  ...
  let contains (handle : t) (value : Listsizet.ListSizeT.t) : bool =
    Error_handling.multi_read [handle; value] (fun () ->
  ...
  let index (handle : t) (value : Listsizet.ListSizeT.t) : int =
    Error_handling.multi_read [handle; value] (fun () ->
