...
class c_listpairconnectiondouble (h : unit ptr) : c_listpairconnectiondouble_t = object(self)
  val raw_val = h
  method raw = raw_val
...
module ListPairConnectionDouble = struct
  ...
  let fillValue (count : int) (value : Pairconnectiondouble.PairConnectionDouble.t) : t =
  ...
  let fromjson (json : string) : t =
    let ptr = Capi_bindings.listpairconnectiondouble_from_json_string (Falcon_string.of_string json) in
    Error_handling.raise_if_error ();
    new c_listpairconnectiondouble ptr

  let pushBack (handle : t) (value : Pairconnectiondouble.PairConnectionDouble.t) : unit =
  ...
  let at (handle : t) (idx : int) : Pairconnectiondouble.PairConnectionDouble.t =
    Error_handling.read handle (fun () ->
      let result = Capi_bindings.listpairconnectiondouble_at handle#raw (Unsigned.Size_t.of_int idx) in
      Error_handling.raise_if_error ();
      new Pairconnectiondouble.c_pairconnectiondouble result
    )

  let items (handle : t) (out_buffer : Pairconnectiondouble.PairConnectionDouble.t) (buffer_size : int) : int =
  ...
  let contains (handle : t) (value : Pairconnectiondouble.PairConnectionDouble.t) : bool =
    Error_handling.multi_read [handle; value] (fun () ->
  ...
  let index (handle : t) (value : Pairconnectiondouble.PairConnectionDouble.t) : int =
    Error_handling.multi_read [handle; value] (fun () ->
