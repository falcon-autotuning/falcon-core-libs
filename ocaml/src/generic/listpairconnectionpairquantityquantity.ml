...
class c_listpairconnectionpairquantityquantity (h : unit ptr) : c_listpairconnectionpairquantityquantity_t = object(self)
  val raw_val = h
  method raw = raw_val
...
module ListPairConnectionPairQuantityQuantity = struct
  ...
  let fillValue (count : int) (value : Pairconnectionpairquantityquantity.PairConnectionPairQuantityQuantity.t) : t =
  ...
  let make (data : Pairconnectionpairquantityquantity.PairConnectionPairQuantityQuantity.t) (count : int) : t =
  ...
  let fromjson (json : string) : t =
    let ptr = Capi_bindings.listpairconnectionpairquantityquantity_from_json_string (Falcon_string.of_string json) in
    Error_handling.raise_if_error ();
    new c_listpairconnectionpairquantityquantity ptr

  let pushBack (handle : t) (value : Pairconnectionpairquantityquantity.PairConnectionPairQuantityQuantity.t) : unit =
  ...
  let at (handle : t) (idx : int) : Pairconnectionpairquantityquantity.PairConnectionPairQuantityQuantity.t =
    Error_handling.read handle (fun () ->
      let result = Capi_bindings.listpairconnectionpairquantityquantity_at handle#raw (Unsigned.Size_t.of_int idx) in
      Error_handling.raise_if_error ();
      new Pairconnectionpairquantityquantity.c_pairconnectionpairquantityquantity result
    )

  let items (handle : t) (out_buffer : Pairconnectionpairquantityquantity.PairConnectionPairQuantityQuantity.t) (buffer_size : int) : int =
  ...
  let contains (handle : t) (value : Pairconnectionpairquantityquantity.PairConnectionPairQuantityQuantity.t) : bool =
    Error_handling.multi_read [handle; value] (fun () ->
  ...
  let index (handle : t) (value : Pairconnectionpairquantityquantity.PairConnectionPairQuantityQuantity.t) : int =
    Error_handling.multi_read [handle; value] (fun () ->
