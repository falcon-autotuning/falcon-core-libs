...
class c_listimpedance (h : unit ptr) : c_listimpedance_t = object(self)
  val raw_val = h
  method raw = raw_val
...
module ListImpedance = struct
  ...
  let fillValue (count : int) (value : Impedance.Impedance.t) : t =
  ...
  let make (data : Impedance.Impedance.t) (count : int) : t =
  ...
  let fromjson (json : string) : t =
    let ptr = Capi_bindings.listimpedance_from_json_string (Falcon_string.of_string json) in
    Error_handling.raise_if_error ();
    new c_listimpedance ptr
  ...
  let items (handle : t) (out_buffer : Impedance.Impedance.t) (buffer_size : int) : int =
