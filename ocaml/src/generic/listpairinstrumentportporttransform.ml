...
class c_listpairinstrumentportporttransform (h : unit ptr) : c_listpairinstrumentportporttransform_t = object(self)
  val raw_val = h
  method raw = raw_val
...
module ListPairInstrumentPortPortTransform = struct
  ...
  let fromjson (json : string) : t =
    let ptr = Capi_bindings.listpairinstrumentportporttransform_from_json_string (Falcon_string.of_string json) in
    Error_handling.raise_if_error ();
    new c_listpairinstrumentportporttransform ptr
