...
class c_listinterpretationcontext (h : unit ptr) : c_listinterpretationcontext_t = object(self)
  val raw_val = h
  method raw = raw_val
...
module ListInterpretationContext = struct
  ...
  let fillValue (count : int) (value : Interpretationcontext.InterpretationContext.t) : t =
  ...
  let make (data : Interpretationcontext.InterpretationContext.t) (count : int) : t =
  ...
  let fromjson (json : string) : t =
    let ptr = Capi_bindings.listinterpretationcontext_from_json_string (Falcon_string.of_string json) in
    Error_handling.raise_if_error ();
    new c_listinterpretationcontext ptr

  let pushBack (handle : t) (value : Interpretationcontext.InterpretationContext.t) : unit =
  ...
  let at (handle : t) (idx : int) : Interpretationcontext.InterpretationContext.t =
    Error_handling.read handle (fun () ->
  ...
  let items (handle : t) (out_buffer : Interpretationcontext.InterpretationContext.t) (buffer_size : int) : int =
  ...
  let contains (handle : t) (value : Interpretationcontext.InterpretationContext.t) : bool =
    Error_handling.multi_read [handle; value] (fun () ->
  ...
  let index (handle : t) (value : Interpretationcontext.InterpretationContext.t) : int =
    Error_handling.multi_read [handle; value] (fun () ->
