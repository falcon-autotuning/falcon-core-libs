...
class c_listlabelledcontrolarray (h : unit ptr) : c_listlabelledcontrolarray_t = object(self)
  val raw_val = h
  method raw = raw_val
...
module ListLabelledControlArray = struct
  ...
  let fillValue (count : int) (value : Labelledcontrolarray.LabelledControlArray.t) : t =
  ...
  let make (data : Labelledcontrolarray.LabelledControlArray.t) (count : int) : t =
  ...
  let fromjson (json : string) : t =
    let ptr = Capi_bindings.listlabelledcontrolarray_from_json_string (Falcon_string.of_string json) in
    Error_handling.raise_if_error ();
    new c_listlabelledcontrolarray ptr
