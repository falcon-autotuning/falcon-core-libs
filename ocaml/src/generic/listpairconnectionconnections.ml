...
class c_listpairconnectionconnections (h : unit ptr) : c_listpairconnectionconnections_t = object(self)
  val raw_val = h
  method raw = raw_val
...
module ListPairConnectionConnections = struct
  ...
  let fromjson (json : string) : t =
    let ptr = Capi_bindings.listpairconnectionconnections_from_json_string (Falcon_string.of_string json) in
    Error_handling.raise_if_error ();
    new c_listpairconnectionconnections ptr
