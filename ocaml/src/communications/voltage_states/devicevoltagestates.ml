...
module DeviceVoltageStates = struct
  ...
  let make (items : Listdevicevoltagestate.ListDeviceVoltageState.t) : t =
  ...
  let states (handle : t) : Listdevicevoltagestate.ListDeviceVoltageState.t =
    Error_handling.read handle (fun () ->
      let result = Capi_bindings.devicevoltagestates_states handle#raw in
      Error_handling.raise_if_error ();
      new Listdevicevoltagestate.c_listdevicevoltagestate result
    )

  let addState (handle : t) (state : Devicevoltagestate.DeviceVoltageState.t) : unit =
  ...
  let findState (handle : t) (connection : Connection.Connection.t) : t =
  ...
  let toPoint (handle : t) : Point.Point.t =
    Error_handling.read handle (fun () ->
  ...
  let items (handle : t) : Listdevicevoltagestate.ListDeviceVoltageState.t =
    Error_handling.read handle (fun () ->
